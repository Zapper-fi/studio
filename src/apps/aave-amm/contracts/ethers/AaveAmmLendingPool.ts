...
export interface AaveAmmLendingPoolInterface extends utils.Interface {
  functions: {
...
export interface AaveAmmLendingPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveAmmLendingPoolInterface;
