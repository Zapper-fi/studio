...
export interface UwuLendDataProviderInterface extends utils.Interface {
  functions: {
...
export interface UwuLendDataProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UwuLendDataProviderInterface;
