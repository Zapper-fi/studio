...
import type { ArtGobblers, ArtGobblersInterface } from '../ArtGobblers';
...
const _abi = [
  ...
  {
    inputs: [],
    name: 'MintStartPending',
    type: 'error',
  },
  {
    inputs: [],
    name: 'NoRemainingLegendaryGobblers',
    type: 'error',
  },
  {
    inputs: [
  ...
  {
    inputs: [],
    name: 'RequestTooEarly',
    type: 'error',
  },
  {
    inputs: [],
    name: 'ReserveImbalance',
    type: 'error',
  },
  {
    inputs: [],
...
export class ArtGobblers__factory {
  static readonly abi = _abi;
  static createInterface(): ArtGobblersInterface {
    return new utils.Interface(_abi) as ArtGobblersInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ArtGobblers {
    return new Contract(address, _abi, signerOrProvider) as ArtGobblers;
  }
}
