...
export type ArtGobblers = typeof artGobblersAbi;
export type ArtGobblersContract = GetContractReturnType<ArtGobblers, PublicClient>;

export class ArtGobblers__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: artGobblersAbi, publicClient: client });
  }
}
