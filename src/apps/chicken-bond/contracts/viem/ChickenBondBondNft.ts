...
export const chickenBondBondNftAbi = [
  {
    inputs: [
      {
        internalType: 'string',
...
export type ChickenBondBondNft = typeof chickenBondBondNftAbi;
export type ChickenBondBondNftContract = GetContractReturnType<ChickenBondBondNft, PublicClient>;

export class ChickenBondBondNft__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: chickenBondBondNftAbi, publicClient: client });
  }
}
