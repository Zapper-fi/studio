...
export const chickenBondManagerAbi = [
  {
    inputs: [
      {
        components: [
...
export type ChickenBondManager = typeof chickenBondManagerAbi;
export type ChickenBondManagerContract = GetContractReturnType<ChickenBondManager, PublicClient>;

export class ChickenBondManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: chickenBondManagerAbi, publicClient: client });
  }
}
