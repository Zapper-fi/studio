...
import type { ChickenBondManager, ChickenBondManagerInterface } from '../ChickenBondManager';
...
export class ChickenBondManager__factory {
  static readonly abi = _abi;
  static createInterface(): ChickenBondManagerInterface {
    return new utils.Interface(_abi) as ChickenBondManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ChickenBondManager {
    return new Contract(address, _abi, signerOrProvider) as ChickenBondManager;
  }
}
