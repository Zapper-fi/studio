...
export interface ChickenBondBlusdInterface extends utils.Interface {
  functions: {
    'allowance(address,address)': FunctionFragment;
    'approve(address,uint256)': FunctionFragment;
    'balanceOf(address)': FunctionFragment;
    'burn(address,uint256)': FunctionFragment;
    'chickenBondManagerAddress()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'chickenBondManagerAddress', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'chickenBondManagerAddress', data: BytesLike): Result;
...
export interface ChickenBondBlusd extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChickenBondBlusdInterface;
  ...
  functions: {
    ...
    burn(
      ...
      _bLUSDAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
