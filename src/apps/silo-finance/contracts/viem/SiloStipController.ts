...
export const siloStipControllerAbi = [
  {
    inputs: [
      {
...
export type SiloStipController = typeof siloStipControllerAbi;
export type SiloStipControllerContract = GetContractReturnType<SiloStipController, PublicClient>;

export class SiloStipController__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: siloStipControllerAbi, publicClient: client });
  }
}
