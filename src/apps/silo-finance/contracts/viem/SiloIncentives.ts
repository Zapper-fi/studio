...
export const siloIncentivesAbi = [
  {
    inputs: [
      {
...
export type SiloIncentives = typeof siloIncentivesAbi;
export type SiloIncentivesContract = GetContractReturnType<SiloIncentives, PublicClient>;

export class SiloIncentives__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: siloIncentivesAbi, publicClient: client });
  }
}
