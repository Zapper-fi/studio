...
import type { SiloLens, SiloLensInterface } from '../SiloLens';
...
export class SiloLens__factory {
  static readonly abi = _abi;
  static createInterface(): SiloLensInterface {
    return new utils.Interface(_abi) as SiloLensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SiloLens {
    return new Contract(address, _abi, signerOrProvider) as SiloLens;
  }
}
