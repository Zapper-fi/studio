...
import type { SiloIncentives, SiloIncentivesInterface } from '../SiloIncentives';
...
export class SiloIncentives__factory {
  static readonly abi = _abi;
  static createInterface(): SiloIncentivesInterface {
    return new utils.Interface(_abi) as SiloIncentivesInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SiloIncentives {
    return new Contract(address, _abi, signerOrProvider) as SiloIncentives;
  }
}
