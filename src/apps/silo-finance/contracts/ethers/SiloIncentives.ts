...
export interface SiloIncentivesInterface extends utils.Interface {
  functions: {
    ...
    'claimRewardsToSelf(address[],uint256)': FunctionFragment;
    ...
    'notificationReceiverPing()': FunctionFragment;
    'onAfterTransfer(address,address,address,uint256)': FunctionFragment;
    'rescueRewards()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'notificationReceiverPing', values?: undefined): string;
  encodeFunctionData(
    functionFragment: 'onAfterTransfer',
    values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>],
  ): string;
  encodeFunctionData(functionFragment: 'rescueRewards', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'notificationReceiverPing', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'onAfterTransfer', data: BytesLike): Result;
...
export interface SiloIncentives extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SiloIncentivesInterface;
  ...
  functions: {
    ...
    notificationReceiverPing(overrides?: CallOverrides): Promise<[string]>;
    ...
    rescueRewards(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    rescueRewards(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    notificationReceiverPing(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    rescueRewards(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    notificationReceiverPing(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    rescueRewards(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
