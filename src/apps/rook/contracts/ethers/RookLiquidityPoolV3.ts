...
export interface RookLiquidityPoolV3Interface extends utils.Interface {
  functions: {
...
export interface RookLiquidityPoolV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RookLiquidityPoolV3Interface;
