...
export const rookLiquidityPoolV3Abi = [
  {
    inputs: [],
...
export type RookLiquidityPoolV3 = typeof rookLiquidityPoolV3Abi;
export type RookLiquidityPoolV3Contract = GetContractReturnType<RookLiquidityPoolV3, PublicClient>;

export class RookLiquidityPoolV3__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rookLiquidityPoolV3Abi, publicClient: client });
  }
}
