...
import type { TeddyCashStabilityPool, TeddyCashStabilityPoolInterface } from '../TeddyCashStabilityPool';
...
export class TeddyCashStabilityPool__factory {
  static readonly abi = _abi;
  static createInterface(): TeddyCashStabilityPoolInterface {
    return new utils.Interface(_abi) as TeddyCashStabilityPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TeddyCashStabilityPool {
    return new Contract(address, _abi, signerOrProvider) as TeddyCashStabilityPool;
  }
}
