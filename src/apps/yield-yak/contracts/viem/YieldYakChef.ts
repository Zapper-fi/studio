...
export type YieldYakChef = typeof yieldYakChefAbi;
export type YieldYakChefContract = GetContractReturnType<YieldYakChef, PublicClient>;

export class YieldYakChef__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: yieldYakChefAbi, publicClient: client });
  }
}
