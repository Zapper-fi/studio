...
import { ArbitrumUmamiCompoundContractPositionFetcher } from './arbitrum/umami.compound.contract-position-fetcher';
...
@Register.AppModule({
  ...
  providers: [
    ...
    ArbitrumUmamiCompoundContractPositionFetcher,
