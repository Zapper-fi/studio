...
export interface PlutusRewardsDistroPlsDpxInterface extends utils.Interface {
  functions: {
    ...
    'sendRewards(address,uint128,uint128,uint128,uint128,uint128)': FunctionFragment;
...
export interface PlutusRewardsDistroPlsDpx extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusRewardsDistroPlsDpxInterface;
  ...
  functions: {
    ...
    sendRewards(
      ...
      _rdpxAmt: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
