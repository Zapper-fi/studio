...
export interface PlutusFarmPlsJonesLpInterface extends utils.Interface {
  functions: {
...
export interface PlutusFarmPlsJonesLp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusFarmPlsJonesLpInterface;
