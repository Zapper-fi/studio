...
export interface PlutusFarmPlsDpxLpInterface extends utils.Interface {
  functions: {
...
export interface PlutusFarmPlsDpxLp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusFarmPlsDpxLpInterface;
