...
export const plutusFarmPlsJonesAbi = [
  {
    inputs: [
      {
...
export type PlutusFarmPlsJones = typeof plutusFarmPlsJonesAbi;
export type PlutusFarmPlsJonesContract = GetContractReturnType<PlutusFarmPlsJones, PublicClient>;

export class PlutusFarmPlsJones__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: plutusFarmPlsJonesAbi, publicClient: client });
  }
}
