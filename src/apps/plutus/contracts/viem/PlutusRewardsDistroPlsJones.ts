...
export const plutusRewardsDistroPlsJonesAbi = [
  {
    inputs: [
      {
...
export type PlutusRewardsDistroPlsJones = typeof plutusRewardsDistroPlsJonesAbi;
export type PlutusRewardsDistroPlsJonesContract = GetContractReturnType<PlutusRewardsDistroPlsJones, PublicClient>;

export class PlutusRewardsDistroPlsJones__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: plutusRewardsDistroPlsJonesAbi, publicClient: client });
  }
}
