...
export type RocketMinipoolManager = typeof rocketMinipoolManagerAbi;
export type RocketMinipoolManagerContract = GetContractReturnType<RocketMinipoolManager, PublicClient>;

export class RocketMinipoolManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rocketMinipoolManagerAbi, publicClient: client });
  }
}
