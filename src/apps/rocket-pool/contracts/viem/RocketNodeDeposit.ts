...
export type RocketNodeDeposit = typeof rocketNodeDepositAbi;
export type RocketNodeDepositContract = GetContractReturnType<RocketNodeDeposit, PublicClient>;

export class RocketNodeDeposit__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rocketNodeDepositAbi, publicClient: client });
  }
}
