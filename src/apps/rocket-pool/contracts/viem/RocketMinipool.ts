...
export const rocketMinipoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type RocketMinipool = typeof rocketMinipoolAbi;
export type RocketMinipoolContract = GetContractReturnType<RocketMinipool, PublicClient>;

export class RocketMinipool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rocketMinipoolAbi, publicClient: client });
  }
}
