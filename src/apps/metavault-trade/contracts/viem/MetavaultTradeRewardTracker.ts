...
export const metavaultTradeRewardTrackerAbi = [
  {
    inputs: [],
...
export type MetavaultTradeRewardTracker = typeof metavaultTradeRewardTrackerAbi;
export type MetavaultTradeRewardTrackerContract = GetContractReturnType<MetavaultTradeRewardTracker, PublicClient>;

export class MetavaultTradeRewardTracker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: metavaultTradeRewardTrackerAbi, publicClient: client });
  }
}
