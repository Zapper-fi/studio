...
export const metavaultTradeVaultAbi = [
  {
    inputs: [],
...
export type MetavaultTradeVault = typeof metavaultTradeVaultAbi;
export type MetavaultTradeVaultContract = GetContractReturnType<MetavaultTradeVault, PublicClient>;

export class MetavaultTradeVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: metavaultTradeVaultAbi, publicClient: client });
  }
}
