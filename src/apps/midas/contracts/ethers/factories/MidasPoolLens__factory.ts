...
import type { MidasPoolLens, MidasPoolLensInterface } from '../MidasPoolLens';
...
export class MidasPoolLens__factory {
  ...
  static createInterface(): MidasPoolLensInterface {
    return new utils.Interface(_abi) as MidasPoolLensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MidasPoolLens {
    return new Contract(address, _abi, signerOrProvider) as MidasPoolLens;
  }
}
