...
export interface MidasPoolDirectoryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_deprecatePool(address)', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: '_deprecatePool(uint256)', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'getActivePools', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: '_deprecatePool(address)', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_deprecatePool(uint256)', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'getActivePools', data: BytesLike): Result;
...
export interface MidasPoolDirectory extends BaseContract {
  ...
  functions: {
    ...
    getActivePools(overrides?: CallOverrides): Promise<[BigNumber[], FusePoolDirectory.FusePoolStructOutput[]]>;
  ...
  callStatic: {
    ...
    '_deprecatePool(address)'(comptroller: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    '_deprecatePool(uint256)'(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
