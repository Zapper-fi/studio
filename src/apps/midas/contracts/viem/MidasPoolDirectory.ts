...
export const midasPoolDirectoryAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type MidasPoolDirectory = typeof midasPoolDirectoryAbi;
export type MidasPoolDirectoryContract = GetContractReturnType<MidasPoolDirectory, PublicClient>;

export class MidasPoolDirectory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: midasPoolDirectoryAbi, publicClient: client });
  }
}
