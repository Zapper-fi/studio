...
export interface NereusFinanceLendingPoolProviderInterface extends utils.Interface {
  functions: {
...
export interface NereusFinanceLendingPoolProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NereusFinanceLendingPoolProviderInterface;
