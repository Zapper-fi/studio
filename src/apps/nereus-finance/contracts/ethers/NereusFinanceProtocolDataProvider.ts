...
export interface NereusFinanceProtocolDataProviderInterface extends utils.Interface {
  functions: {
...
export interface NereusFinanceProtocolDataProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NereusFinanceProtocolDataProviderInterface;
