...
export interface NereusFinanceStakedTokenIncentivesControllerInterface extends utils.Interface {
  functions: {
...
export interface NereusFinanceStakedTokenIncentivesController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NereusFinanceStakedTokenIncentivesControllerInterface;
