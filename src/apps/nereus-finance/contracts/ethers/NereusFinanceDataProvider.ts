...
export interface NereusFinanceDataProviderInterface extends utils.Interface {
  functions: {
...
export interface NereusFinanceDataProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NereusFinanceDataProviderInterface;
