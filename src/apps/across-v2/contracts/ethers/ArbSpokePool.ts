...
export interface ArbSpokePoolInterface extends utils.Interface {
  functions: {
...
export interface ArbitrumTokensBridgedEventObject {
  l1Token: string;
  target: string;
  numberOfTokensBridged: BigNumber;
}
export type ArbitrumTokensBridgedEvent = TypedEvent<[string, string, BigNumber], ArbitrumTokensBridgedEventObject>;

export type ArbitrumTokensBridgedEventFilter = TypedEventFilter<ArbitrumTokensBridgedEvent>;
...
export interface SetL2GatewayRouterEventObject {
  newL2GatewayRouter: string;
}
export type SetL2GatewayRouterEvent = TypedEvent<[string], SetL2GatewayRouterEventObject>;

export type SetL2GatewayRouterEventFilter = TypedEventFilter<SetL2GatewayRouterEvent>;
...
export interface WhitelistedTokensEventObject {
  l2Token: string;
  l1Token: string;
}
export type WhitelistedTokensEvent = TypedEvent<[string, string], WhitelistedTokensEventObject>;

export type WhitelistedTokensEventFilter = TypedEventFilter<WhitelistedTokensEvent>;

export interface ArbSpokePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArbSpokePoolInterface;
  ...
  filters: {
    ...
    ): ArbitrumTokensBridgedEventFilter;
    ...
    'SetL2GatewayRouter(address)'(newL2GatewayRouter?: string | null): SetL2GatewayRouterEventFilter;
    SetL2GatewayRouter(newL2GatewayRouter?: string | null): SetL2GatewayRouterEventFilter;
    ...
    'WhitelistedTokens(address,address)'(
      l2Token?: string | null,
      l1Token?: string | null,
    ): WhitelistedTokensEventFilter;
    WhitelistedTokens(l2Token?: string | null, l1Token?: string | null): WhitelistedTokensEventFilter;
  };
