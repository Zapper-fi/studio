...
import type { EthSpokePool, EthSpokePoolInterface } from '../EthSpokePool';
...
export class EthSpokePool__factory {
  static readonly abi = _abi;
  static createInterface(): EthSpokePoolInterface {
    return new utils.Interface(_abi) as EthSpokePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EthSpokePool {
    return new Contract(address, _abi, signerOrProvider) as EthSpokePool;
  }
}
