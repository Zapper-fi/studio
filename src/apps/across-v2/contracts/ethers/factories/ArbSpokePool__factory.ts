...
import type { ArbSpokePool, ArbSpokePoolInterface } from '../ArbSpokePool';
...
export class ArbSpokePool__factory {
  static readonly abi = _abi;
  static createInterface(): ArbSpokePoolInterface {
    return new utils.Interface(_abi) as ArbSpokePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ArbSpokePool {
    return new Contract(address, _abi, signerOrProvider) as ArbSpokePool;
  }
}
