...
import type { EthHubPool, EthHubPoolInterface } from '../EthHubPool';
...
export class EthHubPool__factory {
  static readonly abi = _abi;
  static createInterface(): EthHubPoolInterface {
    return new utils.Interface(_abi) as EthHubPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EthHubPool {
    return new Contract(address, _abi, signerOrProvider) as EthHubPool;
  }
}
