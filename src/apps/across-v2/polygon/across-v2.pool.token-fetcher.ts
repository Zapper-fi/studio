...
import { ACROSS_V2_POL_POOL_DEFINITIONS } from './across.pool.definitions';
...
export class PolygonAcrossV2PoolTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
  ...
  async getPositions() {
    const definition = ACROSS_V2_POL_POOL_DEFINITIONS;
