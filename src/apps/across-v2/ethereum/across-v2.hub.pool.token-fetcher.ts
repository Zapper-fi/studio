...
import { ACROSS_V2_ETH_HUBPOOL_DEFINITION } from './across.pool.definitions';
...
export class EthereumAcrossV2HubPoolTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
  ...
  async getPositions() {
    const definition = ACROSS_V2_ETH_HUBPOOL_DEFINITION;
