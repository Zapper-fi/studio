...
export type RhinoFiBridge = typeof rhinoFiBridgeAbi;
export type RhinoFiBridgeContract = GetContractReturnType<RhinoFiBridge, PublicClient>;

export class RhinoFiBridge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rhinoFiBridgeAbi, publicClient: client });
  }
}
