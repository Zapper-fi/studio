...
export type TeahouseVault = typeof teahouseVaultAbi;
export type TeahouseVaultContract = GetContractReturnType<TeahouseVault, PublicClient>;

export class TeahouseVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: teahouseVaultAbi, publicClient: client });
  }
}
