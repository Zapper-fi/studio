...
export const pancakeswapMasterchefAbi = [
  {
    inputs: [
      {
...
export type PancakeswapMasterchef = typeof pancakeswapMasterchefAbi;
export type PancakeswapMasterchefContract = GetContractReturnType<PancakeswapMasterchef, PublicClient>;

export class PancakeswapMasterchef__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pancakeswapMasterchefAbi, publicClient: client });
  }
}
