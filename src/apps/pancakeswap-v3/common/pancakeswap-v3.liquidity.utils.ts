import { Token as TokenWrapper } from '@pancakeswap/swap-sdk-core';
...
import {
  PancakeswapV3LiquidityPositionContractData,
  PancakeswapV3LiquiditySlotContractData,
  PancakeswapV3LiquidityTickContractData,
} from './pancakeswap-v3.liquidity.types';
...
export const getSupplied = ({
  ...
  position: PancakeswapV3LiquidityPositionContractData;
  slot: PancakeswapV3LiquiditySlotContractData;
  token0: Token;
  token1: Token;
  network: Network;
  liquidity: BigNumber;
...
export const getClaimable = ({
  ...
  position: PancakeswapV3LiquidityPositionContractData;
  slot: PancakeswapV3LiquiditySlotContractData;
  ticksLower: PancakeswapV3LiquidityTickContractData;
  ticksUpper: PancakeswapV3LiquidityTickContractData;
