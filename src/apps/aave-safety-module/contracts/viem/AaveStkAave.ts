...
export type AaveStkAave = typeof aaveStkAaveAbi;
export type AaveStkAaveContract = GetContractReturnType<AaveStkAave, PublicClient>;

export class AaveStkAave__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aaveStkAaveAbi, publicClient: client });
  }
}
