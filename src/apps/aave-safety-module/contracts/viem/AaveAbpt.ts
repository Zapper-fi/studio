...
export type AaveAbpt = typeof aaveAbptAbi;
export type AaveAbptContract = GetContractReturnType<AaveAbpt, PublicClient>;

export class AaveAbpt__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aaveAbptAbi, publicClient: client });
  }
}
