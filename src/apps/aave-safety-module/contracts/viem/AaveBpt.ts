...
export type AaveBpt = typeof aaveBptAbi;
export type AaveBptContract = GetContractReturnType<AaveBpt, PublicClient>;

export class AaveBpt__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aaveBptAbi, publicClient: client });
  }
}
