...
export type AaveStkAbpt = typeof aaveStkAbptAbi;
export type AaveStkAbptContract = GetContractReturnType<AaveStkAbpt, PublicClient>;

export class AaveStkAbpt__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aaveStkAbptAbi, publicClient: client });
  }
}
