...
export const platypusFinancePoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PlatypusFinancePool = typeof platypusFinancePoolAbi;
export type PlatypusFinancePoolContract = GetContractReturnType<PlatypusFinancePool, PublicClient>;

export class PlatypusFinancePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: platypusFinancePoolAbi, publicClient: client });
  }
}
