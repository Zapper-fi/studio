...
export interface PlatypusFinanceMasterPlatypusV1Interface extends utils.Interface {
  functions: {
...
export interface PlatypusFinanceMasterPlatypusV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlatypusFinanceMasterPlatypusV1Interface;
