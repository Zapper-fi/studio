...
export const caskVaultTokenAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type CaskVaultToken = typeof caskVaultTokenAbi;
export type CaskVaultTokenContract = GetContractReturnType<CaskVaultToken, PublicClient>;

export class CaskVaultToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: caskVaultTokenAbi, publicClient: client });
  }
}
