...
export type RoboVault = typeof roboVaultAbi;
export type RoboVaultContract = GetContractReturnType<RoboVault, PublicClient>;

export class RoboVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: roboVaultAbi, publicClient: client });
  }
}
