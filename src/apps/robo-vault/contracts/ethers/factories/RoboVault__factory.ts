...
import type { RoboVault, RoboVaultInterface } from '../RoboVault';
...
export class RoboVault__factory {
  static readonly abi = _abi;
  static createInterface(): RoboVaultInterface {
    return new utils.Interface(_abi) as RoboVaultInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RoboVault {
    return new Contract(address, _abi, signerOrProvider) as RoboVault;
  }
}
