...
export interface BastionProtocolComptrollerInterface extends utils.Interface {
  functions: {
    ...
    '_setRewardDistributor(address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: '_setRewardDistributor', values: [PromiseOrValue<string>]): string;
  ...
  decodeFunctionResult(functionFragment: '_setRewardDistributor', data: BytesLike): Result;
...
export interface NewRewardDistributorEventObject {
  oldRewardDistributor: string;
  newRewardDistributor: string;
}
export type NewRewardDistributorEvent = TypedEvent<[string, string], NewRewardDistributorEventObject>;

export type NewRewardDistributorEventFilter = TypedEventFilter<NewRewardDistributorEvent>;

export interface BastionProtocolComptroller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BastionProtocolComptrollerInterface;
  ...
  functions: {
    ...
    _setRewardDistributor(
      newRewardDistributor: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
    ...
    isMarketListed(cTokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    _setRewardDistributor(newRewardDistributor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    'NewRewardDistributor(address,address)'(
      oldRewardDistributor?: null,
      newRewardDistributor?: null,
    ): NewRewardDistributorEventFilter;
    NewRewardDistributor(oldRewardDistributor?: null, newRewardDistributor?: null): NewRewardDistributorEventFilter;
  };
  ...
  estimateGas: {
    ...
    isMarketListed(cTokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isMarketListed(cTokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
