...
export type Beanstalk = typeof beanstalkAbi;
export type BeanstalkContract = GetContractReturnType<Beanstalk, PublicClient>;

export class Beanstalk__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: beanstalkAbi, publicClient: client });
  }
}
