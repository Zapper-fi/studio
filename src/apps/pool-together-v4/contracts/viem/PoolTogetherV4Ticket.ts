...
export const poolTogetherV4TicketAbi = [
  {
    inputs: [
      {
        internalType: 'string',
...
export type PoolTogetherV4Ticket = typeof poolTogetherV4TicketAbi;
export type PoolTogetherV4TicketContract = GetContractReturnType<PoolTogetherV4Ticket, PublicClient>;

export class PoolTogetherV4Ticket__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV4TicketAbi, publicClient: client });
  }
}
