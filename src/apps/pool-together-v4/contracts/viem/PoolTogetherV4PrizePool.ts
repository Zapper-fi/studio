...
export const poolTogetherV4PrizePoolAbi = [
  {
    inputs: [
      {
...
export type PoolTogetherV4PrizePool = typeof poolTogetherV4PrizePoolAbi;
export type PoolTogetherV4PrizePoolContract = GetContractReturnType<PoolTogetherV4PrizePool, PublicClient>;

export class PoolTogetherV4PrizePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV4PrizePoolAbi, publicClient: client });
  }
}
