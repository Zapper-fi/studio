...
export interface RadiantCapitalLendingProviderInterface extends utils.Interface {
  functions: {
...
export interface RadiantCapitalLendingProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RadiantCapitalLendingProviderInterface;
