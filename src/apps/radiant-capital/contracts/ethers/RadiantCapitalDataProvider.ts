...
export interface RadiantCapitalDataProviderInterface extends utils.Interface {
  functions: {
...
export interface RadiantCapitalDataProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RadiantCapitalDataProviderInterface;
