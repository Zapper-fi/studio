...
export type CompoundLens = typeof compoundLensAbi;
export type CompoundLensContract = GetContractReturnType<CompoundLens, PublicClient>;

export class CompoundLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: compoundLensAbi, publicClient: client });
  }
}
