...
export const yearnStakedYCrvAbi = [
  {
    name: 'Transfer',
    inputs: [
      {
...
export type YearnStakedYCrv = typeof yearnStakedYCrvAbi;
export type YearnStakedYCrvContract = GetContractReturnType<YearnStakedYCrv, PublicClient>;

export class YearnStakedYCrv__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: yearnStakedYCrvAbi, publicClient: client });
  }
}
