...
import type { YearnLpYCrv, YearnLpYCrvInterface } from '../YearnLpYCrv';
...
export class YearnLpYCrv__factory {
  static readonly abi = _abi;
  static createInterface(): YearnLpYCrvInterface {
    return new utils.Interface(_abi) as YearnLpYCrvInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): YearnLpYCrv {
    return new Contract(address, _abi, signerOrProvider) as YearnLpYCrv;
  }
}
