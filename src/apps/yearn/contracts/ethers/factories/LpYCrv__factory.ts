...
import type { LpYCrv, LpYCrvInterface } from '../LpYCrv';
...
export class LpYCrv__factory {
  static readonly abi = _abi;
  static createInterface(): LpYCrvInterface {
    return new utils.Interface(_abi) as LpYCrvInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): LpYCrv {
    return new Contract(address, _abi, signerOrProvider) as LpYCrv;
  }
}
