...
export type AirdropDistributor = typeof airdropDistributorAbi;
export type AirdropDistributorContract = GetContractReturnType<AirdropDistributor, PublicClient>;

export class AirdropDistributor__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: airdropDistributorAbi, publicClient: client });
  }
}
