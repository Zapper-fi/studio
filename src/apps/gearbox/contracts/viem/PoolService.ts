...
export type PoolService = typeof poolServiceAbi;
export type PoolServiceContract = GetContractReturnType<PoolService, PublicClient>;

export class PoolService__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolServiceAbi, publicClient: client });
  }
}
