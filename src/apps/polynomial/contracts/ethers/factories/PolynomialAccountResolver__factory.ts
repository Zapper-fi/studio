...
import type { PolynomialAccountResolver, PolynomialAccountResolverInterface } from '../PolynomialAccountResolver';
...
export class PolynomialAccountResolver__factory {
  ...
  static createInterface(): PolynomialAccountResolverInterface {
    return new utils.Interface(_abi) as PolynomialAccountResolverInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PolynomialAccountResolver {
    return new Contract(address, _abi, signerOrProvider) as PolynomialAccountResolver;
  }
}
