...
export const polynomialCoveredCallAbi = [
  {
    inputs: [
      {
...
export type PolynomialCoveredCall = typeof polynomialCoveredCallAbi;
export type PolynomialCoveredCallContract = GetContractReturnType<PolynomialCoveredCall, PublicClient>;

export class PolynomialCoveredCall__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: polynomialCoveredCallAbi, publicClient: client });
  }
}
