...
export const polynomialPutSellingAbi = [
  {
    inputs: [
      {
...
export type PolynomialPutSelling = typeof polynomialPutSellingAbi;
export type PolynomialPutSellingContract = GetContractReturnType<PolynomialPutSelling, PublicClient>;

export class PolynomialPutSelling__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: polynomialPutSellingAbi, publicClient: client });
  }
}
