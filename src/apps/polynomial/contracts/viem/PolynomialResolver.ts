...
export const polynomialResolverAbi = [
  {
    inputs: [
      {
...
export type PolynomialResolver = typeof polynomialResolverAbi;
export type PolynomialResolverContract = GetContractReturnType<PolynomialResolver, PublicClient>;

export class PolynomialResolver__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: polynomialResolverAbi, publicClient: client });
  }
}
