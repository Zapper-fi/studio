...
export interface CronusFinancePoolInterface extends utils.Interface {
  functions: {
...
export interface CronusFinancePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CronusFinancePoolInterface;
