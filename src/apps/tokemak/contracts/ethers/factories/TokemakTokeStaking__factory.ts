...
import type { TokemakTokeStaking, TokemakTokeStakingInterface } from '../TokemakTokeStaking';
...
export class TokemakTokeStaking__factory {
  ...
  static createInterface(): TokemakTokeStakingInterface {
    return new utils.Interface(_abi) as TokemakTokeStakingInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TokemakTokeStaking {
    return new Contract(address, _abi, signerOrProvider) as TokemakTokeStaking;
  }
}
