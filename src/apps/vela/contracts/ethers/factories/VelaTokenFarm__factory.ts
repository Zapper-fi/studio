...
import type { VelaTokenFarm, VelaTokenFarmInterface } from '../VelaTokenFarm';
...
export class VelaTokenFarm__factory {
  ...
  static createInterface(): VelaTokenFarmInterface {
    return new utils.Interface(_abi) as VelaTokenFarmInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VelaTokenFarm {
    return new Contract(address, _abi, signerOrProvider) as VelaTokenFarm;
  }
}
