...
import type { VelaVault, VelaVaultInterface } from '../VelaVault';
...
export class VelaVault__factory {
  static readonly abi = _abi;
  static createInterface(): VelaVaultInterface {
    return new utils.Interface(_abi) as VelaVaultInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VelaVault {
    return new Contract(address, _abi, signerOrProvider) as VelaVault;
  }
}
