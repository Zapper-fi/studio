...
export type VelaVault = typeof velaVaultAbi;
export type VelaVaultContract = GetContractReturnType<VelaVault, PublicClient>;

export class VelaVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: velaVaultAbi, publicClient: client });
  }
}
