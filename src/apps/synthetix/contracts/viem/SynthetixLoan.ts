...
export type SynthetixLoan = typeof synthetixLoanAbi;
export type SynthetixLoanContract = GetContractReturnType<SynthetixLoan, PublicClient>;

export class SynthetixLoan__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: synthetixLoanAbi, publicClient: client });
  }
}
