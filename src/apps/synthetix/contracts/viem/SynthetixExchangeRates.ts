...
export const synthetixExchangeRatesAbi = [
  {
    inputs: [
      {
...
export type SynthetixExchangeRates = typeof synthetixExchangeRatesAbi;
export type SynthetixExchangeRatesContract = GetContractReturnType<SynthetixExchangeRates, PublicClient>;

export class SynthetixExchangeRates__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: synthetixExchangeRatesAbi, publicClient: client });
  }
}
