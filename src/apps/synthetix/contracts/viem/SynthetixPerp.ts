...
export type SynthetixPerp = typeof synthetixPerpAbi;
export type SynthetixPerpContract = GetContractReturnType<SynthetixPerp, PublicClient>;

export class SynthetixPerp__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: synthetixPerpAbi, publicClient: client });
  }
}
