...
export const synthetixNetworkTokenAbi = [
  {
    constant: true,
    inputs: [],
    name: 'resolver',
...
export type SynthetixNetworkToken = typeof synthetixNetworkTokenAbi;
export type SynthetixNetworkTokenContract = GetContractReturnType<SynthetixNetworkToken, PublicClient>;

export class SynthetixNetworkToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: synthetixNetworkTokenAbi, publicClient: client });
  }
}
