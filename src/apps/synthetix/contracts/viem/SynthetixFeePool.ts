...
export const synthetixFeePoolAbi = [
  {
    inputs: [
      {
...
export type SynthetixFeePool = typeof synthetixFeePoolAbi;
export type SynthetixFeePoolContract = GetContractReturnType<SynthetixFeePool, PublicClient>;

export class SynthetixFeePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: synthetixFeePoolAbi, publicClient: client });
  }
}
