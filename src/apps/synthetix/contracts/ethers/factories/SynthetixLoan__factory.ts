...
import type { SynthetixLoan, SynthetixLoanInterface } from '../SynthetixLoan';
...
export class SynthetixLoan__factory {
  ...
  static createInterface(): SynthetixLoanInterface {
    return new utils.Interface(_abi) as SynthetixLoanInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SynthetixLoan {
    return new Contract(address, _abi, signerOrProvider) as SynthetixLoan;
  }
}
