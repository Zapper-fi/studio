...
import type { SynthetixExchangeRates, SynthetixExchangeRatesInterface } from '../SynthetixExchangeRates';
...
export class SynthetixExchangeRates__factory {
  ...
  static createInterface(): SynthetixExchangeRatesInterface {
    return new utils.Interface(_abi) as SynthetixExchangeRatesInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SynthetixExchangeRates {
    return new Contract(address, _abi, signerOrProvider) as SynthetixExchangeRates;
  }
}
