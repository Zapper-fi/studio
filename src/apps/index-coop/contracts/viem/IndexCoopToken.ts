...
export const indexCoopTokenAbi = [
  {
    inputs: [
      {
...
export type IndexCoopToken = typeof indexCoopTokenAbi;
export type IndexCoopTokenContract = GetContractReturnType<IndexCoopToken, PublicClient>;

export class IndexCoopToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: indexCoopTokenAbi, publicClient: client });
  }
}
