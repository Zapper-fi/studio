...
export type GmxVault = typeof gmxVaultAbi;
export type GmxVaultContract = GetContractReturnType<GmxVault, PublicClient>;

export class GmxVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: gmxVaultAbi, publicClient: client });
  }
}
