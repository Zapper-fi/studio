...
export interface GmxRewardTrackerInterface extends utils.Interface {
  functions: {
...
export interface GmxRewardTracker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GmxRewardTrackerInterface;
