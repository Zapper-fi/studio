...
export interface SealightswapFactoryInterface extends utils.Interface {
  functions: {
...
export interface SealightswapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SealightswapFactoryInterface;
