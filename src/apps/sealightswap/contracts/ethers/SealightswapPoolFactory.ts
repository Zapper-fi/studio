...
export interface SealightswapPoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface SealightswapPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SealightswapPoolFactoryInterface;
