...
export const wombatExchangePoolAbi = [
  {
    inputs: [],
    name: 'CORE_UNDERFLOW',
    type: 'error',
...
export type WombatExchangePool = typeof wombatExchangePoolAbi;
export type WombatExchangePoolContract = GetContractReturnType<WombatExchangePool, PublicClient>;

export class WombatExchangePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: wombatExchangePoolAbi, publicClient: client });
  }
}
