...
import type { WombatExchangePool, WombatExchangePoolInterface } from '../WombatExchangePool';
...
export class WombatExchangePool__factory {
  static readonly abi = _abi;
  static createInterface(): WombatExchangePoolInterface {
    return new utils.Interface(_abi) as WombatExchangePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): WombatExchangePool {
    return new Contract(address, _abi, signerOrProvider) as WombatExchangePool;
  }
}
