...
import type { WombatExchangeMasterWombat, WombatExchangeMasterWombatInterface } from '../WombatExchangeMasterWombat';
...
export class WombatExchangeMasterWombat__factory {
  ...
  static createInterface(): WombatExchangeMasterWombatInterface {
    return new utils.Interface(_abi) as WombatExchangeMasterWombatInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): WombatExchangeMasterWombat {
    return new Contract(address, _abi, signerOrProvider) as WombatExchangeMasterWombat;
  }
}
