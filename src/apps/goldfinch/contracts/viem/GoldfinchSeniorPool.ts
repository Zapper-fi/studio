...
export const goldfinchSeniorPoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type GoldfinchSeniorPool = typeof goldfinchSeniorPoolAbi;
export type GoldfinchSeniorPoolContract = GetContractReturnType<GoldfinchSeniorPool, PublicClient>;

export class GoldfinchSeniorPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: goldfinchSeniorPoolAbi, publicClient: client });
  }
}
