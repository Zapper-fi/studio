...
export const goldfinchStakingRewardsAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type GoldfinchStakingRewards = typeof goldfinchStakingRewardsAbi;
export type GoldfinchStakingRewardsContract = GetContractReturnType<GoldfinchStakingRewards, PublicClient>;

export class GoldfinchStakingRewards__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: goldfinchStakingRewardsAbi, publicClient: client });
  }
}
