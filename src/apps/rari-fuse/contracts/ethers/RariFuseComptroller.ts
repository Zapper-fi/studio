...
export interface RariFuseComptrollerInterface extends utils.Interface {
  functions: {
...
export interface RariFuseComptroller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RariFuseComptrollerInterface;
