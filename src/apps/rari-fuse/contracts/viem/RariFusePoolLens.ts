...
export const rariFusePoolLensAbi = [
  {
    inputs: [],
    name: 'directory',
    outputs: [
...
export type RariFusePoolLens = typeof rariFusePoolLensAbi;
export type RariFusePoolLensContract = GetContractReturnType<RariFusePoolLens, PublicClient>;

export class RariFusePoolLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rariFusePoolLensAbi, publicClient: client });
  }
}
