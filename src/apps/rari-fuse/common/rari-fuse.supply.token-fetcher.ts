...
> {
  ...
  async getDefinitions({ multicall }: GetDefinitionStageParams) {
  ...
  getUnderlyingTokenAddresses({ contract }: GetUnderlyingTokensStageParams<RariFuseToken>) {
  ...
  async getPricePerShare({
    contract,
    appToken,
  }: GetPricePerShareStageParams<RariFuseToken, RariFuseSupplyTokenDataProps, RariFuseSupplyTokenDefinition>) {
  ...
  async getDataProps({
    ...
    definition,
    appToken,
  }: GetDataPropsStageParams<RariFuseToken, RariFuseSupplyTokenDataProps, RariFuseSupplyTokenDefinition>) {
  ...
  async getLabel({
    appToken,
  }: GetDisplayPropsStageParams<RariFuseToken, RariFuseSupplyTokenDataProps, RariFuseSupplyTokenDefinition>) {
