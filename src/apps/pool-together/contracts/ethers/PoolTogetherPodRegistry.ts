...
export interface PoolTogetherPodRegistryInterface extends utils.Interface {
  functions: {
...
export interface PoolTogetherPodRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolTogetherPodRegistryInterface;
