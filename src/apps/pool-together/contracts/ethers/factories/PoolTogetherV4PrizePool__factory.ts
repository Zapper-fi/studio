...
import type { PoolTogetherV4PrizePool, PoolTogetherV4PrizePoolInterface } from '../PoolTogetherV4PrizePool';
...
export class PoolTogetherV4PrizePool__factory {
  static readonly abi = _abi;
  static createInterface(): PoolTogetherV4PrizePoolInterface {
    return new utils.Interface(_abi) as PoolTogetherV4PrizePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolTogetherV4PrizePool {
    return new Contract(address, _abi, signerOrProvider) as PoolTogetherV4PrizePool;
  }
}
