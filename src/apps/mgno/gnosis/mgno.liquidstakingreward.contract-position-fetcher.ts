...
const groupId = MGNO_DEFINITION.groups.liquidstakingreward.id;
const network = Network.GNOSIS_MAINNET;

@Register.ContractPositionFetcher({ appId, groupId, network })
export class GnosisMgnoLiquidstakingrewardContractPositionFetcher implements PositionFetcher<ContractPosition> {
  constructor(
