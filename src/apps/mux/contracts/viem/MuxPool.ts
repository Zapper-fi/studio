...
export type MuxPool = typeof muxPoolAbi;
export type MuxPoolContract = GetContractReturnType<MuxPool, PublicClient>;

export class MuxPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: muxPoolAbi, publicClient: client });
  }
}
