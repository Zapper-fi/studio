...
export type MuxReader = typeof muxReaderAbi;
export type MuxReaderContract = GetContractReturnType<MuxReader, PublicClient>;

export class MuxReader__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: muxReaderAbi, publicClient: client });
  }
}
