...
export const muxRewardTrackerAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type MuxRewardTracker = typeof muxRewardTrackerAbi;
export type MuxRewardTrackerContract = GetContractReturnType<MuxRewardTracker, PublicClient>;

export class MuxRewardTracker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: muxRewardTrackerAbi, publicClient: client });
  }
}
