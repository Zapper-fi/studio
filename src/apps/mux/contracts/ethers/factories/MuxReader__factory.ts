...
import type { MuxReader, MuxReaderInterface } from '../MuxReader';
    ...
    outputs: [
      {
        components: [
          {
            components: [
              {
                internalType: "uint32",
                name: "shortFundingBaseRate8H",
                type: "uint32",
              },
              {
                internalType: "uint32",
                name: "shortFundingLimitRate8H",
                type: "uint32",
              },
              {
                internalType: "uint32",
              ...
              {
                internalType: "uint32",
                name: "liquidityBaseFeeRate",
                type: "uint32",
              },
              {
                internalType: "uint32",
                name: "liquidityDynamicFeeRate",
                type: "uint32",
              },
              {
                internalType: "uint96",
                name: "mlpPriceLowerBound",
                type: "uint96",
              },
              {
                internalType: "uint96",
                name: "mlpPriceUpperBound",
                type: "uint96",
              },
              {
                internalType: "uint32",
              ...
              {
                internalType: "uint32",
                name: "strictStableDeviation",
                type: "uint32",
              },
            ],
            internalType: "struct Reader.PoolStorage",
            name: "pool",
            type: "tuple",
          },
          {
          ...
          },
          {
            ...
            internalType: "struct Reader.DexStorage[]",
            name: "dexes",
            type: "tuple[]",
          },
          {
        ...
        internalType: "struct Reader.ChainStorage",
        name: "chain",
        type: "tuple",
      },
    ],
...
export class MuxReader__factory {
  static readonly abi = _abi;
  static createInterface(): MuxReaderInterface {
    return new utils.Interface(_abi) as MuxReaderInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MuxReader {
    return new Contract(address, _abi, signerOrProvider) as MuxReader;
  }
}
