...
import type { MuxPool, MuxPoolInterface } from '../MuxPool';
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint96",
        name: "newMlpPriceLowerBound",
        type: "uint96",
      },
      {
        internalType: "uint96",
        name: "newMlpPriceUpperBound",
        type: "uint96",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "enum ReferenceOracleType",
        name: "referenceOracleType",
        type: "uint8",
      },
      {
...
export class MuxPool__factory {
  static readonly abi = _abi;
  static createInterface(): MuxPoolInterface {
    return new utils.Interface(_abi) as MuxPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MuxPool {
    return new Contract(address, _abi, signerOrProvider) as MuxPool;
  }
}
