...
import type { MuxRewardRouter, MuxRewardRouterInterface } from '../MuxRewardRouter';
...
export class MuxRewardRouter__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MuxRewardRouter {
    return new Contract(address, _abi, signerOrProvider) as MuxRewardRouter;
  }
}
