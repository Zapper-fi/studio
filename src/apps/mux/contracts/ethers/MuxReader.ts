...
export type PositionOrderExtraStructOutput = [BigNumber, BigNumber, number, number] & {
  tpPrice: BigNumber;
  slPrice: BigNumber;
...
export interface MuxReaderInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getPositionOrdersExtra', values: [PromiseOrValue<BigNumberish>[]]): string;
...
export interface MuxReader extends BaseContract {
  ...
  estimateGas: {
    ...
    getPositionOrdersExtra(orderIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
