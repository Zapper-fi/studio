...
import type { SaddleCommunalFarm, SaddleCommunalFarmInterface } from '../SaddleCommunalFarm';
...
export class SaddleCommunalFarm__factory {
  ...
  static createInterface(): SaddleCommunalFarmInterface {
    return new utils.Interface(_abi) as SaddleCommunalFarmInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SaddleCommunalFarm {
    return new Contract(address, _abi, signerOrProvider) as SaddleCommunalFarm;
  }
}
