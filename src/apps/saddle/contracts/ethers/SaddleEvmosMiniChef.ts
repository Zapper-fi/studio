...
export interface SaddleEvmosMiniChefInterface extends utils.Interface {
  functions: {
...
export interface SaddleEvmosMiniChef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SaddleEvmosMiniChefInterface;
