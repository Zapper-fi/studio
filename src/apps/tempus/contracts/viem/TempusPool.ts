...
export const tempusPoolAbi = [
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct ITempusFees.FeesConfig',
        name: 'maxFeeSetup',
        type: 'tuple',
      },
      {
  ...
  {
    inputs: [],
    name: 'maximumNegativeYieldDuration',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IPoolShare',
        name: '',
        type: 'address',
      },
    ],
...
export type TempusPool = typeof tempusPoolAbi;
export type TempusPoolContract = GetContractReturnType<TempusPool, PublicClient>;

export class TempusPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: tempusPoolAbi, publicClient: client });
  }
}
