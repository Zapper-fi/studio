...
export interface HectorDaoBondDepositoryInterface extends utils.Interface {
  functions: {
...
export interface HectorDaoBondDepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HectorDaoBondDepositoryInterface;
