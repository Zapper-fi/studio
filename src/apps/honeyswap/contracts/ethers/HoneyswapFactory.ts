...
export interface HoneyswapFactoryInterface extends utils.Interface {
  functions: {
...
export interface HoneyswapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HoneyswapFactoryInterface;
