...
export type KwentaEscrow = typeof kwentaEscrowAbi;
export type KwentaEscrowContract = GetContractReturnType<KwentaEscrow, PublicClient>;

export class KwentaEscrow__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: kwentaEscrowAbi, publicClient: client });
  }
}
