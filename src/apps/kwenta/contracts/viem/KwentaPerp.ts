...
export type KwentaPerp = typeof kwentaPerpAbi;
export type KwentaPerpContract = GetContractReturnType<KwentaPerp, PublicClient>;

export class KwentaPerp__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: kwentaPerpAbi, publicClient: client });
  }
}
