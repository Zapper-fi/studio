...
export const kwentaStakingV2Abi = [
  {
    inputs: [
      {
...
export type KwentaStakingV2 = typeof kwentaStakingV2Abi;
export type KwentaStakingV2Contract = GetContractReturnType<KwentaStakingV2, PublicClient>;

export class KwentaStakingV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: kwentaStakingV2Abi, publicClient: client });
  }
}
