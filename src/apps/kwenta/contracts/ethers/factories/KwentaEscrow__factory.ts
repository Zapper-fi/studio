...
import type { KwentaEscrow, KwentaEscrowInterface } from '../KwentaEscrow';
...
export class KwentaEscrow__factory {
  ...
  static createInterface(): KwentaEscrowInterface {
    return new utils.Interface(_abi) as KwentaEscrowInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): KwentaEscrow {
    return new Contract(address, _abi, signerOrProvider) as KwentaEscrow;
  }
}
