...
import type { KwentaStakingV2, KwentaStakingV2Interface } from '../KwentaStakingV2';
...
const _abi = [
    ...
    inputs: [
      {
        ...
        name: 'maxCooldownPeriod',
        type: 'uint256',
      },
    ],
    name: 'CooldownPeriodTooHigh',
    type: 'error',
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: 'minCooldownPeriod',
        type: 'uint256',
      },
    ],
    name: 'CooldownPeriodTooLow',
    type: 'error',
  },
  {
    inputs: [
  ...
  },
  {
    ...
    name: 'InsufficientUnstakedEscrow',
    type: 'error',
  },
  {
    inputs: [
  ...
  },
  {
    ...
    name: 'unstakeEscrowSkipCooldown',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
export class KwentaStakingV2__factory {
  static readonly abi = _abi;
  static createInterface(): KwentaStakingV2Interface {
    return new utils.Interface(_abi) as KwentaStakingV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): KwentaStakingV2 {
    return new Contract(address, _abi, signerOrProvider) as KwentaStakingV2;
  }
}
