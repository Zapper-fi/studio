...
import type { KwentaFutures, KwentaFuturesInterface } from '../KwentaFutures';
...
export class KwentaFutures__factory {
  static readonly abi = _abi;
  static createInterface(): KwentaFuturesInterface {
    return new utils.Interface(_abi) as KwentaFuturesInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): KwentaFutures {
    return new Contract(address, _abi, signerOrProvider) as KwentaFutures;
  }
}
