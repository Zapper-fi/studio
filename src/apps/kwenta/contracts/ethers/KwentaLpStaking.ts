...
export interface KwentaLpStakingInterface extends utils.Interface {
  functions: {
...
export interface KwentaLpStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KwentaLpStakingInterface;
