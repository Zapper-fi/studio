...
import type { ReflexerUniswapV2SafeSavior, ReflexerUniswapV2SafeSaviorInterface } from '../ReflexerUniswapV2SafeSavior';
...
export class ReflexerUniswapV2SafeSavior__factory {
  ...
  static createInterface(): ReflexerUniswapV2SafeSaviorInterface {
    return new utils.Interface(_abi) as ReflexerUniswapV2SafeSaviorInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ReflexerUniswapV2SafeSavior {
    return new Contract(address, _abi, signerOrProvider) as ReflexerUniswapV2SafeSavior;
  }
}
