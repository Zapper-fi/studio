...
export interface ReflexerSafeJoinInterface extends utils.Interface {
  functions: {
...
export interface ReflexerSafeJoin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReflexerSafeJoinInterface;
  ...
  filters: {
    ...
    'Exit(address,address,uint256)'(sender?: null, usr?: null, wad?: null): ExitEventFilter;
    Exit(sender?: null, usr?: null, wad?: null): ExitEventFilter;

    'Join(address,address,uint256)'(sender?: null, usr?: null, wad?: null): JoinEventFilter;
    Join(sender?: null, usr?: null, wad?: null): JoinEventFilter;
