...
export type AuraLocker = typeof auraLockerAbi;
export type AuraLockerContract = GetContractReturnType<AuraLocker, PublicClient>;

export class AuraLocker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: auraLockerAbi, publicClient: client });
  }
}
