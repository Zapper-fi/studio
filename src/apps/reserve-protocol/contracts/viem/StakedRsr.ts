...
export type StakedRsr = typeof stakedRsrAbi;
export type StakedRsrContract = GetContractReturnType<StakedRsr, PublicClient>;

export class StakedRsr__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakedRsrAbi, publicClient: client });
  }
}
