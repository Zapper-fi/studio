...
export type Rtoken = typeof rtokenAbi;
export type RtokenContract = GetContractReturnType<Rtoken, PublicClient>;

export class Rtoken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rtokenAbi, publicClient: client });
  }
}
