...
export type Main = typeof mainAbi;
export type MainContract = GetContractReturnType<Main, PublicClient>;

export class Main__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: mainAbi, publicClient: client });
  }
}
