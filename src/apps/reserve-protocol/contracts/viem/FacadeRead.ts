...
export type FacadeRead = typeof facadeReadAbi;
export type FacadeReadContract = GetContractReturnType<FacadeRead, PublicClient>;

export class FacadeRead__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: facadeReadAbi, publicClient: client });
  }
}
