...
export const poolTogetherV3PoolWithMultipleWinnersBuilderAbi = [
  {
    inputs: [
      {
...
export type PoolTogetherV3PoolWithMultipleWinnersBuilder = typeof poolTogetherV3PoolWithMultipleWinnersBuilderAbi;
export type PoolTogetherV3PoolWithMultipleWinnersBuilderContract = GetContractReturnType<
...
export class PoolTogetherV3PoolWithMultipleWinnersBuilder__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV3PoolWithMultipleWinnersBuilderAbi, publicClient: client });
  }
}
