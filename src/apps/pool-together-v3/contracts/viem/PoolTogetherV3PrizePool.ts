...
export const poolTogetherV3PrizePoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PoolTogetherV3PrizePool = typeof poolTogetherV3PrizePoolAbi;
export type PoolTogetherV3PrizePoolContract = GetContractReturnType<PoolTogetherV3PrizePool, PublicClient>;

export class PoolTogetherV3PrizePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV3PrizePoolAbi, publicClient: client });
  }
}
