...
export const poolTogetherV3CommunityPrizePoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PoolTogetherV3CommunityPrizePool = typeof poolTogetherV3CommunityPrizePoolAbi;
export type PoolTogetherV3CommunityPrizePoolContract = GetContractReturnType<
...
export class PoolTogetherV3CommunityPrizePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV3CommunityPrizePoolAbi, publicClient: client });
  }
}
