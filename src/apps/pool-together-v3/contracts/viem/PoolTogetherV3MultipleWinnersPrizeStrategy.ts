...
export const poolTogetherV3MultipleWinnersPrizeStrategyAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PoolTogetherV3MultipleWinnersPrizeStrategy = typeof poolTogetherV3MultipleWinnersPrizeStrategyAbi;
export type PoolTogetherV3MultipleWinnersPrizeStrategyContract = GetContractReturnType<
...
export class PoolTogetherV3MultipleWinnersPrizeStrategy__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV3MultipleWinnersPrizeStrategyAbi, publicClient: client });
  }
}
