...
export const poolTogetherV3MultipleWinnersAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PoolTogetherV3MultipleWinners = typeof poolTogetherV3MultipleWinnersAbi;
export type PoolTogetherV3MultipleWinnersContract = GetContractReturnType<PoolTogetherV3MultipleWinners, PublicClient>;

export class PoolTogetherV3MultipleWinners__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolTogetherV3MultipleWinnersAbi, publicClient: client });
  }
}
