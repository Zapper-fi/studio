...
export interface UniswapV3PoolInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'secondsOutside', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'secondsInside', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'secondsOutside', data: BytesLike): Result;
...
export type SwapEvent = TypedEvent<[string, string, BigNumber, BigNumber, BigNumber, number], SwapEventObject>;
...
export interface UniswapV3Pool extends BaseContract {
  ...
  functions: {
    ...
    secondsOutside(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    secondsOutside(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
