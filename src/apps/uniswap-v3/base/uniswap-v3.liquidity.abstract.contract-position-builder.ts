...
} from '../common/uniswap-v3.liquidity.types';
import { getClaimable } from '../common/uniswap-v3.liquidity.utils';
...
> {
  ...
  async buildPosition({
    ...
    const [slot, tickSpacing, liquidity, feeGrowth0, feeGrowth1, ticksLower, ticksUpper] = await Promise.all([
