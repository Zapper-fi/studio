...
import type { VectorFinanceMasterChef, VectorFinanceMasterChefInterface } from '../VectorFinanceMasterChef';
...
export class VectorFinanceMasterChef__factory {
  ...
  static createInterface(): VectorFinanceMasterChefInterface {
    return new utils.Interface(_abi) as VectorFinanceMasterChefInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VectorFinanceMasterChef {
    return new Contract(address, _abi, signerOrProvider) as VectorFinanceMasterChef;
  }
}
