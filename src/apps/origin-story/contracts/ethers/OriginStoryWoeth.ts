...
export interface OriginStoryWoethInterface extends utils.Interface {
  functions: {
...
export interface OriginStoryWoeth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OriginStoryWoethInterface;
