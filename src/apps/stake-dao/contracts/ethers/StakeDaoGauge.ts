...
export interface StakeDaoGaugeInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'set_claimer', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'claim_rewards_for', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'set_claimer', data: BytesLike): Result;
...
export interface StakeDaoGauge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeDaoGaugeInterface;
  ...
  callStatic: {
    ...
    set_claimer(_claimer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
