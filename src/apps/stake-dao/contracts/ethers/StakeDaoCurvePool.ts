...
export interface StakeDaoCurvePoolInterface extends utils.Interface {
  functions: {
...
export interface StakeDaoCurvePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeDaoCurvePoolInterface;
