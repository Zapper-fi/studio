...
import type { StakeDaoMultiGauge, StakeDaoMultiGaugeInterface } from '../StakeDaoMultiGauge';
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IStakeDaoVault',
        name: '',
        type: 'address',
      },
    ],
...
export class StakeDaoMultiGauge__factory {
  static readonly abi = _abi;
  static createInterface(): StakeDaoMultiGaugeInterface {
    return new utils.Interface(_abi) as StakeDaoMultiGaugeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): StakeDaoMultiGauge {
    return new Contract(address, _abi, signerOrProvider) as StakeDaoMultiGauge;
  }
}
