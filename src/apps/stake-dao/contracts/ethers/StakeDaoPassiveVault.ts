...
export interface StakeDaoPassiveVaultInterface extends utils.Interface {
  functions: {
...
export interface StakeDaoPassiveVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeDaoPassiveVaultInterface;
