...
export type StakeDaoGauge = typeof stakeDaoGaugeAbi;
export type StakeDaoGaugeContract = GetContractReturnType<StakeDaoGauge, PublicClient>;

export class StakeDaoGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakeDaoGaugeAbi, publicClient: client });
  }
}
