...
export const stakeDaoMultiGaugeAbi = [
  {
    inputs: [
      {
...
export type StakeDaoMultiGauge = typeof stakeDaoMultiGaugeAbi;
export type StakeDaoMultiGaugeContract = GetContractReturnType<StakeDaoMultiGauge, PublicClient>;

export class StakeDaoMultiGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakeDaoMultiGaugeAbi, publicClient: client });
  }
}
