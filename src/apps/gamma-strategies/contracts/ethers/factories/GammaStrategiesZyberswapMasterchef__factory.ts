...
import type {
  ...
  GammaStrategiesZyberswapMasterchefInterface,
} from '../GammaStrategiesZyberswapMasterchef';
...
export class GammaStrategiesZyberswapMasterchef__factory {
  ...
  static createInterface(): GammaStrategiesZyberswapMasterchefInterface {
    return new utils.Interface(_abi) as GammaStrategiesZyberswapMasterchefInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): GammaStrategiesZyberswapMasterchef {
    return new Contract(address, _abi, signerOrProvider) as GammaStrategiesZyberswapMasterchef;
  }
}
