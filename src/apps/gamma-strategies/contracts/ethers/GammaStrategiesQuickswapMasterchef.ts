...
export interface GammaStrategiesQuickswapMasterchefInterface extends utils.Interface {
  functions: {
...
export interface GammaStrategiesQuickswapMasterchef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GammaStrategiesQuickswapMasterchefInterface;
