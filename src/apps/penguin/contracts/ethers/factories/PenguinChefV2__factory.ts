...
import type { PenguinChefV2, PenguinChefV2Interface } from '../PenguinChefV2';
...
const _abi = [
  {
    ...
    inputs: [
      ...
      {
        type: 'address',
        name: '_nestAllocatorAddress',
        internalType: 'address',
      },
      {
        type: 'address',
        name: '_performanceFeeAddress',
        internalType: 'address',
      },
      {
        type: 'uint256',
        name: '_pefiEmissionPerSecond',
        internalType: 'uint256',
      },
    ],
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        type: 'address',
        name: '_strategy',
        internalType: 'contract IIglooStrategy',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    inputs: [
      {
        type: 'uint256',
        name: '_defaultIpefiDistributionBips',
        internalType: 'uint256',
      },
    ],
  },
...
export class PenguinChefV2__factory {
  static readonly abi = _abi;
  static createInterface(): PenguinChefV2Interface {
    return new utils.Interface(_abi) as PenguinChefV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PenguinChefV2 {
    return new Contract(address, _abi, signerOrProvider) as PenguinChefV2;
  }
}
