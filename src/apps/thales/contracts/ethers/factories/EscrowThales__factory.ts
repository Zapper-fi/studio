...
import type { EscrowThales, EscrowThalesInterface } from '../EscrowThales';
...
export class EscrowThales__factory {
  static readonly abi = _abi;
  static createInterface(): EscrowThalesInterface {
    return new utils.Interface(_abi) as EscrowThalesInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EscrowThales {
    return new Contract(address, _abi, signerOrProvider) as EscrowThales;
  }
}
