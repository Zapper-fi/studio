...
export type EscrowThales = typeof escrowThalesAbi;
export type EscrowThalesContract = GetContractReturnType<EscrowThales, PublicClient>;

export class EscrowThales__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: escrowThalesAbi, publicClient: client });
  }
}
