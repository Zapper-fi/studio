...
export type StakingThales = typeof stakingThalesAbi;
export type StakingThalesContract = GetContractReturnType<StakingThales, PublicClient>;

export class StakingThales__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakingThalesAbi, publicClient: client });
  }
}
