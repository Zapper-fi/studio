...
export const traderJoeChefV2Abi = [
  {
    type: 'constructor',
...
export type TraderJoeChefV2 = typeof traderJoeChefV2Abi;
export type TraderJoeChefV2Contract = GetContractReturnType<TraderJoeChefV2, PublicClient>;

export class TraderJoeChefV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: traderJoeChefV2Abi, publicClient: client });
  }
}
