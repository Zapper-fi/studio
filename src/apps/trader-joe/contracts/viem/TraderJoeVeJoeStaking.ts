...
export const traderJoeVeJoeStakingAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type TraderJoeVeJoeStaking = typeof traderJoeVeJoeStakingAbi;
export type TraderJoeVeJoeStakingContract = GetContractReturnType<TraderJoeVeJoeStaking, PublicClient>;

export class TraderJoeVeJoeStaking__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: traderJoeVeJoeStakingAbi, publicClient: client });
  }
}
