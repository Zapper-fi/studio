...
export interface TraderJoeChefBoostedRewarderInterface extends utils.Interface {
  functions: {
...
export interface TraderJoeChefBoostedRewarder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TraderJoeChefBoostedRewarderInterface;
