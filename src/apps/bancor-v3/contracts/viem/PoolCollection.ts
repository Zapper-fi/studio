...
export const poolCollectionAbi = [
  {
    inputs: [
      {
...
export type PoolCollection = typeof poolCollectionAbi;
export type PoolCollectionContract = GetContractReturnType<PoolCollection, PublicClient>;

export class PoolCollection__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolCollectionAbi, publicClient: client });
  }
}
