...
export const standardRewardsAbi = [
  {
    inputs: [
      {
...
export type StandardRewards = typeof standardRewardsAbi;
export type StandardRewardsContract = GetContractReturnType<StandardRewards, PublicClient>;

export class StandardRewards__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: standardRewardsAbi, publicClient: client });
  }
}
