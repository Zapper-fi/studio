...
export type BntPool = typeof bntPoolAbi;
export type BntPoolContract = GetContractReturnType<BntPool, PublicClient>;

export class BntPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: bntPoolAbi, publicClient: client });
  }
}
