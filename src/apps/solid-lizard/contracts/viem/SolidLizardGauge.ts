...
export const solidLizardGaugeAbi = [
  {
    inputs: [
      {
...
export type SolidLizardGauge = typeof solidLizardGaugeAbi;
export type SolidLizardGaugeContract = GetContractReturnType<SolidLizardGauge, PublicClient>;

export class SolidLizardGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: solidLizardGaugeAbi, publicClient: client });
  }
}
