...
import type { SolidLizardBribe, SolidLizardBribeInterface } from '../SolidLizardBribe';
...
export class SolidLizardBribe__factory {
  ...
  static createInterface(): SolidLizardBribeInterface {
    return new utils.Interface(_abi) as SolidLizardBribeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SolidLizardBribe {
    return new Contract(address, _abi, signerOrProvider) as SolidLizardBribe;
  }
}
