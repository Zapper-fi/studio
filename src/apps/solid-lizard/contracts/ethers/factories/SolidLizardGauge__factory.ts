...
import type { SolidLizardGauge, SolidLizardGaugeInterface } from '../SolidLizardGauge';
...
export class SolidLizardGauge__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): SolidLizardGauge {
