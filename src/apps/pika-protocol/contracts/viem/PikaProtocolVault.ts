...
export const pikaProtocolVaultAbi = [
  {
    inputs: [
      {
...
export type PikaProtocolVault = typeof pikaProtocolVaultAbi;
export type PikaProtocolVaultContract = GetContractReturnType<PikaProtocolVault, PublicClient>;

export class PikaProtocolVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pikaProtocolVaultAbi, publicClient: client });
  }
}
