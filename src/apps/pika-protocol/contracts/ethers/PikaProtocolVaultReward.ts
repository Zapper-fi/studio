...
export interface PikaProtocolVaultRewardInterface extends utils.Interface {
  functions: {
...
export interface PikaProtocolVaultReward extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PikaProtocolVaultRewardInterface;
