...
import type { GainsNetworkGToken, GainsNetworkGTokenInterface } from '../GainsNetworkGToken';
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType: 'struct GToken.GnsPriceProvider',
        name: 'newValue',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct GToken.ContractAddresses',
...
export class GainsNetworkGToken__factory {
  static readonly abi = _abi;
  static createInterface(): GainsNetworkGTokenInterface {
    return new utils.Interface(_abi) as GainsNetworkGTokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): GainsNetworkGToken {
    return new Contract(address, _abi, signerOrProvider) as GainsNetworkGToken;
  }
}
