...
export const gainsNetworkGTokenAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type GainsNetworkGToken = typeof gainsNetworkGTokenAbi;
export type GainsNetworkGTokenContract = GetContractReturnType<GainsNetworkGToken, PublicClient>;

export class GainsNetworkGToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: gainsNetworkGTokenAbi, publicClient: client });
  }
}
