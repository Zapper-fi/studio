...
export type DfxCurve = typeof dfxCurveAbi;
export type DfxCurveContract = GetContractReturnType<DfxCurve, PublicClient>;

export class DfxCurve__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dfxCurveAbi, publicClient: client });
  }
}
