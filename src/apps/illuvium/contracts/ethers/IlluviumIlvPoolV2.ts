...
export interface IlluviumIlvPoolV2Interface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'claimVaultRewardsMultiple', values: [PromiseOrValue<string>[]]): string;
  encodeFunctionData(functionFragment: 'claimYieldRewards', values: [PromiseOrValue<boolean>]): string;
  encodeFunctionData(
    functionFragment: 'claimYieldRewardsMultiple',
  ...
  encodeFunctionData(functionFragment: 'hasMigratedYield', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'mintV1YieldMultiple', values: [PromiseOrValue<BigNumberish>[]]): string;
  ...
  encodeFunctionData(functionFragment: 'setV1PoolTokenReserve', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(
    functionFragment: 'v1YieldMinted',
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>],
  ): string;
...
export interface IlluviumIlvPoolV2 extends BaseContract {
  ...
  functions: {
    ...
    executeMigration(
      ...
      _yieldWeight: PromiseOrValue<BigNumberish>,
      _pendingV1Rewards: PromiseOrValue<BigNumberish>,
      _useSILV: PromiseOrValue<boolean>,
    ...
    hasMigratedYield(_index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    setV1PoolTokenReserve(
      _v1PoolTokenReserve: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    claimVaultRewardsMultiple(_pools: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;
    ...
    mintV1YieldMultiple(_stakeIds: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
    ...
    setV1PoolTokenReserve(_v1PoolTokenReserve: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    LogV1YieldMintedMultiple(from?: PromiseOrValue<string> | null, value?: null): LogV1YieldMintedMultipleEventFilter;
  ...
  estimateGas: {
    ...
    hasMigratedYield(_index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    hasMigratedYield(_index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
