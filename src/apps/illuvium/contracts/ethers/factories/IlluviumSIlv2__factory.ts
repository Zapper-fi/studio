...
import type { IlluviumSIlv2, IlluviumSIlv2Interface } from '../IlluviumSIlv2';
    ...
    outputs: [
      {
        ...
        internalType: 'struct EscrowedIlluvium2.VotingPowerRecord[]',
        name: '',
        type: 'tuple[]',
      },
    ],
...
export class IlluviumSIlv2__factory {
  static readonly abi = _abi;
  static createInterface(): IlluviumSIlv2Interface {
    return new utils.Interface(_abi) as IlluviumSIlv2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IlluviumSIlv2 {
    return new Contract(address, _abi, signerOrProvider) as IlluviumSIlv2;
  }
}
