...
import type { IlluviumCorePool, IlluviumCorePoolInterface } from '../IlluviumCorePool';
...
export class IlluviumCorePool__factory {
  ...
  static createInterface(): IlluviumCorePoolInterface {
    return new utils.Interface(_abi) as IlluviumCorePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IlluviumCorePool {
    return new Contract(address, _abi, signerOrProvider) as IlluviumCorePool;
  }
}
