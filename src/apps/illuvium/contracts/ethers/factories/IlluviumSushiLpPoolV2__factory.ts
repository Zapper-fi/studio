...
import type { IlluviumSushiLpPoolV2, IlluviumSushiLpPoolV2Interface } from '../IlluviumSushiLpPoolV2';
...
export class IlluviumSushiLpPoolV2__factory {
  ...
  static createInterface(): IlluviumSushiLpPoolV2Interface {
    return new utils.Interface(_abi) as IlluviumSushiLpPoolV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IlluviumSushiLpPoolV2 {
    return new Contract(address, _abi, signerOrProvider) as IlluviumSushiLpPoolV2;
  }
}
