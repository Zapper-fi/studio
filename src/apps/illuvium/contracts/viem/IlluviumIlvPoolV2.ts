...
export const illuviumIlvPoolV2Abi = [
  {
    inputs: [
      {
        internalType: 'bytes4',
...
export type IlluviumIlvPoolV2 = typeof illuviumIlvPoolV2Abi;
export type IlluviumIlvPoolV2Contract = GetContractReturnType<IlluviumIlvPoolV2, PublicClient>;

export class IlluviumIlvPoolV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: illuviumIlvPoolV2Abi, publicClient: client });
  }
}
