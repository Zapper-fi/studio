...
export type IlluviumSIlv2 = typeof illuviumSIlv2Abi;
export type IlluviumSIlv2Contract = GetContractReturnType<IlluviumSIlv2, PublicClient>;

export class IlluviumSIlv2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: illuviumSIlv2Abi, publicClient: client });
  }
}
