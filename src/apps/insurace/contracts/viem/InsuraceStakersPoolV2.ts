...
export const insuraceStakersPoolV2Abi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type InsuraceStakersPoolV2 = typeof insuraceStakersPoolV2Abi;
export type InsuraceStakersPoolV2Contract = GetContractReturnType<InsuraceStakersPoolV2, PublicClient>;

export class InsuraceStakersPoolV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: insuraceStakersPoolV2Abi, publicClient: client });
  }
}
