...
import { InsuraceMiningTokenDefinition, InsuraceMiningTokenFetcher } from '../common/insurace.mining.token-fetcher';
...
export class EthereumInsuraceMiningTokenFetcher extends InsuraceMiningTokenFetcher {
  ...
  async getDefinitions(): Promise<InsuraceMiningTokenDefinition[]> {
    ...
    return [...governanceMiningPools, ...underwritingMiningPools, ...liquidityMiningPools];
  }
}
