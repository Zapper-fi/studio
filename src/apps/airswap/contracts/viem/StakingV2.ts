...
export type StakingV2 = typeof stakingV2Abi;
export type StakingV2Contract = GetContractReturnType<StakingV2, PublicClient>;

export class StakingV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakingV2Abi, publicClient: client });
  }
}
