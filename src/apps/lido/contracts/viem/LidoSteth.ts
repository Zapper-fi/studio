...
export type LidoSteth = typeof lidoStethAbi;
export type LidoStethContract = GetContractReturnType<LidoSteth, PublicClient>;

export class LidoSteth__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lidoStethAbi, publicClient: client });
  }
}
