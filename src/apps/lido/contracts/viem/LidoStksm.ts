...
export type LidoStksm = typeof lidoStksmAbi;
export type LidoStksmContract = GetContractReturnType<LidoStksm, PublicClient>;

export class LidoStksm__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lidoStksmAbi, publicClient: client });
  }
}
