...
import type { AngleStablemaster, AngleStablemasterInterface } from '../AngleStablemaster';
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint64',
        name: '_bonusMalusMint',
        type: 'uint64',
      },
      {
        internalType: 'uint64',
        name: '_bonusMalusBurn',
        type: 'uint64',
      },
      {
        internalType: 'uint64',
...
export class AngleStablemaster__factory {
  static readonly abi = _abi;
  static createInterface(): AngleStablemasterInterface {
    return new utils.Interface(_abi) as AngleStablemasterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AngleStablemaster {
    return new Contract(address, _abi, signerOrProvider) as AngleStablemaster;
  }
}
