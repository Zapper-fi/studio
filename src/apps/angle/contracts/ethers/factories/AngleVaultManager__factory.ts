...
import type { AngleVaultManager, AngleVaultManagerInterface } from '../AngleVaultManager';
...
export class AngleVaultManager__factory {
  ...
  static createInterface(): AngleVaultManagerInterface {
    return new utils.Interface(_abi) as AngleVaultManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AngleVaultManager {
    return new Contract(address, _abi, signerOrProvider) as AngleVaultManager;
  }
}
