...
export interface AngleVeangle extends BaseContract {
  ...
  functions: {
    ...
    getPastVotes(addr: string, _block: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getPastVotes(addr: string, _block: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
