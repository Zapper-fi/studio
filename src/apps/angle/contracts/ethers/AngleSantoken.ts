...
export interface AngleSantokenInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'burnNoRedeem', values: [BigNumberish]): string;
...
export interface AngleSantoken extends BaseContract {
  ...
  callStatic: {
    ...
    burnNoRedeem(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    initialize(name_: string, symbol_: string, _poolManager: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    burnNoRedeem(amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
