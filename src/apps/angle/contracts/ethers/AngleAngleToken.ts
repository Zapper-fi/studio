...
export interface AngleAngleTokenInterface extends utils.Interface {
  functions: {
    'DOMAIN_SEPARATOR()': FunctionFragment;
    'MAX_MINT()': FunctionFragment;
    'MINIMUM_BETWEEN_MINTS()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'MINIMUM_BETWEEN_MINTS', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'MINIMUM_BETWEEN_MINTS', data: BytesLike): Result;
...
export interface AngleAngleToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AngleAngleTokenInterface;
  ...
  functions: {
    ...
    MINIMUM_BETWEEN_MINTS(overrides?: CallOverrides): Promise<[number]>;
  ...
  setMinter(minter_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    mint(dst: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    MINIMUM_BETWEEN_MINTS(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setMinter(minter_: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    MINIMUM_BETWEEN_MINTS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
