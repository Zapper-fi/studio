...
export const anglePoolManagerAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type AnglePoolManager = typeof anglePoolManagerAbi;
export type AnglePoolManagerContract = GetContractReturnType<AnglePoolManager, PublicClient>;

export class AnglePoolManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: anglePoolManagerAbi, publicClient: client });
  }
}
