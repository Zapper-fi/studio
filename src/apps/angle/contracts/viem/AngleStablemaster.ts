...
export const angleStablemasterAbi = [
  {
    inputs: [],
...
export type AngleStablemaster = typeof angleStablemasterAbi;
export type AngleStablemasterContract = GetContractReturnType<AngleStablemaster, PublicClient>;

export class AngleStablemaster__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: angleStablemasterAbi, publicClient: client });
  }
}
