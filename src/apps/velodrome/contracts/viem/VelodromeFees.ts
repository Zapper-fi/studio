...
export type VelodromeFees = typeof velodromeFeesAbi;
export type VelodromeFeesContract = GetContractReturnType<VelodromeFees, PublicClient>;

export class VelodromeFees__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: velodromeFeesAbi, publicClient: client });
  }
}
