...
export type VelodromeGauge = typeof velodromeGaugeAbi;
export type VelodromeGaugeContract = GetContractReturnType<VelodromeGauge, PublicClient>;

export class VelodromeGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: velodromeGaugeAbi, publicClient: client });
  }
}
