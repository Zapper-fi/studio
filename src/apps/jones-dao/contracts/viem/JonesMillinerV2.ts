...
export const jonesMillinerV2Abi = [
  {
    inputs: [
      {
...
export type JonesMillinerV2 = typeof jonesMillinerV2Abi;
export type JonesMillinerV2Contract = GetContractReturnType<JonesMillinerV2, PublicClient>;

export class JonesMillinerV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: jonesMillinerV2Abi, publicClient: client });
  }
}
