...
export const eulerEtokenContractAbi = [
  {
...
export type EulerEtokenContract = typeof eulerEtokenContractAbi;
export type EulerEtokenContractContract = GetContractReturnType<EulerEtokenContract, PublicClient>;

export class EulerEtokenContract__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: eulerEtokenContractAbi, publicClient: client });
  }
}
