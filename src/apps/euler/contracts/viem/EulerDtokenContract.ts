...
export const eulerDtokenContractAbi = [
  {
...
export type EulerDtokenContract = typeof eulerDtokenContractAbi;
export type EulerDtokenContractContract = GetContractReturnType<EulerDtokenContract, PublicClient>;

export class EulerDtokenContract__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: eulerDtokenContractAbi, publicClient: client });
  }
}
