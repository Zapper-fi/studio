...
export interface EulerDtokenContractInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'approveDebt', values: [BigNumberish, string, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'balanceOf', values: [string]): string;
  encodeFunctionData(functionFragment: 'balanceOfExact', values: [string]): string;
  encodeFunctionData(functionFragment: 'borrow', values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: 'debtAllowance', values: [string, string]): string;
...
export interface EulerDtokenContract extends BaseContract {
  ...
  functions: {
    ...
    balanceOfExact(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    debtAllowance(holder: string, spender: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    borrow(subAccountId: BigNumberish, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    repay(subAccountId: BigNumberish, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    balanceOfExact(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    debtAllowance(holder: string, spender: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
