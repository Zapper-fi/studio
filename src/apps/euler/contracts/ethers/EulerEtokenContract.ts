...
export interface EulerEtokenContractInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'convertBalanceToUnderlying', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: 'convertUnderlyingToBalance', values: [PromiseOrValue<BigNumberish>]): string;
...
export interface EulerEtokenContract extends BaseContract {
  ...
  functions: {
    ...
    balanceOfUnderlying(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    convertBalanceToUnderlying(balance: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    touch(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    touch(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    balanceOfUnderlying(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    touch(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
