...
export type HalofiAbi = typeof halofiAbiAbi;
export type HalofiAbiContract = GetContractReturnType<HalofiAbi, PublicClient>;

export class HalofiAbi__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: halofiAbiAbi, publicClient: client });
  }
}
