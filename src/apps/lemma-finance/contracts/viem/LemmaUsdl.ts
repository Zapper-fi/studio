...
export type LemmaUsdl = typeof lemmaUsdlAbi;
export type LemmaUsdlContract = GetContractReturnType<LemmaUsdl, PublicClient>;

export class LemmaUsdl__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lemmaUsdlAbi, publicClient: client });
  }
}
