...
export class CeloSushiswapPoolTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
  ...
  getPositions() {
    return this.uniswapV2PoolTokenHelper.getTokens<UniswapFactory, UniswapPair>({
      ...
      resolvePoolVolumes: this.uniswapV2TheGraphPoolVolumeStrategy.build({
        subgraphUrl: 'https://thegraph.com/hosted-service/subgraph/sushiswap/celo-exchange',
        first: 500,
      }),
    });
  }
