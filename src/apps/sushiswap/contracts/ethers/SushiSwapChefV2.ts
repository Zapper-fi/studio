...
export interface SushiSwapChefV2Interface extends utils.Interface {
  functions: {
...
export interface SushiSwapChefV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiSwapChefV2Interface;
