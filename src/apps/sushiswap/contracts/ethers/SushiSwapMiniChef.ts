...
export interface SushiSwapMiniChefInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'setSushiPerSecond', values: [BigNumberish]): string;
...
export interface SushiSwapMiniChef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiSwapMiniChefInterface;
  ...
  callStatic: {
    ...
    setSushiPerSecond(_sushiPerSecond: BigNumberish, overrides?: CallOverrides): Promise<void>;
