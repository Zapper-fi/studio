...
export interface SushiSwapRewarderInterface extends utils.Interface {
  functions: {
...
export interface SushiSwapRewarder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiSwapRewarderInterface;
