...
export class EthereumKyberswapElasticLiquidityContractPositionFetcher extends KyberswapElasticLiquidityContractPositionFetcher {
  ...
  subgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/kyberswap-elastic-mainnet?source=zapper';
  ...
  blockSubgraphUrl = 'https://api.thegraph.com/subgraphs/name/dynamic-amm/ethereum-blocks-ethereum?source=zapper';
}
