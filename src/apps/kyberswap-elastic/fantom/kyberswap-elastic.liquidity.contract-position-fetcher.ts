...
export class FantomKyberswapElasticLiquidityContractPositionFetcher extends KyberswapElasticLiquidityContractPositionFetcher {
  ...
  subgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/kyberswap-elastic-fantom?source=zapper';
  ...
  blockSubgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/fantom-blocks?source=zapper';
}
