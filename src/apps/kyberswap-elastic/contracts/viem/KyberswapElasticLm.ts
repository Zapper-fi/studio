...
export const kyberswapElasticLmAbi = [
  {
    inputs: [
      {
...
export type KyberswapElasticLm = typeof kyberswapElasticLmAbi;
export type KyberswapElasticLmContract = GetContractReturnType<KyberswapElasticLm, PublicClient>;

export class KyberswapElasticLm__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: kyberswapElasticLmAbi, publicClient: client });
  }
}
