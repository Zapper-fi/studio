...
export type PositionManager = typeof positionManagerAbi;
export type PositionManagerContract = GetContractReturnType<PositionManager, PublicClient>;

export class PositionManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: positionManagerAbi, publicClient: client });
  }
}
