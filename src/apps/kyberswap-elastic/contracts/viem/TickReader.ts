...
export type TickReader = typeof tickReaderAbi;
export type TickReaderContract = GetContractReturnType<TickReader, PublicClient>;

export class TickReader__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: tickReaderAbi, publicClient: client });
  }
}
