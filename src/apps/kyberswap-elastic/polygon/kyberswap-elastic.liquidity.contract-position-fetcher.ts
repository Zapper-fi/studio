...
export class PolygonKyberswapElasticLiquidityContractPositionFetcher extends KyberswapElasticLiquidityContractPositionFetcher {
  ...
  subgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/kyberswap-elastic-matic?source=zapper';
  ...
  blockSubgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/polygon-blocks?source=zapper';
}
