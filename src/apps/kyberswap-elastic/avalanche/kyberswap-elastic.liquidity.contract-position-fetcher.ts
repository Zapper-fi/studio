...
export class AvalancheKyberswapElasticLiquidityContractPositionFetcher extends KyberswapElasticLiquidityContractPositionFetcher {
  ...
  subgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/kyberswap-elastic-avalanche?source=zapper';
  ...
  blockSubgraphUrl = 'https://api.thegraph.com/subgraphs/name/kybernetwork/avalanche-blocks?source=zapper';
}
