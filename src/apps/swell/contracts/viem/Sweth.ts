...
export type Sweth = typeof swethAbi;
export type SwethContract = GetContractReturnType<Sweth, PublicClient>;

export class Sweth__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: swethAbi, publicClient: client });
  }
}
