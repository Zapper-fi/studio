...
export const PANCAKESWAP_DEFINITION = appDefinition({
  ...
  groups: {
    syrupStaking: { id: 'syrup-staking', type: GroupType.POSITION, label: 'Syrup Pools', groupLabel: 'Pools' },
    syrupCake: { id: 'syrup-cake', type: GroupType.POSITION, label: 'Staked CAKE', groupLabel: 'Pools' },
    autoCake: { id: 'auto-cake', type: GroupType.POSITION, label: 'Auto CAKE', groupLabel: 'Pools' },
    ifoCake: { id: 'ifo-cake', type: GroupType.POSITION, label: 'IFO Cake', groupLabel: 'Farms' },
    farm: { id: 'farm', type: GroupType.POSITION, label: 'Legacy Farms', groupLabel: 'Farms' },
    farmV2: { id: 'farm-v2', type: GroupType.POSITION, label: 'Farms V2', groupLabel: 'Farms' },
