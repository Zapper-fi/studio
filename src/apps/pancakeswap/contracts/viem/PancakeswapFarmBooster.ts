...
export const pancakeswapFarmBoosterAbi = [
  {
    inputs: [
      {
...
export type PancakeswapFarmBooster = typeof pancakeswapFarmBoosterAbi;
export type PancakeswapFarmBoosterContract = GetContractReturnType<PancakeswapFarmBooster, PublicClient>;

export class PancakeswapFarmBooster__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pancakeswapFarmBoosterAbi, publicClient: client });
  }
}
