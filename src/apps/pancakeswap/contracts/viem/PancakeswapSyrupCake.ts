...
export const pancakeswapSyrupCakeAbi = [
  {
    inputs: [
      {
...
export type PancakeswapSyrupCake = typeof pancakeswapSyrupCakeAbi;
export type PancakeswapSyrupCakeContract = GetContractReturnType<PancakeswapSyrupCake, PublicClient>;

export class PancakeswapSyrupCake__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pancakeswapSyrupCakeAbi, publicClient: client });
  }
}
