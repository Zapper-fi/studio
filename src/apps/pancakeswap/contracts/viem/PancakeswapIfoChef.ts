...
export const pancakeswapIfoChefAbi = [
  {
    inputs: [
      {
...
export type PancakeswapIfoChef = typeof pancakeswapIfoChefAbi;
export type PancakeswapIfoChefContract = GetContractReturnType<PancakeswapIfoChef, PublicClient>;

export class PancakeswapIfoChef__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pancakeswapIfoChefAbi, publicClient: client });
  }
}
