...
export const pancakeswapChefV2Abi = [
  {
    inputs: [
      {
...
export type PancakeswapChefV2 = typeof pancakeswapChefV2Abi;
export type PancakeswapChefV2Contract = GetContractReturnType<PancakeswapChefV2, PublicClient>;

export class PancakeswapChefV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pancakeswapChefV2Abi, publicClient: client });
  }
}
