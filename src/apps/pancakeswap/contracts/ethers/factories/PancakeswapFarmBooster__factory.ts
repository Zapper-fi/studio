...
import type { PancakeswapFarmBooster, PancakeswapFarmBoosterInterface } from '../PancakeswapFarmBooster';
...
export class PancakeswapFarmBooster__factory {
  static readonly abi = _abi;
  static createInterface(): PancakeswapFarmBoosterInterface {
    return new utils.Interface(_abi) as PancakeswapFarmBoosterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PancakeswapFarmBooster {
    return new Contract(address, _abi, signerOrProvider) as PancakeswapFarmBooster;
  }
}
