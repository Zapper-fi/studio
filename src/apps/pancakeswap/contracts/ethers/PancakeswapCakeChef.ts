...
export interface PancakeswapCakeChefInterface extends utils.Interface {
  functions: {
...
export interface PancakeswapCakeChef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PancakeswapCakeChefInterface;
