...
import type { SpoolStaking, SpoolStakingInterface } from '../SpoolStaking';
...
export class SpoolStaking__factory {
  ...
  static createInterface(): SpoolStakingInterface {
    return new utils.Interface(_abi) as SpoolStakingInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SpoolStaking {
    return new Contract(address, _abi, signerOrProvider) as SpoolStaking;
  }
}
