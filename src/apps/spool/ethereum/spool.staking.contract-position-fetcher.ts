...
> {
  ...
  //   const now = parseInt(String(new Date().getTime() / 1000));
  //   const voSpoolContract = this.contractFactory.spoolVospool({ network, address: VOSPOOL_ADDRESS });
  ...
  //   const spoolContract = this.contractFactory.erc20({ network, address: spoolTokenAddress });
