...
export interface IqInterface extends utils.Interface {
  functions: {
...
export interface Iq extends BaseContract {
  ...
  callStatic: {
    ...
    setMinter(_addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
