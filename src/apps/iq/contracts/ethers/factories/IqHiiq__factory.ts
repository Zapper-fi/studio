...
import type { IqHiiq, IqHiiqInterface } from '../IqHiiq';
...
export class IqHiiq__factory {
  ...
  static createInterface(): IqHiiqInterface {
    return new utils.Interface(_abi) as IqHiiqInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IqHiiq {
    return new Contract(address, _abi, signerOrProvider) as IqHiiq;
  }
}
