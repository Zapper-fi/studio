...
export interface MyceliumMlpManagerInterface extends utils.Interface {
  functions: {
...
export interface MyceliumMlpManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyceliumMlpManagerInterface;
