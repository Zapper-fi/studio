...
export interface MyceliumPerpTokenInterface extends utils.Interface {
  functions: {
...
export interface MyceliumPerpToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyceliumPerpTokenInterface;
