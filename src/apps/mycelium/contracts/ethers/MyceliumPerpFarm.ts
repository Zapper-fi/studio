...
export interface MyceliumPerpFarmInterface extends utils.Interface {
  functions: {
...
export interface MyceliumPerpFarm extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyceliumPerpFarmInterface;
