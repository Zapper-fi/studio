...
export type MyceliumVault = typeof myceliumVaultAbi;
export type MyceliumVaultContract = GetContractReturnType<MyceliumVault, PublicClient>;

export class MyceliumVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: myceliumVaultAbi, publicClient: client });
  }
}
