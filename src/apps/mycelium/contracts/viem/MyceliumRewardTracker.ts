...
export const myceliumRewardTrackerAbi = [
  {
    inputs: [
      {
        internalType: 'string',
...
export type MyceliumRewardTracker = typeof myceliumRewardTrackerAbi;
export type MyceliumRewardTrackerContract = GetContractReturnType<MyceliumRewardTracker, PublicClient>;

export class MyceliumRewardTracker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: myceliumRewardTrackerAbi, publicClient: client });
  }
}
