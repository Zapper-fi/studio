...
import { VotiumErc20__factory } from './ethers';
...
export class VotiumContractFactory extends ContractFactory {
  ...
  votiumErc20({ address, network }: ContractOpts) {
    return VotiumErc20__factory.connect(address, this.appToolkit.getNetworkProvider(network));
  }
...
export type { VotiumErc20 } from './ethers';
