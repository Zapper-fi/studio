...
import type { LiquityStaking, LiquityStakingInterface } from '../LiquityStaking';
...
export class LiquityStaking__factory {
  static readonly abi = _abi;
  static createInterface(): LiquityStakingInterface {
    return new utils.Interface(_abi) as LiquityStakingInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): LiquityStaking {
    return new Contract(address, _abi, signerOrProvider) as LiquityStaking;
  }
}
