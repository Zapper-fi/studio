...
export const liquityStakingAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type LiquityStaking = typeof liquityStakingAbi;
export type LiquityStakingContract = GetContractReturnType<LiquityStaking, PublicClient>;

export class LiquityStaking__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: liquityStakingAbi, publicClient: client });
  }
}
