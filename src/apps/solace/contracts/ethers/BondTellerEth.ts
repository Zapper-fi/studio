...
export interface BondTellerEthInterface extends utils.Interface {
  functions: {
    ...
    'depositEth(uint256,address,bool)': FunctionFragment;
    'depositWeth(uint256,uint256,address,bool)': FunctionFragment;
    'depositWethSigned(uint256,uint256,address,bool,uint256,uint8,bytes32,bytes32)': FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: 'depositWethSigned', data: BytesLike): Result;
...
export interface BondTellerEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BondTellerEthInterface;
