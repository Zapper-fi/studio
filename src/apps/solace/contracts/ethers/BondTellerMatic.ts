...
export declare namespace BondTellerMatic {
...
export interface BondTellerMaticInterface extends utils.Interface {
  functions: {
    ...
    'depositMatic(uint256,address,bool)': FunctionFragment;
    'depositWmatic(uint256,uint256,address,bool)': FunctionFragment;
    'depositWmaticSigned(uint256,uint256,address,bool,uint256,uint8,bytes32,bytes32)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'depositMatic', values: [BigNumberish, string, boolean]): string;
  encodeFunctionData(functionFragment: 'depositWmatic', values: [BigNumberish, BigNumberish, string, boolean]): string;
  encodeFunctionData(
    functionFragment: 'depositWmaticSigned',
  ...
  encodeFunctionData(functionFragment: 'setTerms', values: [BondTellerMatic.TermsStruct]): string;
  ...
  decodeFunctionResult(functionFragment: 'depositWmatic', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'depositWmaticSigned', data: BytesLike): Result;
...
export interface BondTellerMatic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BondTellerMaticInterface;
  ...
  functions: {
    ...
    setTerms(
      terms: BondTellerMatic.TermsStruct,
      overrides?: Overrides & { from?: string | Promise<string> },
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setTerms(terms: BondTellerMatic.TermsStruct, overrides?: CallOverrides): Promise<void>;
