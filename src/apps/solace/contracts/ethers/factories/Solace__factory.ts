...
import type { Solace, SolaceInterface } from '../Solace';
...
export class Solace__factory {
  static readonly abi = _abi;
  static createInterface(): SolaceInterface {
    return new utils.Interface(_abi) as SolaceInterface;
  }
