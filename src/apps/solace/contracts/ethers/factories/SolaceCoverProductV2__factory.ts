...
import type { SolaceCoverProductV2, SolaceCoverProductV2Interface } from '../SolaceCoverProductV2';
...
export class SolaceCoverProductV2__factory {
  static readonly abi = _abi;
  static createInterface(): SolaceCoverProductV2Interface {
    return new utils.Interface(_abi) as SolaceCoverProductV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SolaceCoverProductV2 {
    return new Contract(address, _abi, signerOrProvider) as SolaceCoverProductV2;
  }
}
