...
import type { PieDaoVoteLockedDough, PieDaoVoteLockedDoughInterface } from '../PieDaoVoteLockedDough';
...
export class PieDaoVoteLockedDough__factory {
  ...
  static createInterface(): PieDaoVoteLockedDoughInterface {
    return new utils.Interface(_abi) as PieDaoVoteLockedDoughInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PieDaoVoteLockedDough {
    return new Contract(address, _abi, signerOrProvider) as PieDaoVoteLockedDough;
  }
}
