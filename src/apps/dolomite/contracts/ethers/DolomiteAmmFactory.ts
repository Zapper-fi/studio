...
export interface DolomiteAmmFactoryInterface extends utils.Interface {
  functions: {
    ...
    'isPairCreated(address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'getPairInitCode', values?: undefined): string;
  encodeFunctionData(functionFragment: 'getPairInitCodeHash', values?: undefined): string;
  encodeFunctionData(functionFragment: 'isPairCreated', values: [PromiseOrValue<string>]): string;
  ...
  encodeFunctionData(functionFragment: 'transferProxy', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'getPairInitCode', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getPairInitCodeHash', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'isPairCreated', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'setFeeTo', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'setFeeToSetter', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'transferProxy', data: BytesLike): Result;
...
export interface DolomiteAmmFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DolomiteAmmFactoryInterface;
  ...
  functions: {
    ...
    isPairCreated(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isPairCreated(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getPairInitCodeHash(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    isPairCreated(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
