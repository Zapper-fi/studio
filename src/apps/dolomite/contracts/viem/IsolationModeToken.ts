...
export const isolationModeTokenAbi = [
  {
    inputs: [
      {
...
export type IsolationModeToken = typeof isolationModeTokenAbi;
export type IsolationModeTokenContract = GetContractReturnType<IsolationModeToken, PublicClient>;

export class IsolationModeToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: isolationModeTokenAbi, publicClient: client });
  }
}
