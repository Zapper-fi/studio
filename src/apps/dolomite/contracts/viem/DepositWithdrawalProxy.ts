...
export const depositWithdrawalProxyAbi = [
  {
    inputs: [
      {
...
export type DepositWithdrawalProxy = typeof depositWithdrawalProxyAbi;
export type DepositWithdrawalProxyContract = GetContractReturnType<DepositWithdrawalProxy, PublicClient>;

export class DepositWithdrawalProxy__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: depositWithdrawalProxyAbi, publicClient: client });
  }
}
