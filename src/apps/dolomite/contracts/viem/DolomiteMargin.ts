...
export type DolomiteMargin = typeof dolomiteMarginAbi;
export type DolomiteMarginContract = GetContractReturnType<DolomiteMargin, PublicClient>;

export class DolomiteMargin__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dolomiteMarginAbi, publicClient: client });
  }
}
