...
export interface QiDaoMasterChefV3Interface extends utils.Interface {
  functions: {
    ...
    'updatePoolDepositFee(uint256,uint16)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'updatePoolDepositFee',
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'updatePoolDepositFee', data: BytesLike): Result;
...
export interface QiDaoMasterChefV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QiDaoMasterChefV3Interface;
