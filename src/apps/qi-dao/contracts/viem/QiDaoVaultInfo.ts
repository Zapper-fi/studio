...
export const qiDaoVaultInfoAbi = [
  {
    inputs: [
      {
...
export type QiDaoVaultInfo = typeof qiDaoVaultInfoAbi;
export type QiDaoVaultInfoContract = GetContractReturnType<QiDaoVaultInfo, PublicClient>;

export class QiDaoVaultInfo__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: qiDaoVaultInfoAbi, publicClient: client });
  }
}
