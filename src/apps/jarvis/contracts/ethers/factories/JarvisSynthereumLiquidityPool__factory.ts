...
import type {
  JarvisSynthereumLiquidityPool,
  JarvisSynthereumLiquidityPoolInterface,
} from '../JarvisSynthereumLiquidityPool';
...
export class JarvisSynthereumLiquidityPool__factory {
  static readonly abi = _abi;
  static createInterface(): JarvisSynthereumLiquidityPoolInterface {
    return new utils.Interface(_abi) as JarvisSynthereumLiquidityPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): JarvisSynthereumLiquidityPool {
    return new Contract(address, _abi, signerOrProvider) as JarvisSynthereumLiquidityPool;
  }
}
