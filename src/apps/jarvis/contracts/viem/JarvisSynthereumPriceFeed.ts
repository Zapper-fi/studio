...
export const jarvisSynthereumPriceFeedAbi = [
  {
    inputs: [
      {
...
export type JarvisSynthereumPriceFeed = typeof jarvisSynthereumPriceFeedAbi;
export type JarvisSynthereumPriceFeedContract = GetContractReturnType<JarvisSynthereumPriceFeed, PublicClient>;

export class JarvisSynthereumPriceFeed__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: jarvisSynthereumPriceFeedAbi, publicClient: client });
  }
}
