...
export const jarvisSynthereumLiquidityPoolAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type JarvisSynthereumLiquidityPool = typeof jarvisSynthereumLiquidityPoolAbi;
export type JarvisSynthereumLiquidityPoolContract = GetContractReturnType<JarvisSynthereumLiquidityPool, PublicClient>;

export class JarvisSynthereumLiquidityPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: jarvisSynthereumLiquidityPoolAbi, publicClient: client });
  }
}
