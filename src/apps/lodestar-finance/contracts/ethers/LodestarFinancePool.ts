...
export interface LodestarFinancePoolInterface extends utils.Interface {
  functions: {
    ...
    'borrowBehalf(uint256,address)': FunctionFragment;
    ...
    'redeemBehalf(uint256,address)': FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: 'redeemBehalf', data: BytesLike): Result;
  ...
  events: {
    ...
    'Borrow(address,uint256,uint256,uint256,uint256)': EventFragment;
    ...
    'RepayBorrow(address,address,uint256,uint256,uint256,uint256)': EventFragment;
...
export type BorrowEvent = TypedEvent<[string, BigNumber, BigNumber, BigNumber, BigNumber], BorrowEventObject>;
...
export interface LodestarFinancePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LodestarFinancePoolInterface;
  ...
  functions: {
    ...
    borrowBehalf(
      borrowAmount: PromiseOrValue<BigNumberish>,
      borrowee: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
    ...
    redeemBehalf(
      redeemTokens: PromiseOrValue<BigNumberish>,
      redeemee: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
