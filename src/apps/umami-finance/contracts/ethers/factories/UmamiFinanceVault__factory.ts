...
import type { UmamiFinanceVault, UmamiFinanceVaultInterface, Vault } from '../UmamiFinanceVault';
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'enum GlpUSDCVault.HedgeAction',
        name: 'sethAction',
        type: 'uint8',
      },
      {
  ...
  },
  {
    ...
    name: 'roundQueuedWithdrawalShares',
    outputs: [
      {
        internalType: 'uint128',
        name: '',
...
export class UmamiFinanceVault__factory {
  static readonly abi = _abi;
  static createInterface(): UmamiFinanceVaultInterface {
    return new utils.Interface(_abi) as UmamiFinanceVaultInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): UmamiFinanceVault {
    return new Contract(address, _abi, signerOrProvider) as UmamiFinanceVault;
  }
}
