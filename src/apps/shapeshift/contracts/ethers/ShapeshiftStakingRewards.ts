...
export interface ShapeshiftStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface ShapeshiftStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShapeshiftStakingRewardsInterface;
