...
export interface BiswapPoolInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'setDevFee', values: [PromiseOrValue<BigNumberish>]): string;
...
export interface BiswapPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BiswapPoolInterface;
  ...
  callStatic: {
    ...
    setDevFee(_devFee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
