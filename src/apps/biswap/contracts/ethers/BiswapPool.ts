...
export interface BiswapPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'setDevFee', values: [BigNumberish]): string;
...
export interface BiswapPool extends BaseContract {
  ...
  estimateGas: {
    ...
    setDevFee(_devFee: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
