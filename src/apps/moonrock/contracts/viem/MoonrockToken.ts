...
export type MoonrockToken = typeof moonrockTokenAbi;
export type MoonrockTokenContract = GetContractReturnType<MoonrockToken, PublicClient>;

export class MoonrockToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: moonrockTokenAbi, publicClient: client });
  }
}
