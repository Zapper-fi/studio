...
import type { MoonrockToken, MoonrockTokenInterface } from '../MoonrockToken';
...
export class MoonrockToken__factory {
  static readonly abi = _abi;
  static createInterface(): MoonrockTokenInterface {
    return new utils.Interface(_abi) as MoonrockTokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MoonrockToken {
    return new Contract(address, _abi, signerOrProvider) as MoonrockToken;
  }
}
