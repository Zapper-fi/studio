...
import type { VesselManager, VesselManagerInterface } from '../VesselManager';
...
export class VesselManager__factory {
  ...
  static createInterface(): VesselManagerInterface {
    return new utils.Interface(_abi) as VesselManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VesselManager {
    return new Contract(address, _abi, signerOrProvider) as VesselManager;
  }
}
