...
import type { AdminContract, AdminContractInterface } from '../AdminContract';
...
export class AdminContract__factory {
  static readonly abi = _abi;
  static createInterface(): AdminContractInterface {
    return new utils.Interface(_abi) as AdminContractInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AdminContract {
    return new Contract(address, _abi, signerOrProvider) as AdminContract;
  }
}
