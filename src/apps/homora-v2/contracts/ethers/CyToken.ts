...
export interface CyTokenInterface extends utils.Interface {
  functions: {
    ...
    'totalBorrowValue()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'totalBorrowValue', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'totalBorrowValue', data: BytesLike): Result;
...
export interface CyToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CyTokenInterface;
  ...
  functions: {
    ...
    totalBorrowValue(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    totalBorrowValue(overrides?: CallOverrides): Promise<PopulatedTransaction>;
