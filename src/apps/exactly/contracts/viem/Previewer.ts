...
export type Previewer = typeof previewerAbi;
export type PreviewerContract = GetContractReturnType<Previewer, PublicClient>;

export class Previewer__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: previewerAbi, publicClient: client });
  }
}
