...
import type { SymphonyYolo, SymphonyYoloInterface } from '../SymphonyYolo';
...
export class SymphonyYolo__factory {
  ...
  static createInterface(): SymphonyYoloInterface {
    return new utils.Interface(_abi) as SymphonyYoloInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): SymphonyYolo {
    return new Contract(address, _abi, signerOrProvider) as SymphonyYolo;
  }
}
