...
export interface TrisolarisFactoryInterface extends utils.Interface {
  functions: {
...
export interface TrisolarisFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TrisolarisFactoryInterface;
