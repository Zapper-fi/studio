...
export const apecoinStakingAbi = [
  {
    inputs: [
      {
...
export type ApecoinStaking = typeof apecoinStakingAbi;
export type ApecoinStakingContract = GetContractReturnType<ApecoinStaking, PublicClient>;

export class ApecoinStaking__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: apecoinStakingAbi, publicClient: client });
  }
}
