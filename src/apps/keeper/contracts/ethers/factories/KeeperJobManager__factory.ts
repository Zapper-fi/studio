...
import type { KeeperJobManager, KeeperJobManagerInterface } from '../KeeperJobManager';
...
export class KeeperJobManager__factory {
  ...
  static createInterface(): KeeperJobManagerInterface {
    return new utils.Interface(_abi) as KeeperJobManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): KeeperJobManager {
    return new Contract(address, _abi, signerOrProvider) as KeeperJobManager;
  }
}
