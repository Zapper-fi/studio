...
import type { KeeperVest, KeeperVestInterface } from '../KeeperVest';
...
export class KeeperVest__factory {
  ...
  static createInterface(): KeeperVestInterface {
    return new utils.Interface(_abi) as KeeperVestInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): KeeperVest {
    return new Contract(address, _abi, signerOrProvider) as KeeperVest;
  }
}
