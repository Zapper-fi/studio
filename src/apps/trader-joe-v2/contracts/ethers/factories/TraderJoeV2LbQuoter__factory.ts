...
import type { TraderJoeV2LbQuoter, TraderJoeV2LbQuoterInterface } from '../TraderJoeV2LbQuoter';
...
export class TraderJoeV2LbQuoter__factory {
  static readonly abi = _abi;
  static createInterface(): TraderJoeV2LbQuoterInterface {
    return new utils.Interface(_abi) as TraderJoeV2LbQuoterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TraderJoeV2LbQuoter {
    return new Contract(address, _abi, signerOrProvider) as TraderJoeV2LbQuoter;
  }
}
