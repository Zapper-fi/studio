...
import type { TraderJoeV2LbPair, TraderJoeV2LbPairInterface } from '../TraderJoeV2LbPair';
...
export class TraderJoeV2LbPair__factory {
  static readonly abi = _abi;
  static createInterface(): TraderJoeV2LbPairInterface {
    return new utils.Interface(_abi) as TraderJoeV2LbPairInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TraderJoeV2LbPair {
    return new Contract(address, _abi, signerOrProvider) as TraderJoeV2LbPair;
  }
}
