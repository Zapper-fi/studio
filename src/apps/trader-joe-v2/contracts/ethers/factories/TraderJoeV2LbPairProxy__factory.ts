...
import type { TraderJoeV2LbPairProxy, TraderJoeV2LbPairProxyInterface } from '../TraderJoeV2LbPairProxy';
...
export class TraderJoeV2LbPairProxy__factory {
  static readonly abi = _abi;
  static createInterface(): TraderJoeV2LbPairProxyInterface {
    return new utils.Interface(_abi) as TraderJoeV2LbPairProxyInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TraderJoeV2LbPairProxy {
    return new Contract(address, _abi, signerOrProvider) as TraderJoeV2LbPairProxy;
  }
}
