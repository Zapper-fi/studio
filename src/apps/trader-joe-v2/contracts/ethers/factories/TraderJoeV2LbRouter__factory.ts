...
import type { TraderJoeV2LbRouter, TraderJoeV2LbRouterInterface } from '../TraderJoeV2LbRouter';
...
export class TraderJoeV2LbRouter__factory {
  static readonly abi = _abi;
  static createInterface(): TraderJoeV2LbRouterInterface {
    return new utils.Interface(_abi) as TraderJoeV2LbRouterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TraderJoeV2LbRouter {
    return new Contract(address, _abi, signerOrProvider) as TraderJoeV2LbRouter;
  }
}
