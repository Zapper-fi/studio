...
@PositionTemplate()
export class ArbitrumLyraAvalonStkLyraClaimableContractPositionFetcher extends ContractPositionTemplatePositionFetcher<LyraStkLyra> {
  ...
  async getDefinitions(): Promise<DefaultContractPositionDefinition[]> {
    return [{ address: '0x5b237ab26ced47fb8ed104671819c801aa5ba45e' }];
  }
