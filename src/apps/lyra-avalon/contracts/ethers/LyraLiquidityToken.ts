...
export interface LyraLiquidityTokenInterface extends utils.Interface {
  functions: {
...
export interface LyraLiquidityToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LyraLiquidityTokenInterface;
