...
export const lyraLiquidityPoolAbi = [
  {
    inputs: [],
...
export type LyraLiquidityPool = typeof lyraLiquidityPoolAbi;
export type LyraLiquidityPoolContract = GetContractReturnType<LyraLiquidityPool, PublicClient>;

export class LyraLiquidityPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lyraLiquidityPoolAbi, publicClient: client });
  }
}
