...
export type LyraStkLyra = typeof lyraStkLyraAbi;
export type LyraStkLyraContract = GetContractReturnType<LyraStkLyra, PublicClient>;

export class LyraStkLyra__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lyraStkLyraAbi, publicClient: client });
  }
}
