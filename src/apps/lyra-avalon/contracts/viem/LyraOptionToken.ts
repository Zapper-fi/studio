...
export const lyraOptionTokenAbi = [
  {
    inputs: [
      {
        internalType: 'string',
...
export type LyraOptionToken = typeof lyraOptionTokenAbi;
export type LyraOptionTokenContract = GetContractReturnType<LyraOptionToken, PublicClient>;

export class LyraOptionToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lyraOptionTokenAbi, publicClient: client });
  }
}
