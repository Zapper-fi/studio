...
export interface ParaspaceDTokenInterface extends utils.Interface {
  functions: {
...
export interface ParaspaceDToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ParaspaceDTokenInterface;
