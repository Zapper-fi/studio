...
export type PStakePool = typeof pStakePoolAbi;
export type PStakePoolContract = GetContractReturnType<PStakePool, PublicClient>;

export class PStakePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pStakePoolAbi, publicClient: client });
  }
}
