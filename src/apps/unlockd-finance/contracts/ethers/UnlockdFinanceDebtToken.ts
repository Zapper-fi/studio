...
export interface UnlockdFinanceDebtTokenInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    'Initialized(address,address,address,uint8,string,string)': EventFragment;
...
export type InitializedEvent = TypedEvent<[string, string, string, number, string, string], InitializedEventObject>;
...
export interface UnlockdFinanceDebtToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnlockdFinanceDebtTokenInterface;
  ...
  filters: {
    ...
    'Burn(address,uint256,uint256)'(user?: PromiseOrValue<string> | null, amount?: null, index?: null): BurnEventFilter;
    Burn(user?: PromiseOrValue<string> | null, amount?: null, index?: null): BurnEventFilter;

    'Initialized(address,address,address,uint8,string,string)'(
