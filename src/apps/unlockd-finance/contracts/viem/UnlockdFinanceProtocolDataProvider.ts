...
export const unlockdFinanceProtocolDataProviderAbi = [
  {
    inputs: [
      {
...
export type UnlockdFinanceProtocolDataProvider = typeof unlockdFinanceProtocolDataProviderAbi;
export type UnlockdFinanceProtocolDataProviderContract = GetContractReturnType<
...
export class UnlockdFinanceProtocolDataProvider__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: unlockdFinanceProtocolDataProviderAbi, publicClient: client });
  }
}
