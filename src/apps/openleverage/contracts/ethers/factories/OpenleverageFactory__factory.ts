...
import type { OpenleverageFactory, OpenleverageFactoryInterface } from '../OpenleverageFactory';
...
export class OpenleverageFactory__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): OpenleverageFactory {
