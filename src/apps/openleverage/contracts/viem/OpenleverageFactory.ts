...
export const openleverageFactoryAbi = {
  contractName: 'OpenLevV1',
  abi: [
    {
      inputs: [],
...
export type OpenleverageFactory = typeof openleverageFactoryAbi;
export type OpenleverageFactoryContract = GetContractReturnType<OpenleverageFactory, PublicClient>;

export class OpenleverageFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: openleverageFactoryAbi, publicClient: client });
  }
}
