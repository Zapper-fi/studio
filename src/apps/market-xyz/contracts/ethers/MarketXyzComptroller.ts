...
export interface MarketXyzComptrollerInterface extends utils.Interface {
  functions: {
...
export interface MarketXyzComptroller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarketXyzComptrollerInterface;
