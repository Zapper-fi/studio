...
export const marketXyzPoolLensAbi = [
  {
    inputs: [
      {
...
export type MarketXyzPoolLens = typeof marketXyzPoolLensAbi;
export type MarketXyzPoolLensContract = GetContractReturnType<MarketXyzPoolLens, PublicClient>;

export class MarketXyzPoolLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: marketXyzPoolLensAbi, publicClient: client });
  }
}
