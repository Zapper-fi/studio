...
import type { PendleVotingEscrow, PendleVotingEscrowInterface } from '../PendleVotingEscrow';
...
export class PendleVotingEscrow__factory {
  ...
  static createInterface(): PendleVotingEscrowInterface {
    return new utils.Interface(_abi) as PendleVotingEscrowInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PendleVotingEscrow {
    return new Contract(address, _abi, signerOrProvider) as PendleVotingEscrow;
  }
}
