  ...
  hubs = [
    {
      ...
      subgraphUrl: 'https://api.thegraph.com/subgraphs/name/mean-finance/dca-v2-ys-vulnerable-optimism?source=zapper',
    },
    {
      ...
      subgraphUrl: 'https://api.thegraph.com/subgraphs/name/mean-finance/dca-v2-ys-optimism?source=zapper',
    },
    {
      // Version 4 Hub - YIELD
      ...
      subgraphUrl: 'https://api.thegraph.com/subgraphs/name/mean-finance/dca-v2-yf-optimism?source=zapper',
    },
  ];
}
