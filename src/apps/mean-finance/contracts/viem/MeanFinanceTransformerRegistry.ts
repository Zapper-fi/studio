...
export const meanFinanceTransformerRegistryAbi = [
  {
    inputs: [
      {
...
export type MeanFinanceTransformerRegistry = typeof meanFinanceTransformerRegistryAbi;
export type MeanFinanceTransformerRegistryContract = GetContractReturnType<
...
export class MeanFinanceTransformerRegistry__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: meanFinanceTransformerRegistryAbi, publicClient: client });
  }
}
