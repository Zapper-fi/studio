...
export const meanFinancePermissionManagerAbi = [
  {
    inputs: [
      {
...
export type MeanFinancePermissionManager = typeof meanFinancePermissionManagerAbi;
export type MeanFinancePermissionManagerContract = GetContractReturnType<MeanFinancePermissionManager, PublicClient>;

export class MeanFinancePermissionManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: meanFinancePermissionManagerAbi, publicClient: client });
  }
}
