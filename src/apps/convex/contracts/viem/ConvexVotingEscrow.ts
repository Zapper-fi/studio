...
export const convexVotingEscrowAbi = [
  {
    inputs: [],
...
export type ConvexVotingEscrow = typeof convexVotingEscrowAbi;
export type ConvexVotingEscrowContract = GetContractReturnType<ConvexVotingEscrow, PublicClient>;

export class ConvexVotingEscrow__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: convexVotingEscrowAbi, publicClient: client });
  }
}
