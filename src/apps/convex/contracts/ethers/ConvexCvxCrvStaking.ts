...
export interface ConvexCvxCrvStakingInterface extends utils.Interface {
  functions: {
...
export interface ConvexCvxCrvStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConvexCvxCrvStakingInterface;
