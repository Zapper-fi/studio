...
export interface ConvexVirtualBalanceRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface ConvexVirtualBalanceRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConvexVirtualBalanceRewardPoolInterface;
