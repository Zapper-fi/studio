...
export interface ConvexSingleStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface ConvexSingleStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConvexSingleStakingRewardsInterface;
