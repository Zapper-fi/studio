...
export interface FerroSwapInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    'NewFeeCollector(address)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'NewFeeCollector'): EventFragment;
...
export interface NewFeeCollectorEventObject {
  newFeeCollector: string;
}
export type NewFeeCollectorEvent = TypedEvent<[string], NewFeeCollectorEventObject>;

export type NewFeeCollectorEventFilter = TypedEventFilter<NewFeeCollectorEvent>;
...
export interface FerroSwap extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FerroSwapInterface;
  ...
  functions: {
    ...
    withdrawAdminFees(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  };
  ...
  callStatic: {
    ...
    setFeeCollector(newFeeCollector: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'NewFeeCollector(address)'(newFeeCollector?: null): NewFeeCollectorEventFilter;
    NewFeeCollector(newFeeCollector?: null): NewFeeCollectorEventFilter;
  ...
  estimateGas: {
    ...
    withdrawAdminFees(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    withdrawAdminFees(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
  };
}
