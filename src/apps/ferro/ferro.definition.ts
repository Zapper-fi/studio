...
export const FERRO_DEFINITION = appDefinition({
  ...
  groups: {
    ...
    stakedLiquidity: { id: 'staked-liquidity', type: GroupType.POSITION, label: 'Staked Liquidity', groupLabel: 'Pools' },
    xfer: { id: 'xfer', type: GroupType.TOKEN, label: 'xFER', groupLabel: 'xFER' },
    xferVault: { id: 'xfer-vault', type: GroupType.POSITION, label: 'xFER Vault', groupLabel: 'xFER' },
  },
