...
import type { PoolV2Legacy, PoolV2LegacyInterface } from '../PoolV2Legacy';
...
export class PoolV2Legacy__factory {
  ...
  static createInterface(): PoolV2LegacyInterface {
    return new utils.Interface(_abi) as PoolV2LegacyInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PoolV2Legacy {
    return new Contract(address, _abi, signerOrProvider) as PoolV2Legacy;
  }
}
