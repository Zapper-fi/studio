...
export type PoolV2 = typeof poolV2Abi;
export type PoolV2Contract = GetContractReturnType<PoolV2, PublicClient>;

export class PoolV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: poolV2Abi, publicClient: client });
  }
}
