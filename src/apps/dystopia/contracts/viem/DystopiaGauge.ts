...
export type DystopiaGauge = typeof dystopiaGaugeAbi;
export type DystopiaGaugeContract = GetContractReturnType<DystopiaGauge, PublicClient>;

export class DystopiaGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dystopiaGaugeAbi, publicClient: client });
  }
}
