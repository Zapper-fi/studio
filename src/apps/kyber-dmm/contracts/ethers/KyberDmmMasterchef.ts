...
export interface KyberDmmMasterchefInterface extends utils.Interface {
  functions: {
...
export interface KyberDmmMasterchef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KyberDmmMasterchefInterface;
