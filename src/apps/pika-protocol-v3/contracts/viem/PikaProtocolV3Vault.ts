...
export const pikaProtocolV3VaultAbi = [
  {
    inputs: [
      {
...
export type PikaProtocolV3Vault = typeof pikaProtocolV3VaultAbi;
export type PikaProtocolV3VaultContract = GetContractReturnType<PikaProtocolV3Vault, PublicClient>;

export class PikaProtocolV3Vault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: pikaProtocolV3VaultAbi, publicClient: client });
  }
}
