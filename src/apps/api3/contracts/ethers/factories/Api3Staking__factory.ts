...
import type { Api3Staking, Api3StakingInterface } from '../Api3Staking';
...
export class Api3Staking__factory {
  ...
  static createInterface(): Api3StakingInterface {
    return new utils.Interface(_abi) as Api3StakingInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Api3Staking {
    return new Contract(address, _abi, signerOrProvider) as Api3Staking;
  }
}
