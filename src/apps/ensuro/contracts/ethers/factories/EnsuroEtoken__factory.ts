...
import type { EnsuroEtoken, EnsuroEtokenInterface } from '../EnsuroEtoken';
...
export class EnsuroEtoken__factory {
  static readonly abi = _abi;
  static createInterface(): EnsuroEtokenInterface {
    return new utils.Interface(_abi) as EnsuroEtokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EnsuroEtoken {
    return new Contract(address, _abi, signerOrProvider) as EnsuroEtoken;
  }
}
