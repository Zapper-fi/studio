...
export type EnsuroEtoken = typeof ensuroEtokenAbi;
export type EnsuroEtokenContract = GetContractReturnType<EnsuroEtoken, PublicClient>;

export class EnsuroEtoken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: ensuroEtokenAbi, publicClient: client });
  }
}
