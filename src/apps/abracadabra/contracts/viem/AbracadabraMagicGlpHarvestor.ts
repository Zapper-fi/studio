...
export const abracadabraMagicGlpHarvestorAbi = [
  {
    inputs: [
      {
...
export type AbracadabraMagicGlpHarvestor = typeof abracadabraMagicGlpHarvestorAbi;
export type AbracadabraMagicGlpHarvestorContract = GetContractReturnType<AbracadabraMagicGlpHarvestor, PublicClient>;

export class AbracadabraMagicGlpHarvestor__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: abracadabraMagicGlpHarvestorAbi, publicClient: client });
  }
}
