...
export const abracadabraMarketLensAbi = [
  {
    inputs: [
      {
...
export type AbracadabraMarketLens = typeof abracadabraMarketLensAbi;
export type AbracadabraMarketLensContract = GetContractReturnType<AbracadabraMarketLens, PublicClient>;

export class AbracadabraMarketLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: abracadabraMarketLensAbi, publicClient: client });
  }
}
