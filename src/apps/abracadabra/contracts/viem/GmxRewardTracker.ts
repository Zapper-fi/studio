...
export const gmxRewardTrackerAbi = [
  {
    inputs: [
      {
        internalType: 'string',
...
export type GmxRewardTracker = typeof gmxRewardTrackerAbi;
export type GmxRewardTrackerContract = GetContractReturnType<GmxRewardTracker, PublicClient>;

export class GmxRewardTracker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: gmxRewardTrackerAbi, publicClient: client });
  }
}
