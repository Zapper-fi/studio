...
export const abracadabraCauldronAbi = [
  {
    inputs: [
      {
...
export type AbracadabraCauldron = typeof abracadabraCauldronAbi;
export type AbracadabraCauldronContract = GetContractReturnType<AbracadabraCauldron, PublicClient>;

export class AbracadabraCauldron__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: abracadabraCauldronAbi, publicClient: client });
  }
}
