...
export const sushiswapBentoboxAbi = [
  {
    inputs: [
      {
...
export type SushiswapBentobox = typeof sushiswapBentoboxAbi;
export type SushiswapBentoboxContract = GetContractReturnType<SushiswapBentobox, PublicClient>;

export class SushiswapBentobox__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: sushiswapBentoboxAbi, publicClient: client });
  }
}
