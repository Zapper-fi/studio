...
export interface AbracadabraDegenboxInterface extends utils.Interface {
  functions: {
...
export interface AbracadabraDegenbox extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AbracadabraDegenboxInterface;
