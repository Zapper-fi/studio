...
export interface HakuswapFactoryInterface extends utils.Interface {
  functions: {
    'INIT_CODE_PAIR_HASH()': FunctionFragment;
    'allPairs(uint256)': FunctionFragment;
    'allPairsLength()': FunctionFragment;
    'createPair(address,address)': FunctionFragment;
    'expectPairFor(address,address)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'expectPairFor',
  ...
  decodeFunctionResult(functionFragment: 'expectPairFor', data: BytesLike): Result;
...
export interface HakuswapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HakuswapFactoryInterface;
