...
export interface PendleOwnershipTokenInterface extends utils.Interface {
  functions: {
...
export interface PendleOwnershipToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendleOwnershipTokenInterface;
