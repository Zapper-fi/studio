...
import type { PendleData, PendleDataInterface } from '../PendleData';
...
export class PendleData__factory {
  ...
  static createInterface(): PendleDataInterface {
    return new utils.Interface(_abi) as PendleDataInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PendleData {
    return new Contract(address, _abi, signerOrProvider) as PendleData;
  }
}
