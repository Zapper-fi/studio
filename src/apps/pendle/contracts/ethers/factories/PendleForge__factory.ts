...
import type { PendleForge, PendleForgeInterface } from '../PendleForge';
...
export class PendleForge__factory {
  ...
  static createInterface(): PendleForgeInterface {
    return new utils.Interface(_abi) as PendleForgeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PendleForge {
    return new Contract(address, _abi, signerOrProvider) as PendleForge;
  }
}
