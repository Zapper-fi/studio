...
export type Borrowable = typeof borrowableAbi;
export type BorrowableContract = GetContractReturnType<Borrowable, PublicClient>;

export class Borrowable__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: borrowableAbi, publicClient: client });
  }
}
