...
export type Collateral = typeof collateralAbi;
export type CollateralContract = GetContractReturnType<Collateral, PublicClient>;

export class Collateral__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: collateralAbi, publicClient: client });
  }
}
