...
export type ArrakisPool = typeof arrakisPoolAbi;
export type ArrakisPoolContract = GetContractReturnType<ArrakisPool, PublicClient>;

export class ArrakisPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: arrakisPoolAbi, publicClient: client });
  }
}
