...
import type { TarotFactory, TarotFactoryInterface } from '../TarotFactory';
...
const _abi = [
  {
    inputs: [
      ...
      {
        internalType: 'contract ITarotPriceOracle',
...
export class TarotFactory__factory {
  static readonly abi = _abi;
  static createInterface(): TarotFactoryInterface {
    return new utils.Interface(_abi) as TarotFactoryInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TarotFactory {
    return new Contract(address, _abi, signerOrProvider) as TarotFactory;
  }
}
