...
export type TarotFactory = typeof tarotFactoryAbi;
export type TarotFactoryContract = GetContractReturnType<TarotFactory, PublicClient>;

export class TarotFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: tarotFactoryAbi, publicClient: client });
  }
}
