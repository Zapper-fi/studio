...
export const tarotBorrowableAbi = [
  {
    inputs: [],
    payable: false,
...
export type TarotBorrowable = typeof tarotBorrowableAbi;
export type TarotBorrowableContract = GetContractReturnType<TarotBorrowable, PublicClient>;

export class TarotBorrowable__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: tarotBorrowableAbi, publicClient: client });
  }
}
