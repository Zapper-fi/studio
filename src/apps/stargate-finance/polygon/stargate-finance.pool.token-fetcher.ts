...
const addresses = ['0x1205f31718499dBf1fCa446663B532Ef87481fe1', '0x29e38769f23701A2e4A8Ef0492e19dA4604Be62c'];

@Register.TokenPositionFetcher({ appId, groupId, network })
export class PolygonStargateFinancePoolTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
