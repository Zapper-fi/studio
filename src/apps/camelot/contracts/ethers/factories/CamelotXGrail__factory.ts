...
import type { CamelotXGrail, CamelotXGrailInterface } from '../CamelotXGrail';
...
export class CamelotXGrail__factory {
  ...
  static createInterface(): CamelotXGrailInterface {
    return new utils.Interface(_abi) as CamelotXGrailInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CamelotXGrail {
    return new Contract(address, _abi, signerOrProvider) as CamelotXGrail;
  }
}
