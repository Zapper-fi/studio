...
import type { CamelotNitroFactory, CamelotNitroFactoryInterface } from '../CamelotNitroFactory';
...
export class CamelotNitroFactory__factory {
  ...
  static createInterface(): CamelotNitroFactoryInterface {
    return new utils.Interface(_abi) as CamelotNitroFactoryInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CamelotNitroFactory {
    return new Contract(address, _abi, signerOrProvider) as CamelotNitroFactory;
  }
}
