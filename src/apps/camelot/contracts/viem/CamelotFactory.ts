...
export type CamelotFactory = typeof camelotFactoryAbi;
export type CamelotFactoryContract = GetContractReturnType<CamelotFactory, PublicClient>;

export class CamelotFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: camelotFactoryAbi, publicClient: client });
  }
}
