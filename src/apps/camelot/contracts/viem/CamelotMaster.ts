...
export type CamelotMaster = typeof camelotMasterAbi;
export type CamelotMasterContract = GetContractReturnType<CamelotMaster, PublicClient>;

export class CamelotMaster__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: camelotMasterAbi, publicClient: client });
  }
}
