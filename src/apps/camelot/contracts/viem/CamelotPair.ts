...
export type CamelotPair = typeof camelotPairAbi;
export type CamelotPairContract = GetContractReturnType<CamelotPair, PublicClient>;

export class CamelotPair__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: camelotPairAbi, publicClient: client });
  }
}
