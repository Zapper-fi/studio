...
export const camelotDividendAbi = [
  {
    inputs: [
      {
...
export type CamelotDividend = typeof camelotDividendAbi;
export type CamelotDividendContract = GetContractReturnType<CamelotDividend, PublicClient>;

export class CamelotDividend__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: camelotDividendAbi, publicClient: client });
  }
}
