...
export const camelotNftPoolAbi = [
  {
    inputs: [],
...
export type CamelotNftPool = typeof camelotNftPoolAbi;
export type CamelotNftPoolContract = GetContractReturnType<CamelotNftPool, PublicClient>;

export class CamelotNftPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: camelotNftPoolAbi, publicClient: client });
  }
}
