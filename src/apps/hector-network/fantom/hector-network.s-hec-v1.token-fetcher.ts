...
> {
  ...
  async getDataProps({ appToken }: GetDataPropsStageParams<HectorNetworkStaked, HectorNetworkSHecV1DataProps>) {
    const liquidity = appToken.supply * appToken.price;
    return { liquidity };
  }

  async getLabel(
    _params: GetDisplayPropsStageParams<HectorNetworkStaked, HectorNetworkSHecV1DataProps>,
