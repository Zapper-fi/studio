...
export interface HectorNetworkStakeBondDepositoryInterface extends utils.Interface {
  functions: {
...
export interface HectorNetworkStakeBondDepository extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HectorNetworkStakeBondDepositoryInterface;
