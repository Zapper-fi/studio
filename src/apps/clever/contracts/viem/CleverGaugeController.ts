...
export const cleverGaugeControllerAbi = [
  {
...
export type CleverGaugeController = typeof cleverGaugeControllerAbi;
export type CleverGaugeControllerContract = GetContractReturnType<CleverGaugeController, PublicClient>;

export class CleverGaugeController__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: cleverGaugeControllerAbi, publicClient: client });
  }
}
