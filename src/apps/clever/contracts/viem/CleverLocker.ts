...
export type CleverLocker = typeof cleverLockerAbi;
export type CleverLockerContract = GetContractReturnType<CleverLocker, PublicClient>;

export class CleverLocker__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: cleverLockerAbi, publicClient: client });
  }
}
