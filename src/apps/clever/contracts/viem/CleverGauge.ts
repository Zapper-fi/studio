...
export type CleverGauge = typeof cleverGaugeAbi;
export type CleverGaugeContract = GetContractReturnType<CleverGauge, PublicClient>;

export class CleverGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: cleverGaugeAbi, publicClient: client });
  }
}
