...
export interface CleverAbcCvxGaugeInterface extends utils.Interface {
  functions: {
...
export interface CleverAbcCvxGauge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CleverAbcCvxGaugeInterface;
