...
export interface CleverGaugeControllerInterface extends utils.Interface {
  functions: {
...
export interface CleverGaugeController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CleverGaugeControllerInterface;
