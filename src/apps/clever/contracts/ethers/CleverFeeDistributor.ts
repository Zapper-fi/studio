...
export interface CleverFeeDistributorInterface extends utils.Interface {
  functions: {
...
export interface CleverFeeDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CleverFeeDistributorInterface;
