...
import type { StrategyManager, StrategyManagerInterface } from '../StrategyManager';
...
const _abi = [
  ...
  },
  {
    ...
    name: 'AllowedSwapDeviationChanged',
    type: 'event',
  },
  {
    anonymous: false,
...
export class StrategyManager__factory {
  static readonly abi = _abi;
  static createInterface(): StrategyManagerInterface {
    return new utils.Interface(_abi) as StrategyManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): StrategyManager {
