...
export const lodestarV0LensAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type LodestarV0Lens = typeof lodestarV0LensAbi;
export type LodestarV0LensContract = GetContractReturnType<LodestarV0Lens, PublicClient>;

export class LodestarV0Lens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lodestarV0LensAbi, publicClient: client });
  }
}
