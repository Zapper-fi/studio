...
export const lodestarV0ITokenAbi = [
  {
    inputs: [],
...
export type LodestarV0IToken = typeof lodestarV0ITokenAbi;
export type LodestarV0ITokenContract = GetContractReturnType<LodestarV0IToken, PublicClient>;

export class LodestarV0IToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: lodestarV0ITokenAbi, publicClient: client });
  }
}
