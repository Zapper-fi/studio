...
export type StargatePool = typeof stargatePoolAbi;
export type StargatePoolContract = GetContractReturnType<StargatePool, PublicClient>;

export class StargatePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stargatePoolAbi, publicClient: client });
  }
}
