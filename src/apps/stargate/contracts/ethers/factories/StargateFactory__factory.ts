...
import type { StargateFactory, StargateFactoryInterface } from '../StargateFactory';
...
export class StargateFactory__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): StargateFactory {
