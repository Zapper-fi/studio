...
export const beethovenXGaugeAbi = [
  {
    name: 'Approval',
    inputs: [
      {
...
export type BeethovenXGauge = typeof beethovenXGaugeAbi;
export type BeethovenXGaugeContract = GetContractReturnType<BeethovenXGauge, PublicClient>;

export class BeethovenXGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: beethovenXGaugeAbi, publicClient: client });
  }
}
