...
import type { InverseLens, InverseLensInterface } from '../InverseLens';
...
export class InverseLens__factory {
  static readonly abi = _abi;
  static createInterface(): InverseLensInterface {
    return new utils.Interface(_abi) as InverseLensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): InverseLens {
    return new Contract(address, _abi, signerOrProvider) as InverseLens;
  }
}
