...
export interface InverseLendingPoolInterface extends utils.Interface {
  functions: {
...
export interface InverseLendingPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InverseLendingPoolInterface;
