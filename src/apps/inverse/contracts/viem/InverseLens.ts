...
export type InverseLens = typeof inverseLensAbi;
export type InverseLensContract = GetContractReturnType<InverseLens, PublicClient>;

export class InverseLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: inverseLensAbi, publicClient: client });
  }
}
