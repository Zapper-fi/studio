...
export interface CurvePoolLegacyInterface extends utils.Interface {
  functions: {
...
export interface CurvePoolLegacy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurvePoolLegacyInterface;
