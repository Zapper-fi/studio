...
export interface CurveDoubleGaugeInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'reward_integral_for', values: [string]): string;
  encodeFunctionData(functionFragment: 'rewards_for', values: [string]): string;
  encodeFunctionData(functionFragment: 'claimed_rewards_for', values: [string]): string;
...
export interface CurveDoubleGauge extends BaseContract {
  ...
  functions: {
    ...
    reward_integral_for(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    rewards_for(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    claimed_rewards_for(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  callStatic: {
    ...
    'withdraw(uint256,bool)'(_value: BigNumberish, claim_rewards: boolean, overrides?: CallOverrides): Promise<void>;

    'claim_rewards()'(overrides?: CallOverrides): Promise<void>;

    'claim_rewards(address)'(addr: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    reward_integral_for(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    rewards_for(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    claimed_rewards_for(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
