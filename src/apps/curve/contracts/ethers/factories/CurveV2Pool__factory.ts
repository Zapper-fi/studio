...
import type { CurveV2Pool, CurveV2PoolInterface } from '../CurveV2Pool';
...
export class CurveV2Pool__factory {
  static readonly abi = _abi;
  static createInterface(): CurveV2PoolInterface {
    return new utils.Interface(_abi) as CurveV2PoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CurveV2Pool {
    return new Contract(address, _abi, signerOrProvider) as CurveV2Pool;
  }
}
