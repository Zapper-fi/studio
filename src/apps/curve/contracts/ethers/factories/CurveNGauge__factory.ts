...
import type { CurveNGauge, CurveNGaugeInterface } from '../CurveNGauge';
...
export class CurveNGauge__factory {
  ...
  static createInterface(): CurveNGaugeInterface {
    return new utils.Interface(_abi) as CurveNGaugeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CurveNGauge {
    return new Contract(address, _abi, signerOrProvider) as CurveNGauge;
  }
}
