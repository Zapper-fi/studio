...
import type { CurveFactoryPoolV2, CurveFactoryPoolV2Interface } from '../CurveFactoryPoolV2';
...
export class CurveFactoryPoolV2__factory {
  static readonly abi = _abi;
  static createInterface(): CurveFactoryPoolV2Interface {
    return new utils.Interface(_abi) as CurveFactoryPoolV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CurveFactoryPoolV2 {
    return new Contract(address, _abi, signerOrProvider) as CurveFactoryPoolV2;
  }
}
