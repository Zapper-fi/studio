...
export interface CurveV1MetapoolInterface extends utils.Interface {
  functions: {
    'A()': FunctionFragment;
    ...
    'base_pool()': FunctionFragment;
    'base_virtual_price()': FunctionFragment;
    'base_cache_updated()': FunctionFragment;
    'base_coins(uint256)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'base_pool', values?: undefined): string;
  encodeFunctionData(functionFragment: 'base_virtual_price', values?: undefined): string;
  encodeFunctionData(functionFragment: 'base_cache_updated', values?: undefined): string;
  encodeFunctionData(functionFragment: 'base_coins', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  decodeFunctionResult(functionFragment: 'base_pool', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'base_virtual_price', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'base_cache_updated', data: BytesLike): Result;
...
export interface CurveV1Metapool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveV1MetapoolInterface;
  ...
  functions: {
    ...
    base_pool(overrides?: CallOverrides): Promise<[string]>;

    base_virtual_price(overrides?: CallOverrides): Promise<[BigNumber]>;

    base_cache_updated(overrides?: CallOverrides): Promise<[BigNumber]>;

    base_coins(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    base_pool(overrides?: CallOverrides): Promise<BigNumber>;

    base_virtual_price(overrides?: CallOverrides): Promise<BigNumber>;

    base_cache_updated(overrides?: CallOverrides): Promise<BigNumber>;

    base_coins(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    base_pool(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    base_virtual_price(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    base_cache_updated(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    base_coins(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
