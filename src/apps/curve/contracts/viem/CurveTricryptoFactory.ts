...
export const curveTricryptoFactoryAbi = [
  {
...
export type CurveTricryptoFactory = typeof curveTricryptoFactoryAbi;
export type CurveTricryptoFactoryContract = GetContractReturnType<CurveTricryptoFactory, PublicClient>;

export class CurveTricryptoFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveTricryptoFactoryAbi, publicClient: client });
  }
}
