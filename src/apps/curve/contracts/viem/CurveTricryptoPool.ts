...
export const curveTricryptoPoolAbi = [
  {
    name: 'Transfer',
    inputs: [
      {
...
export type CurveTricryptoPool = typeof curveTricryptoPoolAbi;
export type CurveTricryptoPoolContract = GetContractReturnType<CurveTricryptoPool, PublicClient>;

export class CurveTricryptoPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveTricryptoPoolAbi, publicClient: client });
  }
}
