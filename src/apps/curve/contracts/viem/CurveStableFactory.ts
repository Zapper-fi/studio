...
export const curveStableFactoryAbi = [
  {
    name: 'BasePoolAdded',
    inputs: [
      {
...
export type CurveStableFactory = typeof curveStableFactoryAbi;
export type CurveStableFactoryContract = GetContractReturnType<CurveStableFactory, PublicClient>;

export class CurveStableFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveStableFactoryAbi, publicClient: client });
  }
}
