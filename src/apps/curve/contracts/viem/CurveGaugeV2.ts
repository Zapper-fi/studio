...
export type CurveGaugeV2 = typeof curveGaugeV2Abi;
export type CurveGaugeV2Contract = GetContractReturnType<CurveGaugeV2, PublicClient>;

export class CurveGaugeV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveGaugeV2Abi, publicClient: client });
  }
}
