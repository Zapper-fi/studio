...
export const curveCryptoFactoryAbi = [
  {
...
export type CurveCryptoFactory = typeof curveCryptoFactoryAbi;
export type CurveCryptoFactoryContract = GetContractReturnType<CurveCryptoFactory, PublicClient>;

export class CurveCryptoFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveCryptoFactoryAbi, publicClient: client });
  }
}
