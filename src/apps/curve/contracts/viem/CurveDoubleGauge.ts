...
export const curveDoubleGaugeAbi = [
  {
    name: 'Deposit',
    inputs: [
      {
...
export type CurveDoubleGauge = typeof curveDoubleGaugeAbi;
export type CurveDoubleGaugeContract = GetContractReturnType<CurveDoubleGauge, PublicClient>;

export class CurveDoubleGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveDoubleGaugeAbi, publicClient: client });
  }
}
