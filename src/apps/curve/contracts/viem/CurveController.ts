...
export const curveControllerAbi = [
  {
...
export type CurveController = typeof curveControllerAbi;
export type CurveControllerContract = GetContractReturnType<CurveController, PublicClient>;

export class CurveController__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveControllerAbi, publicClient: client });
  }
}
