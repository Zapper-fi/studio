...
export const curveFactoryPoolV2Abi = [
  {
    name: 'BasePoolAdded',
    inputs: [
      {
...
export type CurveFactoryPoolV2 = typeof curveFactoryPoolV2Abi;
export type CurveFactoryPoolV2Contract = GetContractReturnType<CurveFactoryPoolV2, PublicClient>;

export class CurveFactoryPoolV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveFactoryPoolV2Abi, publicClient: client });
  }
}
