...
export type CurveGaugeV6 = typeof curveGaugeV6Abi;
export type CurveGaugeV6Contract = GetContractReturnType<CurveGaugeV6, PublicClient>;

export class CurveGaugeV6__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveGaugeV6Abi, publicClient: client });
  }
}
