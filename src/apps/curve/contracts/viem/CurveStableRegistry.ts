...
export const curveStableRegistryAbi = [
  {
    name: 'PoolAdded',
    inputs: [
      {
...
export type CurveStableRegistry = typeof curveStableRegistryAbi;
export type CurveStableRegistryContract = GetContractReturnType<CurveStableRegistry, PublicClient>;

export class CurveStableRegistry__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveStableRegistryAbi, publicClient: client });
  }
}
