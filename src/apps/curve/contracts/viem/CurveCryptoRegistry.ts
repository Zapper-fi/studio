...
export const curveCryptoRegistryAbi = [
  {
    name: 'PoolAdded',
    inputs: [
      {
...
export type CurveCryptoRegistry = typeof curveCryptoRegistryAbi;
export type CurveCryptoRegistryContract = GetContractReturnType<CurveCryptoRegistry, PublicClient>;

export class CurveCryptoRegistry__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: curveCryptoRegistryAbi, publicClient: client });
  }
}
