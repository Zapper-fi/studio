...
export type BalancerPoolToken = typeof balancerPoolTokenAbi;
export type BalancerPoolTokenContract = GetContractReturnType<BalancerPoolToken, PublicClient>;

export class BalancerPoolToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerPoolTokenAbi, publicClient: client });
  }
}
