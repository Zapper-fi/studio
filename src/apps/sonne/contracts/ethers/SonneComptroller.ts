...
export interface SonneComptrollerInterface extends utils.Interface {
  functions: {
...
export interface SonneComptroller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SonneComptrollerInterface;
  ...
  functions: {
    ...
    fixBadAccruals(
      affectedUsers: PromiseOrValue<string>[],
