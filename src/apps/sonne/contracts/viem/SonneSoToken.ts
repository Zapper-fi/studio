...
export type SonneSoToken = typeof sonneSoTokenAbi;
export type SonneSoTokenContract = GetContractReturnType<SonneSoToken, PublicClient>;

export class SonneSoToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: sonneSoTokenAbi, publicClient: client });
  }
}
