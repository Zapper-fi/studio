...
export interface VeoxInterface extends utils.Interface {
  functions: {
    ...
    'create_lock_as_minter(address,uint256,uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'create_lock_as_minter',
  ...
  decodeFunctionResult(functionFragment: 'create_lock_as_minter', data: BytesLike): Result;
...
export interface Veox extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeoxInterface;
