...
export const meshswapSinglePoolFactoryAbi = [
  {
    constant: false,
    inputs: [
      {
...
export type MeshswapSinglePoolFactory = typeof meshswapSinglePoolFactoryAbi;
export type MeshswapSinglePoolFactoryContract = GetContractReturnType<MeshswapSinglePoolFactory, PublicClient>;

export class MeshswapSinglePoolFactory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: meshswapSinglePoolFactoryAbi, publicClient: client });
  }
}
