...
export type Staking = typeof stakingAbi;
export type StakingContract = GetContractReturnType<Staking, PublicClient>;

export class Staking__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stakingAbi, publicClient: client });
  }
}
