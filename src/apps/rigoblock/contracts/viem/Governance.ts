...
export type Governance = typeof governanceAbi;
export type GovernanceContract = GetContractReturnType<Governance, PublicClient>;

export class Governance__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: governanceAbi, publicClient: client });
  }
}
