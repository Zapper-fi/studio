...
export type GrgVault = typeof grgVaultAbi;
export type GrgVaultContract = GetContractReturnType<GrgVault, PublicClient>;

export class GrgVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: grgVaultAbi, publicClient: client });
  }
}
