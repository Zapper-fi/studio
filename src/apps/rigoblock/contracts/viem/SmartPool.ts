...
export type SmartPool = typeof smartPoolAbi;
export type SmartPoolContract = GetContractReturnType<SmartPool, PublicClient>;

export class SmartPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: smartPoolAbi, publicClient: client });
  }
}
