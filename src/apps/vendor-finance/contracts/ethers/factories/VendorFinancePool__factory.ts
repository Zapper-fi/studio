...
import type { VendorFinancePool, VendorFinancePoolInterface } from '../VendorFinancePool';
...
export class VendorFinancePool__factory {
  ...
  static createInterface(): VendorFinancePoolInterface {
    return new utils.Interface(_abi) as VendorFinancePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VendorFinancePool {
    return new Contract(address, _abi, signerOrProvider) as VendorFinancePool;
  }
}
