...
export const vendorFinancePoolV2Abi = [
  {
    inputs: [],
...
export type VendorFinancePoolV2 = typeof vendorFinancePoolV2Abi;
export type VendorFinancePoolV2Contract = GetContractReturnType<VendorFinancePoolV2, PublicClient>;

export class VendorFinancePoolV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: vendorFinancePoolV2Abi, publicClient: client });
  }
}
