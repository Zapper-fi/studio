...
export class MorphoAaveV3__factory {
  ...
  static createInterface(): MorphoAaveV3Interface {
    return new utils.Interface(_abi) as MorphoAaveV3Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MorphoAaveV3 {
    return new Contract(address, _abi, signerOrProvider) as MorphoAaveV3;
  }
}
