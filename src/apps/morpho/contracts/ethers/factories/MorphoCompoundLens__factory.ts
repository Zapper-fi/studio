...
import type { MorphoCompoundLens, MorphoCompoundLensInterface } from '../MorphoCompoundLens';
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'uint256',
        name: 'currentPoolSupplyIndex',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'currentPoolBorrowIndex',
        type: 'uint256',
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'uint256',
        name: 'newP2PSupplyIndex',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'newP2PBorrowIndex',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'newPoolSupplyIndex',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: 'newPoolBorrowIndex',
        type: 'uint256',
      },
    ],
    stateMutability: 'view',
...
export class MorphoCompoundLens__factory {
  ...
  static createInterface(): MorphoCompoundLensInterface {
    return new utils.Interface(_abi) as MorphoCompoundLensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MorphoCompoundLens {
    return new Contract(address, _abi, signerOrProvider) as MorphoCompoundLens;
  }
}
