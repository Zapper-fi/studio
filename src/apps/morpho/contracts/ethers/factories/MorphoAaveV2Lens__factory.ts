...
import type { MorphoAaveV2Lens, MorphoAaveV2LensInterface } from '../MorphoAaveV2Lens';
...
const _abi = [
  ...
  },
  {
    ...
    name: '_getCurrentBorrowBalanceInOf',
    outputs: [
      {
        internalType: 'address',
  ...
  },
  {
    ...
    name: '_getCurrentSupplyBalanceInOf',
    outputs: [
      {
        internalType: 'address',
        name: 'underlyingToken',
...
export class MorphoAaveV2Lens__factory {
  ...
  static createInterface(): MorphoAaveV2LensInterface {
    return new utils.Interface(_abi) as MorphoAaveV2LensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MorphoAaveV2Lens {
    return new Contract(address, _abi, signerOrProvider) as MorphoAaveV2Lens;
  }
}
