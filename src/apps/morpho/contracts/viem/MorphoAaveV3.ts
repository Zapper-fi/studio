...
export type MorphoAaveV3 = typeof morphoAaveV3Abi;
export type MorphoAaveV3Contract = GetContractReturnType<MorphoAaveV3, PublicClient>;

export class MorphoAaveV3__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: morphoAaveV3Abi, publicClient: client });
  }
}
