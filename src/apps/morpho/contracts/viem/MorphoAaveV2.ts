...
export type MorphoAaveV2 = typeof morphoAaveV2Abi;
export type MorphoAaveV2Contract = GetContractReturnType<MorphoAaveV2, PublicClient>;

export class MorphoAaveV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: morphoAaveV2Abi, publicClient: client });
  }
}
