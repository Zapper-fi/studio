...
export const morphoCompoundAbi = [
  {
    inputs: [],
    name: 'AmountIsZero',
    type: 'error',
...
export type MorphoCompound = typeof morphoCompoundAbi;
export type MorphoCompoundContract = GetContractReturnType<MorphoCompound, PublicClient>;

export class MorphoCompound__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: morphoCompoundAbi, publicClient: client });
  }
}
