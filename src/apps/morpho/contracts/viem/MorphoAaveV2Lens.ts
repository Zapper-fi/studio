...
export const morphoAaveV2LensAbi = [
  {
    inputs: [
      {
...
export type MorphoAaveV2Lens = typeof morphoAaveV2LensAbi;
export type MorphoAaveV2LensContract = GetContractReturnType<MorphoAaveV2Lens, PublicClient>;

export class MorphoAaveV2Lens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: morphoAaveV2LensAbi, publicClient: client });
  }
}
