...
export const morphoCompoundLensAbi = [
  {
    inputs: [],
...
export type MorphoCompoundLens = typeof morphoCompoundLensAbi;
export type MorphoCompoundLensContract = GetContractReturnType<MorphoCompoundLens, PublicClient>;

export class MorphoCompoundLens__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: morphoCompoundLensAbi, publicClient: client });
  }
}
