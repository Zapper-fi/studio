...
export interface KyberSwapClassicMasterchefV2Interface extends utils.Interface {
  functions: {
    'addPool(address,uint32,uint32,uint32,uint256[],string,string)': FunctionFragment;
    ...
    'renewPool(uint256,uint32,uint32,uint32,uint256[])': FunctionFragment;
    'rewardLocker()': FunctionFragment;
    'rewardTokens(uint256)': FunctionFragment;
    'transferAdmin(address)': FunctionFragment;
    'transferAdminQuickly(address)': FunctionFragment;
    'updatePool(uint256,uint32,uint32,uint256[])': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'multipliers', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  decodeFunctionResult(functionFragment: 'multipliers', data: BytesLike): Result;
  ...
  events: {
    'AddNewPool(address,address,uint32,uint32,uint32)': EventFragment;
    ...
    'RenewPool(uint256,uint32,uint32,uint32)': EventFragment;
    'TransferAdminPending(address)': EventFragment;
    'UpdatePool(uint256,uint32,uint32)': EventFragment;
...
export type AddNewPoolEvent = TypedEvent<[string, string, number, number, number], AddNewPoolEventObject>;
...
export type RenewPoolEvent = TypedEvent<[BigNumber, number, number, number], RenewPoolEventObject>;
...
export type UpdatePoolEvent = TypedEvent<[BigNumber, number, number], UpdatePoolEventObject>;
...
export interface KyberSwapClassicMasterchefV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KyberSwapClassicMasterchefV2Interface;
  ...
  functions: {
    ...
    getPoolInfo(
      ...
      [BigNumber, string, string, number, number, number, number, BigNumber[], BigNumber[], BigNumber[]] & {
    ...
    multipliers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    'AddNewPool(address,address,uint32,uint32,uint32)'(
      stakeToken?: PromiseOrValue<string> | null,
      generatedToken?: PromiseOrValue<string> | null,
      startTime?: null,
      endTime?: null,
    ...
    'RenewPool(uint256,uint32,uint32,uint32)'(
      pid?: PromiseOrValue<BigNumberish> | null,
    ...
    'UpdatePool(uint256,uint32,uint32)'(
      pid?: PromiseOrValue<BigNumberish> | null,
      endTime?: PromiseOrValue<BigNumberish> | null,
      vestingDuration?: PromiseOrValue<BigNumberish> | null,
  ...
  populateTransaction: {
    ...
    multipliers(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
