...
export type MstableAsset = typeof mstableAssetAbi;
export type MstableAssetContract = GetContractReturnType<MstableAsset, PublicClient>;

export class MstableAsset__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: mstableAssetAbi, publicClient: client });
  }
}
