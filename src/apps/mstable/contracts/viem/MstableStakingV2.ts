...
export const mstableStakingV2Abi = [
  {
    inputs: [
      {
...
export type MstableStakingV2 = typeof mstableStakingV2Abi;
export type MstableStakingV2Contract = GetContractReturnType<MstableStakingV2, PublicClient>;

export class MstableStakingV2__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: mstableStakingV2Abi, publicClient: client });
  }
}
