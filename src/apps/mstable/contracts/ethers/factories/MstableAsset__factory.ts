...
import type { MstableAsset, MstableAssetInterface } from '../MstableAsset';
...
export class MstableAsset__factory {
  static readonly abi = _abi;
  static createInterface(): MstableAssetInterface {
    return new utils.Interface(_abi) as MstableAssetInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MstableAsset {
    return new Contract(address, _abi, signerOrProvider) as MstableAsset;
  }
}
