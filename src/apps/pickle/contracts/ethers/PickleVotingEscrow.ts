...
export interface PickleVotingEscrowInterface extends utils.Interface {
  functions: {
...
export interface PickleVotingEscrow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PickleVotingEscrowInterface;
