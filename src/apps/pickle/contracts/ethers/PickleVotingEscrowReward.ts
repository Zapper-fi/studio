...
export interface PickleVotingEscrowRewardInterface extends utils.Interface {
  functions: {
...
export interface PickleVotingEscrowReward extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PickleVotingEscrowRewardInterface;
