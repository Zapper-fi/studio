...
export interface PickleJarMasterchefInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'setBonusEndBlock', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: 'setDevFundDivRate', values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: 'setPicklePerBlock', values: [BigNumberish]): string;
...
export interface PickleJarMasterchef extends BaseContract {
  ...
  callStatic: {
    ...
    setBonusEndBlock(_bonusEndBlock: BigNumberish, overrides?: CallOverrides): Promise<void>;

    setDevFundDivRate(_devFundDivRate: BigNumberish, overrides?: CallOverrides): Promise<void>;

    setPicklePerBlock(_picklePerBlock: BigNumberish, overrides?: CallOverrides): Promise<void>;
