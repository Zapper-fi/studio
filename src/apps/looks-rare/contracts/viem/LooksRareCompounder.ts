...
export const looksRareCompounderAbi = [
  {
    inputs: [
      {
...
export type LooksRareCompounder = typeof looksRareCompounderAbi;
export type LooksRareCompounderContract = GetContractReturnType<LooksRareCompounder, PublicClient>;

export class LooksRareCompounder__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: looksRareCompounderAbi, publicClient: client });
  }
}
