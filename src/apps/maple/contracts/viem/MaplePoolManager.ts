...
export const maplePoolManagerAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type MaplePoolManager = typeof maplePoolManagerAbi;
export type MaplePoolManagerContract = GetContractReturnType<MaplePoolManager, PublicClient>;

export class MaplePoolManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: maplePoolManagerAbi, publicClient: client });
  }
}
