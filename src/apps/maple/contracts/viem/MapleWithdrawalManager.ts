...
export const mapleWithdrawalManagerAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type MapleWithdrawalManager = typeof mapleWithdrawalManagerAbi;
export type MapleWithdrawalManagerContract = GetContractReturnType<MapleWithdrawalManager, PublicClient>;

export class MapleWithdrawalManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: mapleWithdrawalManagerAbi, publicClient: client });
  }
}
