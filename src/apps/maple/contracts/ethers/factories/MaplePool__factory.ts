...
import type { MaplePool, MaplePoolInterface } from '../MaplePool';
...
export class MaplePool__factory {
  static readonly abi = _abi;
  static createInterface(): MaplePoolInterface {
    return new utils.Interface(_abi) as MaplePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MaplePool {
    return new Contract(address, _abi, signerOrProvider) as MaplePool;
  }
}
