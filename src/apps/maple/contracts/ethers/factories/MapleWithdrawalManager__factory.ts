...
import type { MapleWithdrawalManager, MapleWithdrawalManagerInterface } from '../MapleWithdrawalManager';
...
export class MapleWithdrawalManager__factory {
  static readonly abi = _abi;
  static createInterface(): MapleWithdrawalManagerInterface {
    return new utils.Interface(_abi) as MapleWithdrawalManagerInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MapleWithdrawalManager {
    return new Contract(address, _abi, signerOrProvider) as MapleWithdrawalManager;
  }
}
