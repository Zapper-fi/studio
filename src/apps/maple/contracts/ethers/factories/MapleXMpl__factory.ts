...
import type { MapleXMpl, MapleXMplInterface } from '../MapleXMpl';
...
export class MapleXMpl__factory {
  ...
  static createInterface(): MapleXMplInterface {
    return new utils.Interface(_abi) as MapleXMplInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MapleXMpl {
    return new Contract(address, _abi, signerOrProvider) as MapleXMpl;
  }
}
