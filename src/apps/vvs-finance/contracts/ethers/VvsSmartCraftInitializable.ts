...
export interface VvsSmartCraftInitializableInterface extends utils.Interface {
  functions: {
    ...
    'SMART_CRAFT_FACTORY()': FunctionFragment;
...
export interface VvsSmartCraftInitializable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VvsSmartCraftInitializableInterface;
  ...
  functions: {
    ...
    SMART_CRAFT_FACTORY(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    SMART_CRAFT_FACTORY(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    SMART_CRAFT_FACTORY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
