...
export interface RamsesRewardsInterface extends utils.Interface {
  functions: {
...
export type ClaimedFromMergedEvent = TypedEvent<[BigNumber, BigNumber], ClaimedFromMergedEventObject>;
...
export interface RamsesRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RamsesRewardsInterface;
