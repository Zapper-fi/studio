...
export class EthereumBadgerClaimableContractPositionBalanceFetcher
  implements PositionBalanceFetcher<ContractPositionBalance>
{
  ...
  async getBalances(address: string) {
    return this.badgerClaimableBalancesHelper.getBalances({ address, network: Network.ETHEREUM_MAINNET });
  }
}
