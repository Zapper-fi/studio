...
export const badgerYearnVaultAbi = [
  {
    name: 'Transfer',
    inputs: [
      {
...
export type BadgerYearnVault = typeof badgerYearnVaultAbi;
export type BadgerYearnVaultContract = GetContractReturnType<BadgerYearnVault, PublicClient>;

export class BadgerYearnVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: badgerYearnVaultAbi, publicClient: client });
  }
}
