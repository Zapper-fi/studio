...
export type BadgerTree = typeof badgerTreeAbi;
export type BadgerTreeContract = GetContractReturnType<BadgerTree, PublicClient>;

export class BadgerTree__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: badgerTreeAbi, publicClient: client });
  }
}
