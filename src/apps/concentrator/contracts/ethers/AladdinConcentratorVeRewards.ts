...
export interface AladdinConcentratorVeRewards extends BaseContract {
  ...
  callStatic: {
    ...
    claim(_addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    claim(_addr: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
