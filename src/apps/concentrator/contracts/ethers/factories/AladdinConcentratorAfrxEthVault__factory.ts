...
export class AladdinConcentratorAfrxEthVault__factory {
  ...
  static createInterface(): AladdinConcentratorAfrxEthVaultInterface {
    return new utils.Interface(_abi) as AladdinConcentratorAfrxEthVaultInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AladdinConcentratorAfrxEthVault {
    return new Contract(address, _abi, signerOrProvider) as AladdinConcentratorAfrxEthVault;
  }
}
