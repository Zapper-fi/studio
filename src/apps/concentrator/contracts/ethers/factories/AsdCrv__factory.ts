...
import type { AsdCrv, AsdCrvInterface } from '../AsdCrv';
...
export class AsdCrv__factory {
  static readonly abi = _abi;
  static createInterface(): AsdCrvInterface {
    return new utils.Interface(_abi) as AsdCrvInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AsdCrv {
    return new Contract(address, _abi, signerOrProvider) as AsdCrv;
  }
}
