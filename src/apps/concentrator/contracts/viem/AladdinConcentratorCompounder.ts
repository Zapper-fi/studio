...
export const aladdinConcentratorCompounderAbi = [
  {
    inputs: [
      {
...
export type AladdinConcentratorCompounder = typeof aladdinConcentratorCompounderAbi;
export type AladdinConcentratorCompounderContract = GetContractReturnType<AladdinConcentratorCompounder, PublicClient>;

export class AladdinConcentratorCompounder__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aladdinConcentratorCompounderAbi, publicClient: client });
  }
}
