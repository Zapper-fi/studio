...
export const aladdinConcentratorAfxsVaultAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type AladdinConcentratorAfxsVault = typeof aladdinConcentratorAfxsVaultAbi;
export type AladdinConcentratorAfxsVaultContract = GetContractReturnType<AladdinConcentratorAfxsVault, PublicClient>;

export class AladdinConcentratorAfxsVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aladdinConcentratorAfxsVaultAbi, publicClient: client });
  }
}
