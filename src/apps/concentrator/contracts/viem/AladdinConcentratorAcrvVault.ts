...
export const aladdinConcentratorAcrvVaultAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type AladdinConcentratorAcrvVault = typeof aladdinConcentratorAcrvVaultAbi;
export type AladdinConcentratorAcrvVaultContract = GetContractReturnType<AladdinConcentratorAcrvVault, PublicClient>;

export class AladdinConcentratorAcrvVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aladdinConcentratorAcrvVaultAbi, publicClient: client });
  }
}
