...
export const aladdinConcentratorLegacyVaultAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type AladdinConcentratorLegacyVault = typeof aladdinConcentratorLegacyVaultAbi;
export type AladdinConcentratorLegacyVaultContract = GetContractReturnType<
...
export class AladdinConcentratorLegacyVault__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aladdinConcentratorLegacyVaultAbi, publicClient: client });
  }
}
