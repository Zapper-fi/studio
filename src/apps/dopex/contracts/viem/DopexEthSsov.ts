...
export type DopexEthSsov = typeof dopexEthSsovAbi;
export type DopexEthSsovContract = GetContractReturnType<DopexEthSsov, PublicClient>;

export class DopexEthSsov__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexEthSsovAbi, publicClient: client });
  }
}
