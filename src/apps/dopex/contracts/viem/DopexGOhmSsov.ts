...
export type DopexGOhmSsov = typeof dopexGOhmSsovAbi;
export type DopexGOhmSsovContract = GetContractReturnType<DopexGOhmSsov, PublicClient>;

export class DopexGOhmSsov__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexGOhmSsovAbi, publicClient: client });
  }
}
