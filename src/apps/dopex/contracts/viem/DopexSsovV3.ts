...
export type DopexSsovV3 = typeof dopexSsovV3Abi;
export type DopexSsovV3Contract = GetContractReturnType<DopexSsovV3, PublicClient>;

export class DopexSsovV3__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexSsovV3Abi, publicClient: client });
  }
}
