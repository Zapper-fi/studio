...
export type DopexGmxSsov = typeof dopexGmxSsovAbi;
export type DopexGmxSsovContract = GetContractReturnType<DopexGmxSsov, PublicClient>;

export class DopexGmxSsov__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexGmxSsovAbi, publicClient: client });
  }
}
