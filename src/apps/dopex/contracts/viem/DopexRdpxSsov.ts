...
export type DopexRdpxSsov = typeof dopexRdpxSsovAbi;
export type DopexRdpxSsovContract = GetContractReturnType<DopexRdpxSsov, PublicClient>;

export class DopexRdpxSsov__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexRdpxSsovAbi, publicClient: client });
  }
}
