...
export type DopexDpxSsov = typeof dopexDpxSsovAbi;
export type DopexDpxSsovContract = GetContractReturnType<DopexDpxSsov, PublicClient>;

export class DopexDpxSsov__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dopexDpxSsovAbi, publicClient: client });
  }
}
