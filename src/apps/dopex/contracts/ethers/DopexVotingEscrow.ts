...
export interface DopexVotingEscrowInterface extends utils.Interface {
  functions: {
...
export interface DopexVotingEscrow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DopexVotingEscrowInterface;
