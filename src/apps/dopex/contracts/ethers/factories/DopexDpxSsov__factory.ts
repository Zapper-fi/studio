...
import type { DopexDpxSsov, DopexDpxSsovInterface } from '../DopexDpxSsov';
...
export class DopexDpxSsov__factory {
  static readonly abi = _abi;
  static createInterface(): DopexDpxSsovInterface {
    return new utils.Interface(_abi) as DopexDpxSsovInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DopexDpxSsov {
    return new Contract(address, _abi, signerOrProvider) as DopexDpxSsov;
  }
}
