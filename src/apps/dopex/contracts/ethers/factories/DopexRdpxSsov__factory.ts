...
import type { DopexRdpxSsov, DopexRdpxSsovInterface } from '../DopexRdpxSsov';
...
export class DopexRdpxSsov__factory {
  static readonly abi = _abi;
  static createInterface(): DopexRdpxSsovInterface {
    return new utils.Interface(_abi) as DopexRdpxSsovInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DopexRdpxSsov {
    return new Contract(address, _abi, signerOrProvider) as DopexRdpxSsov;
  }
}
