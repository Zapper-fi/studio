...
import type { DopexEthSsov, DopexEthSsovInterface } from '../DopexEthSsov';
...
const _abi = [
  ...
  },
  {
    ...
    name: 'totalEpochStrikeEthBalance',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
...
export class DopexEthSsov__factory {
  static readonly abi = _abi;
  static createInterface(): DopexEthSsovInterface {
    return new utils.Interface(_abi) as DopexEthSsovInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DopexEthSsov {
    return new Contract(address, _abi, signerOrProvider) as DopexEthSsov;
  }
}
