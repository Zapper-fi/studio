...
export interface DopexRdpxSsovInterface extends utils.Interface {
  functions: {
    ...
    'totalEpochStrikeDpxBalance(uint256,uint256)': FunctionFragment;
    'totalEpochStrikeRdpxBalance(uint256,uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'totalEpochStrikeDpxBalance',
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
  encodeFunctionData(
    functionFragment: 'totalEpochStrikeRdpxBalance',
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'totalEpochStrikeDpxBalance', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'totalEpochStrikeRdpxBalance', data: BytesLike): Result;
...
export type CompoundEvent = TypedEvent<[BigNumber, BigNumber, BigNumber, BigNumber], CompoundEventObject>;

export type CompoundEventFilter = TypedEventFilter<CompoundEvent>;

export interface EmergencyWithdrawEventObject {
  sender: string;
  dpxWithdrawn: BigNumber;
  rdpxWithdrawn: BigNumber;
}
...
export interface DopexRdpxSsov extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DopexRdpxSsovInterface;
  ...
  callStatic: {
    ...
    updatePurchaseFeePercentage(newFee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    ...
    EmergencyWithdraw(sender?: null, dpxWithdrawn?: null, rdpxWithdrawn?: null): EmergencyWithdrawEventFilter;
    ...
    NewWithdraw(epoch?: null, strike?: null, user?: null, amount?: null, rdpxAmount?: null): NewWithdrawEventFilter;
    ...
    'PurchaseFeePercentageUpdate(uint256)'(newFee?: null): PurchaseFeePercentageUpdateEventFilter;
    PurchaseFeePercentageUpdate(newFee?: null): PurchaseFeePercentageUpdateEventFilter;
