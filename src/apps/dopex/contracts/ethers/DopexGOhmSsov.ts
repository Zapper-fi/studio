...
export interface DopexGOhmSsovInterface extends utils.Interface {
  functions: {
    ...
    'totalEpochStrikeGohmBalance(uint256,uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'totalEpochStrikeGohmBalance',
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>],
  ): string;
  ...
  decodeFunctionResult(functionFragment: 'totalEpochStrikeGohmBalance', data: BytesLike): Result;
  ...
  events: {
    ...
    'ExpireEpoch(uint256,uint256)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'ExpireEpoch'): EventFragment;
...
export interface ExpireEpochEventObject {
  epoch: BigNumber;
  settlementPrice: BigNumber;
}
export type ExpireEpochEvent = TypedEvent<[BigNumber, BigNumber], ExpireEpochEventObject>;

export type ExpireEpochEventFilter = TypedEventFilter<ExpireEpochEvent>;
...
export interface DopexGOhmSsov extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DopexGOhmSsovInterface;
  ...
  functions: {
    ...
    getUsdPrice(overrides?: CallOverrides): Promise<[BigNumber] & { price: BigNumber }>;
  ...
  filters: {
    ...
    'EmergencyWithdraw(address,uint256)'(sender?: null, gohmWithdrawn?: null): EmergencyWithdrawEventFilter;
    EmergencyWithdraw(sender?: null, gohmWithdrawn?: null): EmergencyWithdrawEventFilter;
    ...
    'ExpireEpoch(uint256,uint256)'(epoch?: null, settlementPrice?: null): ExpireEpochEventFilter;
    ExpireEpoch(epoch?: null, settlementPrice?: null): ExpireEpochEventFilter;
    ...
    NewWithdraw(epoch?: null, strike?: null, user?: null, amount?: null, gohmAmount?: null): NewWithdrawEventFilter;
