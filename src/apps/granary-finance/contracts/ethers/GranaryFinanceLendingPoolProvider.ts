...
export interface GranaryFinanceLendingPoolProviderInterface extends utils.Interface {
  functions: {
...
export interface GranaryFinanceLendingPoolProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GranaryFinanceLendingPoolProviderInterface;
