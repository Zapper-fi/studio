...
export type StabilityPool = typeof stabilityPoolAbi;
export type StabilityPoolContract = GetContractReturnType<StabilityPool, PublicClient>;

export class StabilityPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: stabilityPoolAbi, publicClient: client });
  }
}
