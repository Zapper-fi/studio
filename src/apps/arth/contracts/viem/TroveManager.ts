...
export type TroveManager = typeof troveManagerAbi;
export type TroveManagerContract = GetContractReturnType<TroveManager, PublicClient>;

export class TroveManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: troveManagerAbi, publicClient: client });
  }
}
