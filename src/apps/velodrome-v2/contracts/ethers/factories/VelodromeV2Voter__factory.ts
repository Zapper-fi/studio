...
import type { VelodromeV2Voter, VelodromeV2VoterInterface } from '../VelodromeV2Voter';
...
export class VelodromeV2Voter__factory {
  static readonly abi = _abi;
  static createInterface(): VelodromeV2VoterInterface {
    return new utils.Interface(_abi) as VelodromeV2VoterInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VelodromeV2Voter {
    return new Contract(address, _abi, signerOrProvider) as VelodromeV2Voter;
  }
}
