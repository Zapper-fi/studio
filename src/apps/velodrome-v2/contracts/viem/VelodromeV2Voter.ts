...
export const velodromeV2VoterAbi = [
  {
    inputs: [
      {
...
export type VelodromeV2Voter = typeof velodromeV2VoterAbi;
export type VelodromeV2VoterContract = GetContractReturnType<VelodromeV2Voter, PublicClient>;

export class VelodromeV2Voter__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: velodromeV2VoterAbi, publicClient: client });
  }
}
