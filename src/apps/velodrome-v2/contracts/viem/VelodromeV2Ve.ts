...
export type VelodromeV2Ve = typeof velodromeV2VeAbi;
export type VelodromeV2VeContract = GetContractReturnType<VelodromeV2Ve, PublicClient>;

export class VelodromeV2Ve__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: velodromeV2VeAbi, publicClient: client });
  }
}
