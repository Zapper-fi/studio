...
export const dhedgeV2FactoryAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type DhedgeV2Factory = typeof dhedgeV2FactoryAbi;
export type DhedgeV2FactoryContract = GetContractReturnType<DhedgeV2Factory, PublicClient>;

export class DhedgeV2Factory__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: dhedgeV2FactoryAbi, publicClient: client });
  }
}
