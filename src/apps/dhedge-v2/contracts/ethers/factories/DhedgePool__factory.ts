...
import type { DhedgePool, DhedgePoolInterface } from '../DhedgePool';
...
export class DhedgePool__factory {
  static readonly abi = _abi;
  static createInterface(): DhedgePoolInterface {
    return new utils.Interface(_abi) as DhedgePoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DhedgePool {
    return new Contract(address, _abi, signerOrProvider) as DhedgePool;
  }
}
