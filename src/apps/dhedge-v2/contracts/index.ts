...
import { DhedgeV2Factory__factory, DhedgeV2StakingV2__factory, DhedgeV2Token__factory } from './ethers';
...
export class DhedgeV2ContractFactory extends ContractFactory {
  ...
  dhedgeV2StakingV2({ address, network }: ContractOpts) {
    return DhedgeV2StakingV2__factory.connect(address, this.appToolkit.getNetworkProvider(network));
  }
...
export type { DhedgeV2StakingV2 } from './ethers';
