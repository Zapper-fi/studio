...
export declare namespace OptionMarket {
  ...
  export type OptionMarketParametersStructOutput = [BigNumber, string, BigNumber, BigNumber] & {
...
export type SMClaimedEvent = TypedEvent<[string, BigNumber], SMClaimedEventObject>;
...
export interface LyraOptionMarket extends BaseContract {
  ...
  functions: {
    ...
    getBoardAndStrikeDetails(
      ...
      [OptionMarket.OptionBoardStructOutput, OptionMarket.StrikeStructOutput[], BigNumber[], BigNumber, BigNumber]
    >;
  ...
  filters: {
    ...
    'BoardSettled(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)'(
      boardId?: PromiseOrValue<BigNumberish> | null,
