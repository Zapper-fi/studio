...
import { LyraNewportContractFactory, LyraLpStaking } from '../contracts';
...
@PositionTemplate()
export class EthereumLyraNewportStakingContractPositionFetcher extends SingleStakingFarmTemplateContractPositionFetcher<LyraLpStaking> {
  groupLabel = 'Farm';
