...
import { LyraNewportContractFactory, LyraStkLyra } from '../contracts';

@PositionTemplate()
export class EthereumLyraNewportStkLyraTokenFetcher extends AppTokenTemplatePositionFetcher<LyraStkLyra> {
  groupLabel = 'stkLYRA';
