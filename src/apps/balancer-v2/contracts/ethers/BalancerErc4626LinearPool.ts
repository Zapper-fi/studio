...
export interface BalancerErc4626LinearPoolInterface extends utils.Interface {
  functions: {
...
export interface BalancerErc4626LinearPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerErc4626LinearPoolInterface;
