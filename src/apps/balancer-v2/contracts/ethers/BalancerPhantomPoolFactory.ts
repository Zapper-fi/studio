...
export interface BalancerPhantomPoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface BalancerPhantomPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerPhantomPoolFactoryInterface;
