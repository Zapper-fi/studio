...
export interface BalancerGauge extends BaseContract {
  ...
  functions: {
    ...
    killGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;

    unkillGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    RewardDistributorUpdated(reward_token?: string | null, distributor?: null): RewardDistributorUpdatedEventFilter;
  };
  ...
  estimateGas: {
    ...
    killGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    unkillGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    initialize(_lp_token: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    killGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    unkillGauge(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
