...
export class BalancerComposableStablePool__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): BalancerComposableStablePool {
    return new Contract(address, _abi, signerOrProvider) as BalancerComposableStablePool;
  }
}
