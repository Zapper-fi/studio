...
import type { BalancerFeeDistributor, BalancerFeeDistributorInterface } from '../BalancerFeeDistributor';
...
export class BalancerFeeDistributor__factory {
  static readonly abi = _abi;
  static createInterface(): BalancerFeeDistributorInterface {
    return new utils.Interface(_abi) as BalancerFeeDistributorInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BalancerFeeDistributor {
    return new Contract(address, _abi, signerOrProvider) as BalancerFeeDistributor;
  }
}
