...
import type { BalancerWrappedAaveToken, BalancerWrappedAaveTokenInterface } from '../BalancerWrappedAaveToken';
...
export class BalancerWrappedAaveToken__factory {
  static readonly abi = _abi;
  static createInterface(): BalancerWrappedAaveTokenInterface {
    return new utils.Interface(_abi) as BalancerWrappedAaveTokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BalancerWrappedAaveToken {
    return new Contract(address, _abi, signerOrProvider) as BalancerWrappedAaveToken;
  }
}
