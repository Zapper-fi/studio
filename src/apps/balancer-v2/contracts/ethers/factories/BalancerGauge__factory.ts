...
import type { BalancerGauge, BalancerGaugeInterface } from '../BalancerGauge';
...
export class BalancerGauge__factory {
  ...
  static createInterface(): BalancerGaugeInterface {
    return new utils.Interface(_abi) as BalancerGaugeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BalancerGauge {
    return new Contract(address, _abi, signerOrProvider) as BalancerGauge;
  }
}
