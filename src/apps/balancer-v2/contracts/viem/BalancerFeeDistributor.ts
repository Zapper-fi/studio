...
export const balancerFeeDistributorAbi = [
  {
    inputs: [
      {
...
export type BalancerFeeDistributor = typeof balancerFeeDistributorAbi;
export type BalancerFeeDistributorContract = GetContractReturnType<BalancerFeeDistributor, PublicClient>;

export class BalancerFeeDistributor__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerFeeDistributorAbi, publicClient: client });
  }
}
