...
export const balancerBoostedPoolAbi = [
  {
    inputs: [
      {
        components: [
...
export type BalancerBoostedPool = typeof balancerBoostedPoolAbi;
export type BalancerBoostedPoolContract = GetContractReturnType<BalancerBoostedPool, PublicClient>;

export class BalancerBoostedPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerBoostedPoolAbi, publicClient: client });
  }
}
