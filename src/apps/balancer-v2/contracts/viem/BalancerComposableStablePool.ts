...
export const balancerComposableStablePoolAbi = [
  {
    inputs: [
      {
        components: [
...
export type BalancerComposableStablePool = typeof balancerComposableStablePoolAbi;
export type BalancerComposableStablePoolContract = GetContractReturnType<BalancerComposableStablePool, PublicClient>;

export class BalancerComposableStablePool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerComposableStablePoolAbi, publicClient: client });
  }
}
