...
export type BalancerGauge = typeof balancerGaugeAbi;
export type BalancerGaugeContract = GetContractReturnType<BalancerGauge, PublicClient>;

export class BalancerGauge__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerGaugeAbi, publicClient: client });
  }
}
