...
export const balancerWrappedAaveTokenAbi = [
  {
    inputs: [],
...
export type BalancerWrappedAaveToken = typeof balancerWrappedAaveTokenAbi;
export type BalancerWrappedAaveTokenContract = GetContractReturnType<BalancerWrappedAaveToken, PublicClient>;

export class BalancerWrappedAaveToken__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerWrappedAaveTokenAbi, publicClient: client });
  }
}
