...
export const balancerMerkleOrchardAbi = [
  {
    inputs: [
      {
...
export type BalancerMerkleOrchard = typeof balancerMerkleOrchardAbi;
export type BalancerMerkleOrchardContract = GetContractReturnType<BalancerMerkleOrchard, PublicClient>;

export class BalancerMerkleOrchard__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: balancerMerkleOrchardAbi, publicClient: client });
  }
}
