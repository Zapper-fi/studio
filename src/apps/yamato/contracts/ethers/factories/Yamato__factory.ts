...
import type { Yamato, YamatoInterface } from '../Yamato';
...
export class Yamato__factory {
  ...
  static createInterface(): YamatoInterface {
    return new utils.Interface(_abi) as YamatoInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Yamato {
    return new Contract(address, _abi, signerOrProvider) as Yamato;
  }
}
