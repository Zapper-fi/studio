...
import type { RenDarknodeRegistry, RenDarknodeRegistryInterface } from '../RenDarknodeRegistry';
...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        internalType: 'uint256',
        name: '_deregistrationIntervalSeconds',
        type: 'uint256',
      },
    ],
    name: 'initialize',
  ...
  },
  {
    ...
    inputs: [
      {
        internalType: 'contract DarknodeRegistryLogicV1',
        name: '_newOwner',
        type: 'address',
      },
    ],
...
export class RenDarknodeRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): RenDarknodeRegistryInterface {
    return new utils.Interface(_abi) as RenDarknodeRegistryInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RenDarknodeRegistry {
    return new Contract(address, _abi, signerOrProvider) as RenDarknodeRegistry;
  }
}
