...
export const renDarknodeRegistryAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type RenDarknodeRegistry = typeof renDarknodeRegistryAbi;
export type RenDarknodeRegistryContract = GetContractReturnType<RenDarknodeRegistry, PublicClient>;

export class RenDarknodeRegistry__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: renDarknodeRegistryAbi, publicClient: client });
  }
}
