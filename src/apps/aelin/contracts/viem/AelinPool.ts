...
export type AelinPool = typeof aelinPoolAbi;
export type AelinPoolContract = GetContractReturnType<AelinPool, PublicClient>;

export class AelinPool__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: aelinPoolAbi, publicClient: client });
  }
}
