...
import type { AelinPool, AelinPoolInterface } from '../AelinPool';
...
export class AelinPool__factory {
  static readonly abi = _abi;
  static createInterface(): AelinPoolInterface {
    return new utils.Interface(_abi) as AelinPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AelinPool {
    return new Contract(address, _abi, signerOrProvider) as AelinPool;
  }
}
