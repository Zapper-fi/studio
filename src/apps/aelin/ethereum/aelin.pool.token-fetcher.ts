...
export class EthereumAelinPoolTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
  ...
  @CacheOnInterval({
    key: `studio:${AELIN_DEFINITION.id}:${AELIN_DEFINITION.groups.pool}:${Network.ETHEREUM_MAINNET}:addresses`,
    timeout: 15 * 60 * 1000,
  })
