...
export interface Y2KFinanceStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface Y2KFinanceStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Y2KFinanceStakingRewardsInterface;
  ...
  filters: {
    ...
    Staked(user?: PromiseOrValue<string> | null, id?: null, amount?: null): StakedEventFilter;
    ...
    Withdrawn(user?: PromiseOrValue<string> | null, id?: null, amount?: null): WithdrawnEventFilter;
  };
