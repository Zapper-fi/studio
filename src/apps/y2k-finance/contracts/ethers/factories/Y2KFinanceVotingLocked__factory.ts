...
import type { Y2KFinanceVotingLocked, Y2KFinanceVotingLockedInterface } from '../Y2KFinanceVotingLocked';
...
export class Y2KFinanceVotingLocked__factory {
  ...
  static createInterface(): Y2KFinanceVotingLockedInterface {
    return new utils.Interface(_abi) as Y2KFinanceVotingLockedInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Y2KFinanceVotingLocked {
    return new Contract(address, _abi, signerOrProvider) as Y2KFinanceVotingLocked;
  }
}
