...
export interface TectonicTTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_setTectonicCore', values: [string]): string;
...
export interface TectonicTToken extends BaseContract {
  ...
  callStatic: {
    ...
    _setTectonicCore(newTectonicCore: string, overrides?: CallOverrides): Promise<BigNumber>;
