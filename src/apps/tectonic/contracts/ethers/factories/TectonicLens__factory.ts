...
import type { TectonicLens, TectonicLensInterface } from '../TectonicLens';
...
const _abi = [
  {
    ...
    inputs: [
      {
        internalType: 'contract TectonicCoreLensInterface',
        name: 'tectonicCore',
        type: 'address',
      },
      {
...
export class TectonicLens__factory {
  static readonly abi = _abi;
  static createInterface(): TectonicLensInterface {
    return new utils.Interface(_abi) as TectonicLensInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): TectonicLens {
    return new Contract(address, _abi, signerOrProvider) as TectonicLens;
  }
}
