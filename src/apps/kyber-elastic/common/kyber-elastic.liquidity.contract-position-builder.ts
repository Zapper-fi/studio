...
import { KyberElasticLiquidityPositionDataProps } from './kyber-elastic.liquidity.contract-position-fetcher';
import { KyberElasticLiquidityPositionContractData, KyberElasticPoolStateData } from './kyber-elastic.liquidity.types';
import { getSupplied, getRange } from './kyber-elastic.liquidity.utils';

type KyberElasticLiquidityContractPositionHelperParams = {
...
export class KyberElasticLiquidityContractPositionBuilder {
  ...
  async buildPosition({
    ...
    network,
    collapseClaimable,
  }: KyberElasticLiquidityContractPositionHelperParams) {
    ...
    const positionData: KyberElasticLiquidityPositionContractData = {
    ...
    const state: KyberElasticPoolStateData = {
    ...
    const dataProps: KyberElasticLiquidityPositionDataProps = {
    ...
    const balance: ContractPositionBalance<KyberElasticLiquidityPositionDataProps> = {
