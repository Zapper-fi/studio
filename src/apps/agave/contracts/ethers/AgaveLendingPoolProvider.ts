...
export interface AgaveLendingPoolProviderInterface extends utils.Interface {
  functions: {
...
export interface AgaveLendingPoolProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AgaveLendingPoolProviderInterface;
