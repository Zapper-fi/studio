...
export type Xinv = typeof xinvAbi;
export type XinvContract = GetContractReturnType<Xinv, PublicClient>;

export class Xinv__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: xinvAbi, publicClient: client });
  }
}
