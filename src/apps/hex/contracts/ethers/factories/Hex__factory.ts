...
import type { Hex, HexInterface } from '../Hex';
...
export class Hex__factory {
  static readonly abi = _abi;
  static createInterface(): HexInterface {
    return new utils.Interface(_abi) as HexInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Hex {
    return new Contract(address, _abi, signerOrProvider) as Hex;
  }
}
