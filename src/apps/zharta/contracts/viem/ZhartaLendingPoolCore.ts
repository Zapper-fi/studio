...
export const zhartaLendingPoolCoreAbi = [
  {
    name: 'OwnerProposed',
    inputs: [
      {
...
export type ZhartaLendingPoolCore = typeof zhartaLendingPoolCoreAbi;
export type ZhartaLendingPoolCoreContract = GetContractReturnType<ZhartaLendingPoolCore, PublicClient>;

export class ZhartaLendingPoolCore__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: zhartaLendingPoolCoreAbi, publicClient: client });
  }
}
