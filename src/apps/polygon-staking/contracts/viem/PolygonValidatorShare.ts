...
export const polygonValidatorShareAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type PolygonValidatorShare = typeof polygonValidatorShareAbi;
export type PolygonValidatorShareContract = GetContractReturnType<PolygonValidatorShare, PublicClient>;

export class PolygonValidatorShare__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: polygonValidatorShareAbi, publicClient: client });
  }
}
