...
export const polygonStakeManagerAbi = [
  {
    inputs: [],
    payable: false,
...
export type PolygonStakeManager = typeof polygonStakeManagerAbi;
export type PolygonStakeManagerContract = GetContractReturnType<PolygonStakeManager, PublicClient>;

export class PolygonStakeManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: polygonStakeManagerAbi, publicClient: client });
  }
}
