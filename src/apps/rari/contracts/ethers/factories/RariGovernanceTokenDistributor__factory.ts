...
import type {
  ...
  RariGovernanceTokenDistributorInterface,
} from '../RariGovernanceTokenDistributor';
...
export class RariGovernanceTokenDistributor__factory {
  static readonly abi = _abi;
  static createInterface(): RariGovernanceTokenDistributorInterface {
    return new utils.Interface(_abi) as RariGovernanceTokenDistributorInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): RariGovernanceTokenDistributor {
    return new Contract(address, _abi, signerOrProvider) as RariGovernanceTokenDistributor;
  }
}
