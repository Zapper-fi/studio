...
export const rariFundManagerAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type RariFundManager = typeof rariFundManagerAbi;
export type RariFundManagerContract = GetContractReturnType<RariFundManager, PublicClient>;

export class RariFundManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rariFundManagerAbi, publicClient: client });
  }
}
