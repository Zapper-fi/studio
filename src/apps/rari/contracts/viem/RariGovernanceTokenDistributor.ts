...
export const rariGovernanceTokenDistributorAbi = [
  {
    anonymous: false,
    inputs: [
      {
...
export type RariGovernanceTokenDistributor = typeof rariGovernanceTokenDistributorAbi;
export type RariGovernanceTokenDistributorContract = GetContractReturnType<
...
export class RariGovernanceTokenDistributor__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: rariGovernanceTokenDistributorAbi, publicClient: client });
  }
}
