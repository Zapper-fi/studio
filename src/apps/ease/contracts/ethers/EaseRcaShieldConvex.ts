...
export interface EaseRcaShieldConvexInterface extends utils.Interface {
  functions: {
...
export interface EaseRcaShieldConvex extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EaseRcaShieldConvexInterface;
