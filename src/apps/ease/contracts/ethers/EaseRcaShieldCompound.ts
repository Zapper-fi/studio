...
export interface EaseRcaShieldCompoundInterface extends utils.Interface {
  functions: {
...
export interface EaseRcaShieldCompound extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EaseRcaShieldCompoundInterface;
