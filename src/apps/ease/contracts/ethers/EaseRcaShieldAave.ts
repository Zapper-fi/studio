...
export interface EaseRcaShieldAaveInterface extends utils.Interface {
  functions: {
...
export interface EaseRcaShieldAave extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EaseRcaShieldAaveInterface;
