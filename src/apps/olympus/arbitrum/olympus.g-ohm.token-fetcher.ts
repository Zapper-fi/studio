...
const GOVERNANCE_OHM = '0x8d9ba570d6cb60c7e3e0f31343efe75ab8e65fb1';
...
export class ArbitrumOlympusGOhmTokenFetcher implements PositionFetcher<AppTokenPosition> {
  ...
  async getPositions() {
    return this.bridgeTokenHelper.getPositions({
      ...
      dest: { network: Network.ARBITRUM_MAINNET, address: GOVERNANCE_OHM },
      appId: OLYMPUS_DEFINITION.id,
      groupId: OLYMPUS_DEFINITION.groups.gOhm.id,
    });
  }
