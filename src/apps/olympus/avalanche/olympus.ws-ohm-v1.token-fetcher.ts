...
const WRAPPED_STAKED_OHM = '0x8cd309e14575203535ef120b5b0ab4dded0c2073';
...
export class AvalancheOlympusWsOhmV1TokenFetcher implements PositionFetcher<AppTokenPosition> {
  ...
  async getPositions() {
    return this.bridgeTokenHelper.getPositions({
      ...
      dest: { network: Network.AVALANCHE_MAINNET, address: WRAPPED_STAKED_OHM },
      appId: OLYMPUS_DEFINITION.id,
      groupId: OLYMPUS_DEFINITION.groups.wsOhmV1.id,
    });
  }
