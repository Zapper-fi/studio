...
export const olympusBoostedLiquidityManagerAbi = [
  {
    inputs: [
      {
...
export type OlympusBoostedLiquidityManager = typeof olympusBoostedLiquidityManagerAbi;
export type OlympusBoostedLiquidityManagerContract = GetContractReturnType<
...
export class OlympusBoostedLiquidityManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: olympusBoostedLiquidityManagerAbi, publicClient: client });
  }
}
