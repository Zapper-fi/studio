...
export const olympusZapperZapAbi = [
  {
    inputs: [
      {
...
export type OlympusZapperZap = typeof olympusZapperZapAbi;
export type OlympusZapperZapContract = GetContractReturnType<OlympusZapperZap, PublicClient>;

export class OlympusZapperZap__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: olympusZapperZapAbi, publicClient: client });
  }
}
