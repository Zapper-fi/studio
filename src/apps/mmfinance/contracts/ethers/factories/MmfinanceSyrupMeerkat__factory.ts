...
import type { MmfinanceSyrupMeerkat, MmfinanceSyrupMeerkatInterface } from '../MmfinanceSyrupMeerkat';
...
export class MmfinanceSyrupMeerkat__factory {
  ...
  static createInterface(): MmfinanceSyrupMeerkatInterface {
    return new utils.Interface(_abi) as MmfinanceSyrupMeerkatInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): MmfinanceSyrupMeerkat {
    return new Contract(address, _abi, signerOrProvider) as MmfinanceSyrupMeerkat;
  }
}
