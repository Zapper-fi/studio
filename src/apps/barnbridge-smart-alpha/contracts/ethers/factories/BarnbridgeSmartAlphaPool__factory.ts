...
import type { BarnbridgeSmartAlphaPool, BarnbridgeSmartAlphaPoolInterface } from '../BarnbridgeSmartAlphaPool';
...
export class BarnbridgeSmartAlphaPool__factory {
  ...
  static createInterface(): BarnbridgeSmartAlphaPoolInterface {
    return new utils.Interface(_abi) as BarnbridgeSmartAlphaPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BarnbridgeSmartAlphaPool {
    return new Contract(address, _abi, signerOrProvider) as BarnbridgeSmartAlphaPool;
  }
}
