...
export type GeistRewards = typeof geistRewardsAbi;
export type GeistRewardsContract = GetContractReturnType<GeistRewards, PublicClient>;

export class GeistRewards__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: geistRewardsAbi, publicClient: client });
  }
}
