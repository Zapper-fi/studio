...
export interface IdleControllerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: '_addIdleMarkets', values: [PromiseOrValue<string>[]]): string;
  encodeFunctionData(functionFragment: '_become', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: '_dropIdleMarket', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: '_resetMarkets', values?: undefined): string;
  encodeFunctionData(functionFragment: '_setBonusDistribution', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: '_setIdleAddress', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: '_setIdleRate', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: '_setPriceOracle', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: '_supportMarkets', values: [PromiseOrValue<string>[]]): string;
  ...
  encodeFunctionData(functionFragment: 'idleAccrued', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(functionFragment: 'idleAddress', values?: undefined): string;
  encodeFunctionData(functionFragment: 'idleClaimThreshold', values?: undefined): string;
  encodeFunctionData(functionFragment: 'idleInitialIndex', values?: undefined): string;
  encodeFunctionData(functionFragment: 'idleRate', values?: undefined): string;
  encodeFunctionData(functionFragment: 'idleSpeeds', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
    functionFragment: 'idleSupplierIndex',
    values: [PromiseOrValue<string>, PromiseOrValue<string>],
  ): string;
  encodeFunctionData(functionFragment: 'idleSupplyState', values: [PromiseOrValue<string>]): string;
  ...
  encodeFunctionData(functionFragment: 'refreshIdleSpeeds', values?: undefined): string;

  decodeFunctionResult(functionFragment: '_addIdleMarkets', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_become', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_dropIdleMarket', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_resetMarkets', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setBonusDistribution', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setIdleAddress', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setIdleRate', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_setPriceOracle', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: '_supportMarkets', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'idleAccrued', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'idleAddress', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'idleClaimThreshold', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'idleInitialIndex', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'idleSupplierIndex', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'idleSupplyState', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'refreshIdleSpeeds', data: BytesLike): Result;
...
export type DistributedIdleEvent = TypedEvent<[string, string, BigNumber, BigNumber], DistributedIdleEventObject>;
...
export type IdleSpeedUpdatedEvent = TypedEvent<[string, BigNumber], IdleSpeedUpdatedEventObject>;

export type IdleSpeedUpdatedEventFilter = TypedEventFilter<IdleSpeedUpdatedEvent>;

export interface MarketIdledEventObject {
  idleToken: string;
  isIdled: boolean;
}
export type MarketIdledEvent = TypedEvent<[string, boolean], MarketIdledEventObject>;
...
export type NewIdleOracleEvent = TypedEvent<[string, string], NewIdleOracleEventObject>;
...
export type NewIdleRateEvent = TypedEvent<[BigNumber, BigNumber], NewIdleRateEventObject>;
...
export interface IdleController extends BaseContract {
  ...
  functions: {
    ...
    _resetMarkets(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
    ...
    idleAccrued(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    idleSpeeds(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    refreshIdleSpeeds(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  };
  ...
  callStatic: {
    _addIdleMarkets(idleTokens: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>;

    _become(_unitroller: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    _dropIdleMarket(idleToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    _resetMarkets(overrides?: CallOverrides): Promise<BigNumber>;

    _setBonusDistribution(_bonusMultiplier: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    _setIdleAddress(_idleAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    _setIdleRate(idleRate_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    _setPriceOracle(priceOracle_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;

    _supportMarkets(idleTokens: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    IdleSpeedUpdated(idleToken?: PromiseOrValue<string> | null, newSpeed?: null): IdleSpeedUpdatedEventFilter;

    'MarketIdled(address,bool)'(idleToken?: null, isIdled?: null): MarketIdledEventFilter;
    ...
    'NewIdleOracle(address,address)'(oldIdleOracle?: null, newIdleOracle?: null): NewIdleOracleEventFilter;
    NewIdleOracle(oldIdleOracle?: null, newIdleOracle?: null): NewIdleOracleEventFilter;

    'NewIdleRate(uint256,uint256)'(oldIdleRate?: null, newIdleRate?: null): NewIdleRateEventFilter;
  ...
  estimateGas: {
    ...
    _resetMarkets(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
    ...
    idleSupplyState(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    refreshIdleSpeeds(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    _resetMarkets(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
    ...
    idleAccrued(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    idleAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    idleClaimThreshold(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    idleSpeeds(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    idleSupplyState(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    refreshIdleSpeeds(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
  };
}
