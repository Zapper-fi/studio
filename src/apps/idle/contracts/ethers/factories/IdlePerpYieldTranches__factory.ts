...
import type { IdlePerpYieldTranches, IdlePerpYieldTranchesInterface } from '../IdlePerpYieldTranches';
...
export class IdlePerpYieldTranches__factory {
  ...
  static createInterface(): IdlePerpYieldTranchesInterface {
    return new utils.Interface(_abi) as IdlePerpYieldTranchesInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IdlePerpYieldTranches {
    return new Contract(address, _abi, signerOrProvider) as IdlePerpYieldTranches;
  }
}
