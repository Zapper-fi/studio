...
import type {
  IdlePerpetualYieldTranches,
  IdlePerpetualYieldTranchesInterface,
} from "../IdlePerpetualYieldTranches";
...
export class IdlePerpetualYieldTranches__factory {
  static readonly abi = _abi;
  static createInterface(): IdlePerpetualYieldTranchesInterface {
    return new utils.Interface(_abi) as IdlePerpetualYieldTranchesInterface;
  }
  static connect(
    address: string,
