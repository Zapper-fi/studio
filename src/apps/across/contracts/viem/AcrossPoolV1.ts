...
export type AcrossPoolV1 = typeof acrossPoolV1Abi;
export type AcrossPoolV1Contract = GetContractReturnType<AcrossPoolV1, PublicClient>;

export class AcrossPoolV1__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: acrossPoolV1Abi, publicClient: client });
  }
}
