...
export type AcrossStaking = typeof acrossStakingAbi;
export type AcrossStakingContract = GetContractReturnType<AcrossStaking, PublicClient>;

export class AcrossStaking__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: acrossStakingAbi, publicClient: client });
  }
}
