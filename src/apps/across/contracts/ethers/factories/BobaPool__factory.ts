...
import type { BobaPool, BobaPoolInterface } from '../BobaPool';
...
export class BobaPool__factory {
  static readonly abi = _abi;
  static createInterface(): BobaPoolInterface {
    return new utils.Interface(_abi) as BobaPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BobaPool {
    return new Contract(address, _abi, signerOrProvider) as BobaPool;
  }
}
