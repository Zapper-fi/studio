...
import type { WbtcPool, WbtcPoolInterface } from '../WbtcPool';
...
export class WbtcPool__factory {
  static readonly abi = _abi;
  static createInterface(): WbtcPoolInterface {
    return new utils.Interface(_abi) as WbtcPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): WbtcPool {
    return new Contract(address, _abi, signerOrProvider) as WbtcPool;
  }
}
