...
import type { BadgerPool, BadgerPoolInterface } from '../BadgerPool';
...
export class BadgerPool__factory {
  static readonly abi = _abi;
  static createInterface(): BadgerPoolInterface {
    return new utils.Interface(_abi) as BadgerPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): BadgerPool {
    return new Contract(address, _abi, signerOrProvider) as BadgerPool;
  }
}
