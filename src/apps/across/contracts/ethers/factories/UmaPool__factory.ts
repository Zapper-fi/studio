...
import type { UmaPool, UmaPoolInterface } from '../UmaPool';
...
export class UmaPool__factory {
  static readonly abi = _abi;
  static createInterface(): UmaPoolInterface {
    return new utils.Interface(_abi) as UmaPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): UmaPool {
    return new Contract(address, _abi, signerOrProvider) as UmaPool;
  }
}
