...
import type { ArbDepositeBox, ArbDepositeBoxInterface } from '../ArbDepositeBox';
...
export class ArbDepositeBox__factory {
  static readonly abi = _abi;
  static createInterface(): ArbDepositeBoxInterface {
    return new utils.Interface(_abi) as ArbDepositeBoxInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ArbDepositeBox {
    return new Contract(address, _abi, signerOrProvider) as ArbDepositeBox;
  }
}
