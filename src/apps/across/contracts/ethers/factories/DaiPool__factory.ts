...
import type { DaiPool, DaiPoolInterface } from '../DaiPool';
...
export class DaiPool__factory {
  static readonly abi = _abi;
  static createInterface(): DaiPoolInterface {
    return new utils.Interface(_abi) as DaiPoolInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DaiPool {
    return new Contract(address, _abi, signerOrProvider) as DaiPool;
  }
}
