...
export interface JpegdLpFarmV2Interface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    'ContractWhitelistChanged(address,bool)': EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: 'ContractWhitelistChanged'): EventFragment;
...
export interface ContractWhitelistChangedEventObject {
  addr: string;
  isWhitelisted: boolean;
}
export type ContractWhitelistChangedEvent = TypedEvent<[string, boolean], ContractWhitelistChangedEventObject>;

export type ContractWhitelistChangedEventFilter = TypedEventFilter<ContractWhitelistChangedEvent>;
...
export interface JpegdLpFarmV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JpegdLpFarmV2Interface;
  ...
  filters: {
    ...
    'ContractWhitelistChanged(address,bool)'(
      addr?: PromiseOrValue<string> | null,
      isWhitelisted?: null,
    ): ContractWhitelistChangedEventFilter;
    ContractWhitelistChanged(
      addr?: PromiseOrValue<string> | null,
      isWhitelisted?: null,
    ): ContractWhitelistChangedEventFilter;
