...
export const jpegdBondDepositoryAbi = [
  {
    inputs: [
      {
...
export type JpegdBondDepository = typeof jpegdBondDepositoryAbi;
export type JpegdBondDepositoryContract = GetContractReturnType<JpegdBondDepository, PublicClient>;

export class JpegdBondDepository__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: jpegdBondDepositoryAbi, publicClient: client });
  }
}
