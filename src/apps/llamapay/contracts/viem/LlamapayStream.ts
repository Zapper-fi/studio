...
export const llamapayStreamAbi = [
  {
    inputs: [],
...
export type LlamapayStream = typeof llamapayStreamAbi;
export type LlamapayStreamContract = GetContractReturnType<LlamapayStream, PublicClient>;

export class LlamapayStream__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: llamapayStreamAbi, publicClient: client });
  }
}
