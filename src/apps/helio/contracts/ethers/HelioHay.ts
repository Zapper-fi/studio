...
export interface HelioHayInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    'SupplyCapSet(uint256,uint256)': EventFragment;
    'Transfer(address,address,uint256)': EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: 'Approval'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'Initialized'): EventFragment;
  getEvent(nameOrSignatureOrTopic: 'SupplyCapSet'): EventFragment;
...
export interface SupplyCapSetEventObject {
  oldCap: BigNumber;
  newCap: BigNumber;
}
export type SupplyCapSetEvent = TypedEvent<[BigNumber, BigNumber], SupplyCapSetEventObject>;

export type SupplyCapSetEventFilter = TypedEventFilter<SupplyCapSetEvent>;
...
export interface HelioHay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HelioHayInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      supplyCap_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setSupplyCap(wad: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    'SupplyCapSet(uint256,uint256)'(oldCap?: null, newCap?: null): SupplyCapSetEventFilter;
    SupplyCapSet(oldCap?: null, newCap?: null): SupplyCapSetEventFilter;
