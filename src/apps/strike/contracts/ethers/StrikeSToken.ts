...
export interface StrikeSTokenInterface extends utils.Interface {
  functions: {
    ...
    '_transferReserves(uint256)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: '_transferReserves', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(functionFragment: 'isSToken', values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: '_transferReserves', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'isSToken', data: BytesLike): Result;
  ...
  events: {
    ...
    'TransferReserves(address,address,uint256,uint256)': EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: 'TransferReserves'): EventFragment;
}
...
export interface TransferReservesEventObject {
  guardian: string;
  reserveAddress: string;
  reduceAmount: BigNumber;
  newTotalReserves: BigNumber;
}
export type TransferReservesEvent = TypedEvent<[string, string, BigNumber, BigNumber], TransferReservesEventObject>;

export type TransferReservesEventFilter = TypedEventFilter<TransferReservesEvent>;

export interface StrikeSToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StrikeSTokenInterface;
  ...
  functions: {
    ...
    _resignImplementation(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
    ...
    isSToken(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    _transferReserves(reduceAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    'TransferReserves(address,address,uint256,uint256)'(
      guardian?: null,
      reserveAddress?: null,
      reduceAmount?: null,
      newTotalReserves?: null,
    ): TransferReservesEventFilter;
    TransferReserves(
      guardian?: null,
      reserveAddress?: null,
      reduceAmount?: null,
  ...
  estimateGas: {
    ...
    _resignImplementation(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
    ...
    isSToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    _resignImplementation(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
    ...
    isSToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
