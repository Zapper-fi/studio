...
export const strikeComptrollerAbi = [
  {
    inputs: [],
    payable: false,
...
export type StrikeComptroller = typeof strikeComptrollerAbi;
export type StrikeComptrollerContract = GetContractReturnType<StrikeComptroller, PublicClient>;

export class StrikeComptroller__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: strikeComptrollerAbi, publicClient: client });
  }
}
