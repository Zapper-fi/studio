...
import type { AtlendisBorrowerPools, AtlendisBorrowerPoolsInterface } from '../AtlendisBorrowerPools';
...
export class AtlendisBorrowerPools__factory {
  ...
  static createInterface(): AtlendisBorrowerPoolsInterface {
    return new utils.Interface(_abi) as AtlendisBorrowerPoolsInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): AtlendisBorrowerPools {
    return new Contract(address, _abi, signerOrProvider) as AtlendisBorrowerPools;
  }
}
