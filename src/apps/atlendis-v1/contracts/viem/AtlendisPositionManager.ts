...
export const atlendisPositionManagerAbi = [
  {
    inputs: [],
...
export type AtlendisPositionManager = typeof atlendisPositionManagerAbi;
export type AtlendisPositionManagerContract = GetContractReturnType<AtlendisPositionManager, PublicClient>;

export class AtlendisPositionManager__factory {
  static connect(address: string, client: PublicClient) {
    return getContract({ address, abi: atlendisPositionManagerAbi, publicClient: client });
  }
}
